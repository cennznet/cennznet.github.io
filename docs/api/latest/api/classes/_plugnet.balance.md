[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Balance](../classes/_plugnet.balance.md)

# Class: Balance

*__name__*: Balance

*__description__*: The Substrate Balance representation as a [U128](_plugnet.u128.md).
...
↳  [BalanceOf](_plugnet.balanceof.md)

↳  [Amount](_plugnet.amount.md)

↳  [AssetOf](_plugnet.assetof.md)

↳  [AmountOf](_cennznet_types.amountof-1.md)

↳  [AmountOf](_cennznet_types.amountof.md)
...
* [constructor](_plugnet.balance.md#constructor)

### Properties

* [encodedLength](_plugnet.balance.md#encodedlength)
* [isEmpty](_plugnet.balance.md#isempty)

### Methods

* [abs](_plugnet.balance.md#abs)
* [add](_plugnet.balance.md#add)
* [addn](_plugnet.balance.md#addn)
* [and](_plugnet.balance.md#and)
* [andln](_plugnet.balance.md#andln)
* [bincn](_plugnet.balance.md#bincn)
* [bitLength](_plugnet.balance.md#bitlength)
* [byteLength](_plugnet.balance.md#bytelength)
* [clone](_plugnet.balance.md#clone)
* [cmp](_plugnet.balance.md#cmp)
* [cmpn](_plugnet.balance.md#cmpn)
* [div](_plugnet.balance.md#div)
* [divRound](_plugnet.balance.md#divround)
* [divn](_plugnet.balance.md#divn)
* [egcd](_plugnet.balance.md#egcd)
* [eq](_plugnet.balance.md#eq)
* [eqn](_plugnet.balance.md#eqn)
* [fromTwos](_plugnet.balance.md#fromtwos)
* [gcd](_plugnet.balance.md#gcd)
* [gt](_plugnet.balance.md#gt)
* [gte](_plugnet.balance.md#gte)
* [gten](_plugnet.balance.md#gten)
* [gtn](_plugnet.balance.md#gtn)
* [iabs](_plugnet.balance.md#iabs)
* [iadd](_plugnet.balance.md#iadd)
* [iaddn](_plugnet.balance.md#iaddn)
* [iand](_plugnet.balance.md#iand)
* [idivn](_plugnet.balance.md#idivn)
* [imaskn](_plugnet.balance.md#imaskn)
* [imul](_plugnet.balance.md#imul)
* [imuln](_plugnet.balance.md#imuln)
* [ineg](_plugnet.balance.md#ineg)
* [inotn](_plugnet.balance.md#inotn)
* [invm](_plugnet.balance.md#invm)
* [ior](_plugnet.balance.md#ior)
* [isEven](_plugnet.balance.md#iseven)
* [isNeg](_plugnet.balance.md#isneg)
* [isOdd](_plugnet.balance.md#isodd)
* [isZero](_plugnet.balance.md#iszero)
* [ishln](_plugnet.balance.md#ishln)
* [ishrn](_plugnet.balance.md#ishrn)
* [isqr](_plugnet.balance.md#isqr)
* [isub](_plugnet.balance.md#isub)
* [isubn](_plugnet.balance.md#isubn)
* [iuand](_plugnet.balance.md#iuand)
* [iuor](_plugnet.balance.md#iuor)
* [iushln](_plugnet.balance.md#iushln)
* [iushrn](_plugnet.balance.md#iushrn)
* [iuxor](_plugnet.balance.md#iuxor)
* [ixor](_plugnet.balance.md#ixor)
* [lt](_plugnet.balance.md#lt)
* [lte](_plugnet.balance.md#lte)
* [lten](_plugnet.balance.md#lten)
* [ltn](_plugnet.balance.md#ltn)
* [maskn](_plugnet.balance.md#maskn)
* [mod](_plugnet.balance.md#mod)
* [modn](_plugnet.balance.md#modn)
* [mul](_plugnet.balance.md#mul)
* [muln](_plugnet.balance.md#muln)
* [neg](_plugnet.balance.md#neg)
* [notn](_plugnet.balance.md#notn)
* [or](_plugnet.balance.md#or)
* [pow](_plugnet.balance.md#pow)
* [setn](_plugnet.balance.md#setn)
* [shln](_plugnet.balance.md#shln)
* [shrn](_plugnet.balance.md#shrn)
* [sqr](_plugnet.balance.md#sqr)
* [sub](_plugnet.balance.md#sub)
* [subn](_plugnet.balance.md#subn)
* [testn](_plugnet.balance.md#testn)
* [toArray](_plugnet.balance.md#toarray)
* [toArrayLike](_plugnet.balance.md#toarraylike)
* [toBn](_plugnet.balance.md#tobn)
* [toBuffer](_plugnet.balance.md#tobuffer)
* [toHex](_plugnet.balance.md#tohex)
* [toJSON](_plugnet.balance.md#tojson)
* [toNumber](_plugnet.balance.md#tonumber)
* [toRed](_plugnet.balance.md#tored)
* [toString](_plugnet.balance.md#tostring)
* [toTwos](_plugnet.balance.md#totwos)
* [toU8a](_plugnet.balance.md#tou8a)
* [uand](_plugnet.balance.md#uand)
* [ucmp](_plugnet.balance.md#ucmp)
* [umod](_plugnet.balance.md#umod)
* [uor](_plugnet.balance.md#uor)
* [ushln](_plugnet.balance.md#ushln)
* [ushrn](_plugnet.balance.md#ushrn)
* [uxor](_plugnet.balance.md#uxor)
* [xor](_plugnet.balance.md#xor)
* [zeroBits](_plugnet.balance.md#zerobits)
* [decodeAbstracInt](_plugnet.balance.md#decodeabstracint)
* [isBN](_plugnet.balance.md#isbn)
* [max](_plugnet.balance.md#max)
* [min](_plugnet.balance.md#min)
* [mont](_plugnet.balance.md#mont)
* [red](_plugnet.balance.md#red)
...
⊕ **new Balance**(value?: *[AnyNumber](../modules/_plugnet.md#anynumber)*): [Balance](_plugnet.balance.md)
...
**Returns:** [Balance](_plugnet.balance.md)
