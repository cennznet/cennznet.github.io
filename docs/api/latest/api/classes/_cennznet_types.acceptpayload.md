[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [AcceptPayload](../classes/_cennznet_types.acceptpayload.md)
...
* [constructor](_cennznet_types.acceptpayload.md#constructor)

### Properties

* [Type](_cennznet_types.acceptpayload.md#type)
* [__@toStringTag](_cennznet_types.acceptpayload.md#___tostringtag)
* [encodedLength](_cennznet_types.acceptpayload.md#encodedlength)
* [isEmpty](_cennznet_types.acceptpayload.md#isempty)
* [size](_cennznet_types.acceptpayload.md#size)

### Methods

* [__@iterator](_cennznet_types.acceptpayload.md#___iterator)
* [clear](_cennznet_types.acceptpayload.md#clear)
* [delete](_cennznet_types.acceptpayload.md#delete)
* [entries](_cennznet_types.acceptpayload.md#entries)
* [eq](_cennznet_types.acceptpayload.md#eq)
* [forEach](_cennznet_types.acceptpayload.md#foreach)
* [get](_cennznet_types.acceptpayload.md#get)
* [getAtIndex](_cennznet_types.acceptpayload.md#getatindex)
* [has](_cennznet_types.acceptpayload.md#has)
* [keys](_cennznet_types.acceptpayload.md#keys)
* [set](_cennznet_types.acceptpayload.md#set)
* [toArray](_cennznet_types.acceptpayload.md#toarray)
* [toHex](_cennznet_types.acceptpayload.md#tohex)
* [toJSON](_cennznet_types.acceptpayload.md#tojson)
* [toString](_cennznet_types.acceptpayload.md#tostring)
* [toU8a](_cennznet_types.acceptpayload.md#tou8a)
* [values](_cennznet_types.acceptpayload.md#values)
* [with](_cennznet_types.acceptpayload.md#with)
...
⊕ **new AcceptPayload**(value: *`any`*): [AcceptPayload](_cennznet_types.acceptpayload.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in packages/types/src/runtime/sylo.ts:101*
...
**Returns:** [AcceptPayload](_cennznet_types.acceptpayload.md)
