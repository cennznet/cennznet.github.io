[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [OuterDispatchCall](../classes/_plugnet.outerdispatchcall.md)

# Class: OuterDispatchCall
...
* [constructor](_plugnet.outerdispatchcall.md#constructor)

### Properties

* [Type](_plugnet.outerdispatchcall.md#type)
* [__@toStringTag](_plugnet.outerdispatchcall.md#___tostringtag)
* [encodedLength](_plugnet.outerdispatchcall.md#encodedlength)
* [index](_plugnet.outerdispatchcall.md#index)
* [isEmpty](_plugnet.outerdispatchcall.md#isempty)
* [name](_plugnet.outerdispatchcall.md#name)
* [prefix](_plugnet.outerdispatchcall.md#prefix)
* [size](_plugnet.outerdispatchcall.md#size)

### Methods

* [__@iterator](_plugnet.outerdispatchcall.md#___iterator)
* [clear](_plugnet.outerdispatchcall.md#clear)
* [delete](_plugnet.outerdispatchcall.md#delete)
* [entries](_plugnet.outerdispatchcall.md#entries)
* [eq](_plugnet.outerdispatchcall.md#eq)
* [forEach](_plugnet.outerdispatchcall.md#foreach)
* [get](_plugnet.outerdispatchcall.md#get)
* [getAtIndex](_plugnet.outerdispatchcall.md#getatindex)
* [has](_plugnet.outerdispatchcall.md#has)
* [keys](_plugnet.outerdispatchcall.md#keys)
* [set](_plugnet.outerdispatchcall.md#set)
* [toArray](_plugnet.outerdispatchcall.md#toarray)
* [toHex](_plugnet.outerdispatchcall.md#tohex)
* [toJSON](_plugnet.outerdispatchcall.md#tojson)
* [toString](_plugnet.outerdispatchcall.md#tostring)
* [toU8a](_plugnet.outerdispatchcall.md#tou8a)
* [values](_plugnet.outerdispatchcall.md#values)
* [with](_plugnet.outerdispatchcall.md#with)
...
⊕ **new OuterDispatchCall**(value?: *`any`*): [OuterDispatchCall](_plugnet.outerdispatchcall.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Calls.d.ts:5*
...
**Returns:** [OuterDispatchCall](_plugnet.outerdispatchcall.md)
...
**● index**: *[U16](_plugnet.u16.md)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Calls.d.ts:10*

*__description__*: The [U16](_plugnet.u16.md) index for the call
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Calls.d.ts:14*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Calls.d.ts:18*
