[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [AssetOptions](../classes/_cennznet_types.assetoptions.md)
...
* [constructor](_cennznet_types.assetoptions.md#constructor)

### Properties

* [Type](_cennznet_types.assetoptions.md#type)
* [__@toStringTag](_cennznet_types.assetoptions.md#___tostringtag)
* [encodedLength](_cennznet_types.assetoptions.md#encodedlength)
* [isEmpty](_cennznet_types.assetoptions.md#isempty)
* [size](_cennznet_types.assetoptions.md#size)

### Accessors

* [initialIssuance](_cennznet_types.assetoptions.md#initialissuance)
* [permissions](_cennznet_types.assetoptions.md#permissions)

### Methods

* [__@iterator](_cennznet_types.assetoptions.md#___iterator)
* [clear](_cennznet_types.assetoptions.md#clear)
* [delete](_cennznet_types.assetoptions.md#delete)
* [entries](_cennznet_types.assetoptions.md#entries)
* [eq](_cennznet_types.assetoptions.md#eq)
* [forEach](_cennznet_types.assetoptions.md#foreach)
* [get](_cennznet_types.assetoptions.md#get)
* [getAtIndex](_cennznet_types.assetoptions.md#getatindex)
* [has](_cennznet_types.assetoptions.md#has)
* [keys](_cennznet_types.assetoptions.md#keys)
* [set](_cennznet_types.assetoptions.md#set)
* [toArray](_cennznet_types.assetoptions.md#toarray)
* [toHex](_cennznet_types.assetoptions.md#tohex)
* [toJSON](_cennznet_types.assetoptions.md#tojson)
* [toString](_cennznet_types.assetoptions.md#tostring)
* [toU8a](_cennznet_types.assetoptions.md#tou8a)
* [values](_cennznet_types.assetoptions.md#values)
* [with](_cennznet_types.assetoptions.md#with)
...
⊕ **new AssetOptions**(value: *`any`*): [AssetOptions](_cennznet_types.assetoptions.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@cennznet/types/src/runtime/ga/AssetOptions.ts:22*
...
**Returns:** [AssetOptions](_cennznet_types.assetoptions.md)
...
*Defined in node_modules/@cennznet/types/src/runtime/ga/AssetOptions.ts:27*
...
*Defined in node_modules/@cennznet/types/src/runtime/ga/AssetOptions.ts:31*
