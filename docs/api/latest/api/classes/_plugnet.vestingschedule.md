[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [VestingSchedule](../classes/_plugnet.vestingschedule.md)
...
* [constructor](_plugnet.vestingschedule.md#constructor)

### Properties

* [Type](_plugnet.vestingschedule.md#type)
* [__@toStringTag](_plugnet.vestingschedule.md#___tostringtag)
* [encodedLength](_plugnet.vestingschedule.md#encodedlength)
* [isEmpty](_plugnet.vestingschedule.md#isempty)
* [offset](_plugnet.vestingschedule.md#offset)
* [perBlock](_plugnet.vestingschedule.md#perblock)
* [size](_plugnet.vestingschedule.md#size)

### Methods

* [__@iterator](_plugnet.vestingschedule.md#___iterator)
* [clear](_plugnet.vestingschedule.md#clear)
* [delete](_plugnet.vestingschedule.md#delete)
* [entries](_plugnet.vestingschedule.md#entries)
* [eq](_plugnet.vestingschedule.md#eq)
* [forEach](_plugnet.vestingschedule.md#foreach)
* [get](_plugnet.vestingschedule.md#get)
* [getAtIndex](_plugnet.vestingschedule.md#getatindex)
* [has](_plugnet.vestingschedule.md#has)
* [keys](_plugnet.vestingschedule.md#keys)
* [set](_plugnet.vestingschedule.md#set)
* [toArray](_plugnet.vestingschedule.md#toarray)
* [toHex](_plugnet.vestingschedule.md#tohex)
* [toJSON](_plugnet.vestingschedule.md#tojson)
* [toString](_plugnet.vestingschedule.md#tostring)
* [toU8a](_plugnet.vestingschedule.md#tou8a)
* [values](_plugnet.vestingschedule.md#values)
* [with](_plugnet.vestingschedule.md#with)
...
⊕ **new VestingSchedule**(value?: *`any`*): [VestingSchedule](_plugnet.vestingschedule.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/VestingSchedule.d.ts:7*
...
**Returns:** [VestingSchedule](_plugnet.vestingschedule.md)
...
**● offset**: *[Balance](_plugnet.balance.md)*

*Defined in node_modules/@plugnet/types/type/VestingSchedule.d.ts:12*

*__description__*: The offset as [Balance](_plugnet.balance.md)
...
**● perBlock**: *[Balance](_plugnet.balance.md)*

*Defined in node_modules/@plugnet/types/type/VestingSchedule.d.ts:16*

*__description__*: The perBlock value as [Balance](_plugnet.balance.md)
