[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [EventIndex](../classes/_plugnet.eventindex.md)

# Class: EventIndex

*__name__*: EventIndex

*__description__*: This follows the same approach as in [Method](_plugnet.method.md), we have the `[sectionIndex, methodIndex]` pairing that indicates the actual event fired
...
* [constructor](_plugnet.eventindex.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.eventindex.md#bytes_per_element)
* [__@toStringTag](_plugnet.eventindex.md#___tostringtag)
* [buffer](_plugnet.eventindex.md#buffer)
* [byteLength](_plugnet.eventindex.md#bytelength)
* [byteOffset](_plugnet.eventindex.md#byteoffset)
* [encodedLength](_plugnet.eventindex.md#encodedlength)
* [isEmpty](_plugnet.eventindex.md#isempty)
* [length](_plugnet.eventindex.md#length)

### Methods

* [__@iterator](_plugnet.eventindex.md#___iterator)
* [bitLength](_plugnet.eventindex.md#bitlength)
* [copyWithin](_plugnet.eventindex.md#copywithin)
* [entries](_plugnet.eventindex.md#entries)
* [eq](_plugnet.eventindex.md#eq)
* [every](_plugnet.eventindex.md#every)
* [fill](_plugnet.eventindex.md#fill)
* [filter](_plugnet.eventindex.md#filter)
* [find](_plugnet.eventindex.md#find)
* [findIndex](_plugnet.eventindex.md#findindex)
* [forEach](_plugnet.eventindex.md#foreach)
* [includes](_plugnet.eventindex.md#includes)
* [indexOf](_plugnet.eventindex.md#indexof)
* [join](_plugnet.eventindex.md#join)
* [keys](_plugnet.eventindex.md#keys)
* [lastIndexOf](_plugnet.eventindex.md#lastindexof)
* [map](_plugnet.eventindex.md#map)
* [reduce](_plugnet.eventindex.md#reduce)
* [reduceRight](_plugnet.eventindex.md#reduceright)
* [reverse](_plugnet.eventindex.md#reverse)
* [set](_plugnet.eventindex.md#set)
* [slice](_plugnet.eventindex.md#slice)
* [some](_plugnet.eventindex.md#some)
* [sort](_plugnet.eventindex.md#sort)
* [subarray](_plugnet.eventindex.md#subarray)
* [toHex](_plugnet.eventindex.md#tohex)
* [toJSON](_plugnet.eventindex.md#tojson)
* [toLocaleString](_plugnet.eventindex.md#tolocalestring)
* [toString](_plugnet.eventindex.md#tostring)
* [toU8a](_plugnet.eventindex.md#tou8a)
* [values](_plugnet.eventindex.md#values)
...
⊕ **new EventIndex**(value?: *`any`*): [EventIndex](_plugnet.eventindex.md)

*Overrides [U8aFixed](_plugnet.u8afixed.md).[constructor](_plugnet.u8afixed.md#constructor)*

*Defined in node_modules/@plugnet/types/type/Event.d.ts:43*
...
**Returns:** [EventIndex](_plugnet.eventindex.md)
