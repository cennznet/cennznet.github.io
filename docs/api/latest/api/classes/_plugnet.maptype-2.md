[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MapType](../classes/_plugnet.maptype-2.md)
...
* [constructor](_plugnet.maptype-2.md#constructor)

### Properties

* [Type](_plugnet.maptype-2.md#type)
* [__@toStringTag](_plugnet.maptype-2.md#___tostringtag)
* [encodedLength](_plugnet.maptype-2.md#encodedlength)
* [hasher](_plugnet.maptype-2.md#hasher)
* [isEmpty](_plugnet.maptype-2.md#isempty)
* [isLinked](_plugnet.maptype-2.md#islinked)
* [key](_plugnet.maptype-2.md#key)
* [size](_plugnet.maptype-2.md#size)
* [value](_plugnet.maptype-2.md#value)

### Methods

* [__@iterator](_plugnet.maptype-2.md#___iterator)
* [clear](_plugnet.maptype-2.md#clear)
* [delete](_plugnet.maptype-2.md#delete)
* [entries](_plugnet.maptype-2.md#entries)
* [eq](_plugnet.maptype-2.md#eq)
* [forEach](_plugnet.maptype-2.md#foreach)
* [get](_plugnet.maptype-2.md#get)
* [getAtIndex](_plugnet.maptype-2.md#getatindex)
* [has](_plugnet.maptype-2.md#has)
* [keys](_plugnet.maptype-2.md#keys)
* [set](_plugnet.maptype-2.md#set)
* [toArray](_plugnet.maptype-2.md#toarray)
* [toHex](_plugnet.maptype-2.md#tohex)
* [toJSON](_plugnet.maptype-2.md#tojson)
* [toString](_plugnet.maptype-2.md#tostring)
* [toU8a](_plugnet.maptype-2.md#tou8a)
* [values](_plugnet.maptype-2.md#values)
* [with](_plugnet.maptype-2.md#with)
...
⊕ **new MapType**(value?: *`any`*): [MapType](_plugnet.maptype-2.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v4/Storage.d.ts:35*
...
**Returns:** [MapType](_plugnet.maptype-2.md)
...
**● hasher**: *[StorageHasher](_plugnet.storagehasher.md)*

*Defined in node_modules/@plugnet/types/Metadata/v4/Storage.d.ts:40*

*__description__*: The hash algorithm used to hash keys, as [StorageHasher](_plugnet.storagehasher.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v4/Storage.d.ts:44*
...
**● key**: *[Type](_plugnet.type.md)*

*Defined in node_modules/@plugnet/types/Metadata/v4/Storage.d.ts:48*

*__description__*: The mapped key as [Type](_plugnet.maptype-2.md#type)
...
**● value**: *[Type](_plugnet.type.md)*

*Defined in node_modules/@plugnet/types/Metadata/v4/Storage.d.ts:52*

*__description__*: The mapped value as [Type](_plugnet.maptype-2.md#type)
