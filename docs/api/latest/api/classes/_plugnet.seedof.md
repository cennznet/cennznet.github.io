[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [SeedOf](../classes/_plugnet.seedof.md)

# Class: SeedOf

*__name__*: SeedOf

*__description__*: The Substrate SeedOf representation as a [Hash](_plugnet.hash.md).
...
* [constructor](_plugnet.seedof.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.seedof.md#bytes_per_element)
* [__@toStringTag](_plugnet.seedof.md#___tostringtag)
* [buffer](_plugnet.seedof.md#buffer)
* [byteLength](_plugnet.seedof.md#bytelength)
* [byteOffset](_plugnet.seedof.md#byteoffset)
* [encodedLength](_plugnet.seedof.md#encodedlength)
* [isEmpty](_plugnet.seedof.md#isempty)
* [length](_plugnet.seedof.md#length)

### Methods

* [__@iterator](_plugnet.seedof.md#___iterator)
* [bitLength](_plugnet.seedof.md#bitlength)
* [copyWithin](_plugnet.seedof.md#copywithin)
* [entries](_plugnet.seedof.md#entries)
* [eq](_plugnet.seedof.md#eq)
* [every](_plugnet.seedof.md#every)
* [fill](_plugnet.seedof.md#fill)
* [filter](_plugnet.seedof.md#filter)
* [find](_plugnet.seedof.md#find)
* [findIndex](_plugnet.seedof.md#findindex)
* [forEach](_plugnet.seedof.md#foreach)
* [includes](_plugnet.seedof.md#includes)
* [indexOf](_plugnet.seedof.md#indexof)
* [join](_plugnet.seedof.md#join)
* [keys](_plugnet.seedof.md#keys)
* [lastIndexOf](_plugnet.seedof.md#lastindexof)
* [map](_plugnet.seedof.md#map)
* [reduce](_plugnet.seedof.md#reduce)
* [reduceRight](_plugnet.seedof.md#reduceright)
* [reverse](_plugnet.seedof.md#reverse)
* [set](_plugnet.seedof.md#set)
* [slice](_plugnet.seedof.md#slice)
* [some](_plugnet.seedof.md#some)
* [sort](_plugnet.seedof.md#sort)
* [subarray](_plugnet.seedof.md#subarray)
* [toHex](_plugnet.seedof.md#tohex)
* [toJSON](_plugnet.seedof.md#tojson)
* [toLocaleString](_plugnet.seedof.md#tolocalestring)
* [toString](_plugnet.seedof.md#tostring)
* [toU8a](_plugnet.seedof.md#tou8a)
* [values](_plugnet.seedof.md#values)
...
⊕ **new SeedOf**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [SeedOf](_plugnet.seedof.md)
...
**Returns:** [SeedOf](_plugnet.seedof.md)
