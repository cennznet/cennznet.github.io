[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [Member](../classes/_cennznet_types.member.md)
...
* [constructor](_cennznet_types.member.md#constructor)

### Properties

* [Type](_cennznet_types.member.md#type)
* [__@toStringTag](_cennznet_types.member.md#___tostringtag)
* [encodedLength](_cennznet_types.member.md#encodedlength)
* [isEmpty](_cennznet_types.member.md#isempty)
* [size](_cennznet_types.member.md#size)

### Methods

* [__@iterator](_cennznet_types.member.md#___iterator)
* [clear](_cennznet_types.member.md#clear)
* [delete](_cennznet_types.member.md#delete)
* [entries](_cennznet_types.member.md#entries)
* [eq](_cennznet_types.member.md#eq)
* [forEach](_cennznet_types.member.md#foreach)
* [get](_cennznet_types.member.md#get)
* [getAtIndex](_cennznet_types.member.md#getatindex)
* [has](_cennznet_types.member.md#has)
* [keys](_cennznet_types.member.md#keys)
* [set](_cennznet_types.member.md#set)
* [toArray](_cennznet_types.member.md#toarray)
* [toHex](_cennznet_types.member.md#tohex)
* [toJSON](_cennznet_types.member.md#tojson)
* [toString](_cennznet_types.member.md#tostring)
* [toU8a](_cennznet_types.member.md#tou8a)
* [values](_cennznet_types.member.md#values)
* [with](_cennznet_types.member.md#with)
...
⊕ **new Member**(value: *`any`*): [Member](_cennznet_types.member.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in packages/types/src/runtime/sylo.ts:32*
...
**Returns:** [Member](_cennznet_types.member.md)
...
*Defined in packages/types/src/runtime/sylo.ts:37*
