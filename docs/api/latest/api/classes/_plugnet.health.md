[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Health](../classes/_plugnet.health.md)
...
* [constructor](_plugnet.health.md#constructor)

### Properties

* [Type](_plugnet.health.md#type)
* [__@toStringTag](_plugnet.health.md#___tostringtag)
* [encodedLength](_plugnet.health.md#encodedlength)
* [isEmpty](_plugnet.health.md#isempty)
* [isSyncing](_plugnet.health.md#issyncing)
* [peers](_plugnet.health.md#peers)
* [shouldHavePeers](_plugnet.health.md#shouldhavepeers)
* [size](_plugnet.health.md#size)

### Methods

* [__@iterator](_plugnet.health.md#___iterator)
* [clear](_plugnet.health.md#clear)
* [delete](_plugnet.health.md#delete)
* [entries](_plugnet.health.md#entries)
* [eq](_plugnet.health.md#eq)
* [forEach](_plugnet.health.md#foreach)
* [get](_plugnet.health.md#get)
* [getAtIndex](_plugnet.health.md#getatindex)
* [has](_plugnet.health.md#has)
* [keys](_plugnet.health.md#keys)
* [set](_plugnet.health.md#set)
* [toArray](_plugnet.health.md#toarray)
* [toHex](_plugnet.health.md#tohex)
* [toJSON](_plugnet.health.md#tojson)
* [toString](_plugnet.health.md#tostring)
* [toU8a](_plugnet.health.md#tou8a)
* [values](_plugnet.health.md#values)
* [with](_plugnet.health.md#with)
...
⊕ **new Health**(value?: *`any`*): [Health](_plugnet.health.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/rpc/Health.d.ts:9*
...
**Returns:** [Health](_plugnet.health.md)
...
**● isSyncing**: *[Bool](_plugnet.bool.md)*

*Defined in node_modules/@plugnet/types/rpc/Health.d.ts:14*
...
**● peers**: *[USize](_plugnet.usize.md)*

*Defined in node_modules/@plugnet/types/rpc/Health.d.ts:18*

*__description__*: The numbers of peers as [U32](_plugnet.u32.md)
...
**● shouldHavePeers**: *[Bool](_plugnet.bool.md)*

*Defined in node_modules/@plugnet/types/rpc/Health.d.ts:22*
