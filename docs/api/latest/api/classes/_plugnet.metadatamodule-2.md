[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MetadataModule](../classes/_plugnet.metadatamodule-2.md)
...
* [constructor](_plugnet.metadatamodule-2.md#constructor)

### Properties

* [Type](_plugnet.metadatamodule-2.md#type)
* [__@toStringTag](_plugnet.metadatamodule-2.md#___tostringtag)
* [calls](_plugnet.metadatamodule-2.md#calls)
* [encodedLength](_plugnet.metadatamodule-2.md#encodedlength)
* [events](_plugnet.metadatamodule-2.md#events)
* [isEmpty](_plugnet.metadatamodule-2.md#isempty)
* [name](_plugnet.metadatamodule-2.md#name)
* [prefix](_plugnet.metadatamodule-2.md#prefix)
* [size](_plugnet.metadatamodule-2.md#size)
* [storage](_plugnet.metadatamodule-2.md#storage)

### Methods

* [__@iterator](_plugnet.metadatamodule-2.md#___iterator)
* [clear](_plugnet.metadatamodule-2.md#clear)
* [delete](_plugnet.metadatamodule-2.md#delete)
* [entries](_plugnet.metadatamodule-2.md#entries)
* [eq](_plugnet.metadatamodule-2.md#eq)
* [forEach](_plugnet.metadatamodule-2.md#foreach)
* [get](_plugnet.metadatamodule-2.md#get)
* [getAtIndex](_plugnet.metadatamodule-2.md#getatindex)
* [has](_plugnet.metadatamodule-2.md#has)
* [keys](_plugnet.metadatamodule-2.md#keys)
* [set](_plugnet.metadatamodule-2.md#set)
* [toArray](_plugnet.metadatamodule-2.md#toarray)
* [toHex](_plugnet.metadatamodule-2.md#tohex)
* [toJSON](_plugnet.metadatamodule-2.md#tojson)
* [toString](_plugnet.metadatamodule-2.md#tostring)
* [toU8a](_plugnet.metadatamodule-2.md#tou8a)
* [values](_plugnet.metadatamodule-2.md#values)
* [with](_plugnet.metadatamodule-2.md#with)
...
⊕ **new MetadataModule**(value?: *`any`*): [MetadataModule](_plugnet.metadatamodule-2.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v3/Metadata.d.ts:14*
...
**Returns:** [MetadataModule](_plugnet.metadatamodule-2.md)
...
**● calls**: *[Option](_plugnet.option.md)<[Vector](_plugnet.vector.md)<[MetadataCall](_plugnet.metadatacall.md)>>*

*Defined in node_modules/@plugnet/types/Metadata/v3/Metadata.d.ts:19*
...
**● events**: *[Option](_plugnet.option.md)<[Vector](_plugnet.vector.md)<[MetadataEvent](_plugnet.metadataevent.md)>>*

*Defined in node_modules/@plugnet/types/Metadata/v3/Metadata.d.ts:23*
...
*Defined in node_modules/@plugnet/types/Metadata/v3/Metadata.d.ts:27*
...
*Defined in node_modules/@plugnet/types/Metadata/v3/Metadata.d.ts:31*
...
**● storage**: *[Option](_plugnet.option.md)<[Vector](_plugnet.vector.md)<[StorageFunctionMetadata](_plugnet.storagefunctionmetadata-1.md)>>*

*Defined in node_modules/@plugnet/types/Metadata/v3/Metadata.d.ts:35*
