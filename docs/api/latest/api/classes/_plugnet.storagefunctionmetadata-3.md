[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [StorageFunctionMetadata](../classes/_plugnet.storagefunctionmetadata-3.md)
...
* [constructor](_plugnet.storagefunctionmetadata-3.md#constructor)

### Properties

* [Type](_plugnet.storagefunctionmetadata-3.md#type)
* [__@toStringTag](_plugnet.storagefunctionmetadata-3.md#___tostringtag)
* [default](_plugnet.storagefunctionmetadata-3.md#default)
* [docs](_plugnet.storagefunctionmetadata-3.md#docs)
* [documentation](_plugnet.storagefunctionmetadata-3.md#documentation)
* [encodedLength](_plugnet.storagefunctionmetadata-3.md#encodedlength)
* [fallback](_plugnet.storagefunctionmetadata-3.md#fallback)
* [isEmpty](_plugnet.storagefunctionmetadata-3.md#isempty)
* [modifier](_plugnet.storagefunctionmetadata-3.md#modifier)
* [name](_plugnet.storagefunctionmetadata-3.md#name)
* [size](_plugnet.storagefunctionmetadata-3.md#size)
* [type](_plugnet.storagefunctionmetadata-3.md#type-1)

### Methods

* [__@iterator](_plugnet.storagefunctionmetadata-3.md#___iterator)
* [clear](_plugnet.storagefunctionmetadata-3.md#clear)
* [delete](_plugnet.storagefunctionmetadata-3.md#delete)
* [entries](_plugnet.storagefunctionmetadata-3.md#entries)
* [eq](_plugnet.storagefunctionmetadata-3.md#eq)
* [forEach](_plugnet.storagefunctionmetadata-3.md#foreach)
* [get](_plugnet.storagefunctionmetadata-3.md#get)
* [getAtIndex](_plugnet.storagefunctionmetadata-3.md#getatindex)
* [has](_plugnet.storagefunctionmetadata-3.md#has)
* [keys](_plugnet.storagefunctionmetadata-3.md#keys)
* [set](_plugnet.storagefunctionmetadata-3.md#set)
* [toArray](_plugnet.storagefunctionmetadata-3.md#toarray)
* [toHex](_plugnet.storagefunctionmetadata-3.md#tohex)
* [toJSON](_plugnet.storagefunctionmetadata-3.md#tojson)
* [toString](_plugnet.storagefunctionmetadata-3.md#tostring)
* [toU8a](_plugnet.storagefunctionmetadata-3.md#tou8a)
* [values](_plugnet.storagefunctionmetadata-3.md#values)
* [with](_plugnet.storagefunctionmetadata-3.md#with)
...
⊕ **new StorageFunctionMetadata**(value?: *[StorageFunctionMetadataValue](../modules/_plugnet.md#storagefunctionmetadatavalue-3) \| `Uint8Array`*): [StorageFunctionMetadata](_plugnet.storagefunctionmetadata-3.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:74*
...
**Returns:** [StorageFunctionMetadata](_plugnet.storagefunctionmetadata-3.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:80*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:93*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:88*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:84*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:101*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:97*
...
**● type**: *[StorageFunctionType](_plugnet.storagefunctiontype-1.md)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:105*
