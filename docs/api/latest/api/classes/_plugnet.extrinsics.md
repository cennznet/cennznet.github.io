[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Extrinsics](../classes/_plugnet.extrinsics.md)

# Class: Extrinsics

*__name__*: Extrinsics

*__description__*: A [Vector](_plugnet.vector.md) of [Extrinsic](_plugnet.extrinsic.md)
...
↳  [PendingExtrinsics](_plugnet.pendingextrinsics.md)
...
* [constructor](_plugnet.extrinsics.md#constructor)

### Properties

* [Type](_plugnet.extrinsics.md#type)
* [encodedLength](_plugnet.extrinsics.md#encodedlength)
* [isEmpty](_plugnet.extrinsics.md#isempty)
* [length](_plugnet.extrinsics.md#length)

### Methods

* [__@iterator](_plugnet.extrinsics.md#___iterator)
* [__@unscopables](_plugnet.extrinsics.md#___unscopables)
* [concat](_plugnet.extrinsics.md#concat)
* [copyWithin](_plugnet.extrinsics.md#copywithin)
* [entries](_plugnet.extrinsics.md#entries)
* [eq](_plugnet.extrinsics.md#eq)
* [every](_plugnet.extrinsics.md#every)
* [fill](_plugnet.extrinsics.md#fill)
* [filter](_plugnet.extrinsics.md#filter)
* [find](_plugnet.extrinsics.md#find)
* [findIndex](_plugnet.extrinsics.md#findindex)
* [forEach](_plugnet.extrinsics.md#foreach)
* [includes](_plugnet.extrinsics.md#includes)
* [indexOf](_plugnet.extrinsics.md#indexof)
* [join](_plugnet.extrinsics.md#join)
* [keys](_plugnet.extrinsics.md#keys)
* [lastIndexOf](_plugnet.extrinsics.md#lastindexof)
* [map](_plugnet.extrinsics.md#map)
* [pop](_plugnet.extrinsics.md#pop)
* [push](_plugnet.extrinsics.md#push)
* [reduce](_plugnet.extrinsics.md#reduce)
* [reduceRight](_plugnet.extrinsics.md#reduceright)
* [reverse](_plugnet.extrinsics.md#reverse)
* [shift](_plugnet.extrinsics.md#shift)
* [slice](_plugnet.extrinsics.md#slice)
* [some](_plugnet.extrinsics.md#some)
* [sort](_plugnet.extrinsics.md#sort)
* [splice](_plugnet.extrinsics.md#splice)
* [toArray](_plugnet.extrinsics.md#toarray)
* [toHex](_plugnet.extrinsics.md#tohex)
* [toJSON](_plugnet.extrinsics.md#tojson)
* [toLocaleString](_plugnet.extrinsics.md#tolocalestring)
* [toString](_plugnet.extrinsics.md#tostring)
* [toU8a](_plugnet.extrinsics.md#tou8a)
* [unshift](_plugnet.extrinsics.md#unshift)
* [values](_plugnet.extrinsics.md#values)
* [decodeVector](_plugnet.extrinsics.md#decodevector)
* [with](_plugnet.extrinsics.md#with)
...
⊕ **new Extrinsics**(Type: *[Constructor](../interfaces/_plugnet.constructor.md)<`T`>*, value?: *[Vector](_plugnet.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [Extrinsics](_plugnet.extrinsics.md)
...
**Returns:** [Extrinsics](_plugnet.extrinsics.md)
