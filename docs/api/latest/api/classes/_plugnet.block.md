[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Block](../classes/_plugnet.block.md)
...
* [constructor](_plugnet.block.md#constructor)

### Properties

* [Type](_plugnet.block.md#type)
* [__@toStringTag](_plugnet.block.md#___tostringtag)
* [contentHash](_plugnet.block.md#contenthash)
* [encodedLength](_plugnet.block.md#encodedlength)
* [extrinsics](_plugnet.block.md#extrinsics)
* [hash](_plugnet.block.md#hash)
* [header](_plugnet.block.md#header)
* [isEmpty](_plugnet.block.md#isempty)
* [size](_plugnet.block.md#size)

### Methods

* [__@iterator](_plugnet.block.md#___iterator)
* [clear](_plugnet.block.md#clear)
* [delete](_plugnet.block.md#delete)
* [entries](_plugnet.block.md#entries)
* [eq](_plugnet.block.md#eq)
* [forEach](_plugnet.block.md#foreach)
* [get](_plugnet.block.md#get)
* [getAtIndex](_plugnet.block.md#getatindex)
* [has](_plugnet.block.md#has)
* [keys](_plugnet.block.md#keys)
* [set](_plugnet.block.md#set)
* [toArray](_plugnet.block.md#toarray)
* [toHex](_plugnet.block.md#tohex)
* [toJSON](_plugnet.block.md#tojson)
* [toString](_plugnet.block.md#tostring)
* [toU8a](_plugnet.block.md#tou8a)
* [values](_plugnet.block.md#values)
* [with](_plugnet.block.md#with)
...
⊕ **new Block**(value?: *[BlockValue](../modules/_plugnet.md#blockvalue) \| `Uint8Array`*): [Block](_plugnet.block.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/Block.d.ts:15*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [BlockValue](../modules/_plugnet.md#blockvalue) \| `Uint8Array` |

**Returns:** [Block](_plugnet.block.md)
...
**● contentHash**: *[Hash](_plugnet.hash.md)*

*Defined in node_modules/@plugnet/types/type/Block.d.ts:20*

*__description__*: Encodes a content [Hash](_plugnet.hash.md) for the block
...
**● extrinsics**: *[Extrinsics](_plugnet.extrinsics.md)*

*Defined in node_modules/@plugnet/types/type/Block.d.ts:24*

*__description__*: The [Extrinsics](_plugnet.extrinsics.md) contained in the block
...
*Defined in node_modules/@plugnet/types/type/Block.d.ts:28*
...
**● header**: *[Header](_plugnet.header.md)*

*Defined in node_modules/@plugnet/types/type/Block.d.ts:32*

*__description__*: The [Header](_plugnet.header.md) of the block
