[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [AssetOptions](../classes/_cennznet_types.assetoptions-1.md)
...
* [constructor](_cennznet_types.assetoptions-1.md#constructor)

### Properties

* [Type](_cennznet_types.assetoptions-1.md#type)
* [__@toStringTag](_cennznet_types.assetoptions-1.md#___tostringtag)
* [encodedLength](_cennznet_types.assetoptions-1.md#encodedlength)
* [isEmpty](_cennznet_types.assetoptions-1.md#isempty)
* [size](_cennznet_types.assetoptions-1.md#size)

### Accessors

* [initialIssuance](_cennznet_types.assetoptions-1.md#initialissuance)
* [permissions](_cennznet_types.assetoptions-1.md#permissions)

### Methods

* [__@iterator](_cennznet_types.assetoptions-1.md#___iterator)
* [clear](_cennznet_types.assetoptions-1.md#clear)
* [delete](_cennznet_types.assetoptions-1.md#delete)
* [entries](_cennznet_types.assetoptions-1.md#entries)
* [eq](_cennznet_types.assetoptions-1.md#eq)
* [forEach](_cennznet_types.assetoptions-1.md#foreach)
* [get](_cennznet_types.assetoptions-1.md#get)
* [getAtIndex](_cennznet_types.assetoptions-1.md#getatindex)
* [has](_cennznet_types.assetoptions-1.md#has)
* [keys](_cennznet_types.assetoptions-1.md#keys)
* [set](_cennznet_types.assetoptions-1.md#set)
* [toArray](_cennznet_types.assetoptions-1.md#toarray)
* [toHex](_cennznet_types.assetoptions-1.md#tohex)
* [toJSON](_cennznet_types.assetoptions-1.md#tojson)
* [toString](_cennznet_types.assetoptions-1.md#tostring)
* [toU8a](_cennznet_types.assetoptions-1.md#tou8a)
* [values](_cennznet_types.assetoptions-1.md#values)
* [with](_cennznet_types.assetoptions-1.md#with)
...
⊕ **new AssetOptions**(value: *`any`*): [AssetOptions](_cennznet_types.assetoptions-1.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in packages/types/src/runtime/ga/AssetOptions.ts:22*
...
**Returns:** [AssetOptions](_cennznet_types.assetoptions-1.md)
...
**get initialIssuance**(): [Balance](_plugnet.balance.md)

*Defined in packages/types/src/runtime/ga/AssetOptions.ts:27*
...
*Defined in packages/types/src/runtime/ga/AssetOptions.ts:31*

**Returns:** `PermissionLatest`
