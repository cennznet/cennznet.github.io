[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [BftProposeOutOfTurn](../classes/_plugnet.bftproposeoutofturn.md)

# Class: BftProposeOutOfTurn
...
* [constructor](_plugnet.bftproposeoutofturn.md#constructor)

### Properties

* [Type](_plugnet.bftproposeoutofturn.md#type)
* [__@toStringTag](_plugnet.bftproposeoutofturn.md#___tostringtag)
* [a](_plugnet.bftproposeoutofturn.md#a)
* [encodedLength](_plugnet.bftproposeoutofturn.md#encodedlength)
* [isEmpty](_plugnet.bftproposeoutofturn.md#isempty)
* [round](_plugnet.bftproposeoutofturn.md#round)
* [size](_plugnet.bftproposeoutofturn.md#size)

### Methods

* [__@iterator](_plugnet.bftproposeoutofturn.md#___iterator)
* [clear](_plugnet.bftproposeoutofturn.md#clear)
* [delete](_plugnet.bftproposeoutofturn.md#delete)
* [entries](_plugnet.bftproposeoutofturn.md#entries)
* [eq](_plugnet.bftproposeoutofturn.md#eq)
* [forEach](_plugnet.bftproposeoutofturn.md#foreach)
* [get](_plugnet.bftproposeoutofturn.md#get)
* [getAtIndex](_plugnet.bftproposeoutofturn.md#getatindex)
* [has](_plugnet.bftproposeoutofturn.md#has)
* [keys](_plugnet.bftproposeoutofturn.md#keys)
* [set](_plugnet.bftproposeoutofturn.md#set)
* [toArray](_plugnet.bftproposeoutofturn.md#toarray)
* [toHex](_plugnet.bftproposeoutofturn.md#tohex)
* [toJSON](_plugnet.bftproposeoutofturn.md#tojson)
* [toString](_plugnet.bftproposeoutofturn.md#tostring)
* [toU8a](_plugnet.bftproposeoutofturn.md#tou8a)
* [values](_plugnet.bftproposeoutofturn.md#values)
* [with](_plugnet.bftproposeoutofturn.md#with)
...
⊕ **new BftProposeOutOfTurn**(value?: *[BftAtReportValue](../modules/_plugnet.md#bftatreportvalue) \| `Uint8Array`*): [BftProposeOutOfTurn](_plugnet.bftproposeoutofturn.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:42*
...
**Returns:** [BftProposeOutOfTurn](_plugnet.bftproposeoutofturn.md)
...
*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:47*

*__description__*: The [BftHashSignature](_plugnet.bfthashsignature.md) the report applies to
...
*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:51*
