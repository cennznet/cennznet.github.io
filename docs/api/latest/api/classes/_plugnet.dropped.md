[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Dropped](../classes/_plugnet.dropped.md)

# Class: Dropped

*__name__*: Dropped

*__description__*: An [ExtrinsicStatus](_plugnet.extrinsicstatus.md) indicating that the [Extrinsic](_plugnet.extrinsic.md) has been dropped
...
* [encodedLength](_plugnet.dropped.md#encodedlength)
* [isEmpty](_plugnet.dropped.md#isempty)

### Methods

* [eq](_plugnet.dropped.md#eq)
* [toHex](_plugnet.dropped.md#tohex)
* [toJSON](_plugnet.dropped.md#tojson)
* [toString](_plugnet.dropped.md#tostring)
* [toU8a](_plugnet.dropped.md#tou8a)
