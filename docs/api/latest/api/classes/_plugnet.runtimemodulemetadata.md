[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [RuntimeModuleMetadata](../classes/_plugnet.runtimemodulemetadata.md)
...
**● storage**: *[Option](_plugnet.option.md)<[StorageMetadata](_plugnet.storagemetadata.md)>*
