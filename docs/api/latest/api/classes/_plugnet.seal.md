[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Seal](../classes/_plugnet.seal.md)
...
* [constructor](_plugnet.seal.md#constructor)

### Properties

* [Types](_plugnet.seal.md#types)
* [encodedLength](_plugnet.seal.md#encodedlength)
* [isEmpty](_plugnet.seal.md#isempty)
* [length](_plugnet.seal.md#length)
* [signature](_plugnet.seal.md#signature)
* [slot](_plugnet.seal.md#slot)

### Methods

* [__@iterator](_plugnet.seal.md#___iterator)
* [__@unscopables](_plugnet.seal.md#___unscopables)
* [concat](_plugnet.seal.md#concat)
* [copyWithin](_plugnet.seal.md#copywithin)
* [entries](_plugnet.seal.md#entries)
* [eq](_plugnet.seal.md#eq)
* [every](_plugnet.seal.md#every)
* [fill](_plugnet.seal.md#fill)
* [filter](_plugnet.seal.md#filter)
* [find](_plugnet.seal.md#find)
* [findIndex](_plugnet.seal.md#findindex)
* [forEach](_plugnet.seal.md#foreach)
* [includes](_plugnet.seal.md#includes)
* [indexOf](_plugnet.seal.md#indexof)
* [join](_plugnet.seal.md#join)
* [keys](_plugnet.seal.md#keys)
* [lastIndexOf](_plugnet.seal.md#lastindexof)
* [map](_plugnet.seal.md#map)
* [pop](_plugnet.seal.md#pop)
* [push](_plugnet.seal.md#push)
* [reduce](_plugnet.seal.md#reduce)
* [reduceRight](_plugnet.seal.md#reduceright)
* [reverse](_plugnet.seal.md#reverse)
* [shift](_plugnet.seal.md#shift)
* [slice](_plugnet.seal.md#slice)
* [some](_plugnet.seal.md#some)
* [sort](_plugnet.seal.md#sort)
* [splice](_plugnet.seal.md#splice)
* [toArray](_plugnet.seal.md#toarray)
* [toHex](_plugnet.seal.md#tohex)
* [toJSON](_plugnet.seal.md#tojson)
* [toLocaleString](_plugnet.seal.md#tolocalestring)
* [toString](_plugnet.seal.md#tostring)
* [toU8a](_plugnet.seal.md#tou8a)
* [unshift](_plugnet.seal.md#unshift)
* [values](_plugnet.seal.md#values)
* [with](_plugnet.seal.md#with)
...
⊕ **new Seal**(value: *`any`*): [Seal](_plugnet.seal.md)

*Overrides [Tuple](_plugnet.tuple.md).[constructor](_plugnet.tuple.md#constructor)*

*Defined in node_modules/@plugnet/types/type/Digest.d.ts:38*
...
*Defined in node_modules/@plugnet/types/type/Digest.d.ts:43*
...
**● slot**: *[U64](_plugnet.u64.md)*

*Defined in node_modules/@plugnet/types/type/Digest.d.ts:47*

*__description__*: The wrapped [U64](_plugnet.u64.md) slot
