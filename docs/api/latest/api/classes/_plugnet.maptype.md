[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MapType](../classes/_plugnet.maptype.md)
...
* [constructor](_plugnet.maptype.md#constructor)

### Properties

* [Type](_plugnet.maptype.md#type)
* [__@toStringTag](_plugnet.maptype.md#___tostringtag)
* [encodedLength](_plugnet.maptype.md#encodedlength)
* [isEmpty](_plugnet.maptype.md#isempty)
* [isLinked](_plugnet.maptype.md#islinked)
* [key](_plugnet.maptype.md#key)
* [size](_plugnet.maptype.md#size)
* [value](_plugnet.maptype.md#value)

### Methods

* [__@iterator](_plugnet.maptype.md#___iterator)
* [clear](_plugnet.maptype.md#clear)
* [delete](_plugnet.maptype.md#delete)
* [entries](_plugnet.maptype.md#entries)
* [eq](_plugnet.maptype.md#eq)
* [forEach](_plugnet.maptype.md#foreach)
* [get](_plugnet.maptype.md#get)
* [getAtIndex](_plugnet.maptype.md#getatindex)
* [has](_plugnet.maptype.md#has)
* [keys](_plugnet.maptype.md#keys)
* [set](_plugnet.maptype.md#set)
* [toArray](_plugnet.maptype.md#toarray)
* [toHex](_plugnet.maptype.md#tohex)
* [toJSON](_plugnet.maptype.md#tojson)
* [toString](_plugnet.maptype.md#tostring)
* [toU8a](_plugnet.maptype.md#tou8a)
* [values](_plugnet.maptype.md#values)
* [with](_plugnet.maptype.md#with)
...
⊕ **new MapType**(value?: *`any`*): [MapType](_plugnet.maptype.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:19*
...
**Returns:** [MapType](_plugnet.maptype.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:32*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:24*

*__description__*: The mapped key as [Type](_plugnet.maptype.md#type)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:28*

*__description__*: The mapped value as [Type](_plugnet.maptype.md#type)
