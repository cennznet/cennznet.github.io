[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [ApiId](../classes/_plugnet.apiid.md)
...
* [constructor](_plugnet.apiid.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.apiid.md#bytes_per_element)
* [__@toStringTag](_plugnet.apiid.md#___tostringtag)
* [buffer](_plugnet.apiid.md#buffer)
* [byteLength](_plugnet.apiid.md#bytelength)
* [byteOffset](_plugnet.apiid.md#byteoffset)
* [encodedLength](_plugnet.apiid.md#encodedlength)
* [isEmpty](_plugnet.apiid.md#isempty)
* [length](_plugnet.apiid.md#length)

### Methods

* [__@iterator](_plugnet.apiid.md#___iterator)
* [bitLength](_plugnet.apiid.md#bitlength)
* [copyWithin](_plugnet.apiid.md#copywithin)
* [entries](_plugnet.apiid.md#entries)
* [eq](_plugnet.apiid.md#eq)
* [every](_plugnet.apiid.md#every)
* [fill](_plugnet.apiid.md#fill)
* [filter](_plugnet.apiid.md#filter)
* [find](_plugnet.apiid.md#find)
* [findIndex](_plugnet.apiid.md#findindex)
* [forEach](_plugnet.apiid.md#foreach)
* [includes](_plugnet.apiid.md#includes)
* [indexOf](_plugnet.apiid.md#indexof)
* [join](_plugnet.apiid.md#join)
* [keys](_plugnet.apiid.md#keys)
* [lastIndexOf](_plugnet.apiid.md#lastindexof)
* [map](_plugnet.apiid.md#map)
* [reduce](_plugnet.apiid.md#reduce)
* [reduceRight](_plugnet.apiid.md#reduceright)
* [reverse](_plugnet.apiid.md#reverse)
* [set](_plugnet.apiid.md#set)
* [slice](_plugnet.apiid.md#slice)
* [some](_plugnet.apiid.md#some)
* [sort](_plugnet.apiid.md#sort)
* [subarray](_plugnet.apiid.md#subarray)
* [toHex](_plugnet.apiid.md#tohex)
* [toJSON](_plugnet.apiid.md#tojson)
* [toLocaleString](_plugnet.apiid.md#tolocalestring)
* [toString](_plugnet.apiid.md#tostring)
* [toU8a](_plugnet.apiid.md#tou8a)
* [values](_plugnet.apiid.md#values)
...
⊕ **new ApiId**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [ApiId](_plugnet.apiid.md)

*Overrides [U8aFixed](_plugnet.u8afixed.md).[constructor](_plugnet.u8afixed.md#constructor)*

*Defined in node_modules/@plugnet/types/rpc/RuntimeVersion.d.ts:13*
...
**Returns:** [ApiId](_plugnet.apiid.md)
