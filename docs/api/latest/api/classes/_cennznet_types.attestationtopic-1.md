[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [AttestationTopic](../classes/_cennznet_types.attestationtopic-1.md)

# Class: AttestationTopic
...
* [constructor](_cennznet_types.attestationtopic-1.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_cennznet_types.attestationtopic-1.md#bytes_per_element)
* [__@toStringTag](_cennznet_types.attestationtopic-1.md#___tostringtag)
* [buffer](_cennznet_types.attestationtopic-1.md#buffer)
* [byteLength](_cennznet_types.attestationtopic-1.md#bytelength)
* [byteOffset](_cennznet_types.attestationtopic-1.md#byteoffset)
* [encodedLength](_cennznet_types.attestationtopic-1.md#encodedlength)
* [isEmpty](_cennznet_types.attestationtopic-1.md#isempty)
* [length](_cennznet_types.attestationtopic-1.md#length)

### Methods

* [__@iterator](_cennznet_types.attestationtopic-1.md#___iterator)
* [bitLength](_cennznet_types.attestationtopic-1.md#bitlength)
* [copyWithin](_cennznet_types.attestationtopic-1.md#copywithin)
* [entries](_cennznet_types.attestationtopic-1.md#entries)
* [eq](_cennznet_types.attestationtopic-1.md#eq)
* [every](_cennznet_types.attestationtopic-1.md#every)
* [fill](_cennznet_types.attestationtopic-1.md#fill)
* [filter](_cennznet_types.attestationtopic-1.md#filter)
* [find](_cennznet_types.attestationtopic-1.md#find)
* [findIndex](_cennznet_types.attestationtopic-1.md#findindex)
* [forEach](_cennznet_types.attestationtopic-1.md#foreach)
* [includes](_cennznet_types.attestationtopic-1.md#includes)
* [indexOf](_cennznet_types.attestationtopic-1.md#indexof)
* [join](_cennznet_types.attestationtopic-1.md#join)
* [keys](_cennznet_types.attestationtopic-1.md#keys)
* [lastIndexOf](_cennznet_types.attestationtopic-1.md#lastindexof)
* [map](_cennznet_types.attestationtopic-1.md#map)
* [reduce](_cennznet_types.attestationtopic-1.md#reduce)
* [reduceRight](_cennznet_types.attestationtopic-1.md#reduceright)
* [reverse](_cennznet_types.attestationtopic-1.md#reverse)
* [set](_cennznet_types.attestationtopic-1.md#set)
* [slice](_cennznet_types.attestationtopic-1.md#slice)
* [some](_cennznet_types.attestationtopic-1.md#some)
* [sort](_cennznet_types.attestationtopic-1.md#sort)
* [subarray](_cennznet_types.attestationtopic-1.md#subarray)
* [toHex](_cennznet_types.attestationtopic-1.md#tohex)
* [toJSON](_cennznet_types.attestationtopic-1.md#tojson)
* [toLocaleString](_cennznet_types.attestationtopic-1.md#tolocalestring)
* [toString](_cennznet_types.attestationtopic-1.md#tostring)
* [toU8a](_cennznet_types.attestationtopic-1.md#tou8a)
* [values](_cennznet_types.attestationtopic-1.md#values)
...
⊕ **new AttestationTopic**(value: *`string` \| `Uint8Array`*): [AttestationTopic](_cennznet_types.attestationtopic-1.md)

*Overrides [H256](_plugnet.h256.md).[constructor](_plugnet.h256.md#constructor)*

*Defined in packages/types/src/runtime/attestation/Topic.ts:49*
...
**Returns:** [AttestationTopic](_cennznet_types.attestationtopic-1.md)
...
*Defined in packages/types/src/runtime/attestation/Topic.ts:59*
