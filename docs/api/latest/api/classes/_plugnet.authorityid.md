[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [AuthorityId](../classes/_plugnet.authorityid.md)
...
↳  [SessionKey](_plugnet.sessionkey.md)
...
* [constructor](_plugnet.authorityid.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.authorityid.md#bytes_per_element)
* [__@toStringTag](_plugnet.authorityid.md#___tostringtag)
* [buffer](_plugnet.authorityid.md#buffer)
* [byteLength](_plugnet.authorityid.md#bytelength)
* [byteOffset](_plugnet.authorityid.md#byteoffset)
* [encodedLength](_plugnet.authorityid.md#encodedlength)
* [isEmpty](_plugnet.authorityid.md#isempty)
* [length](_plugnet.authorityid.md#length)

### Methods

* [__@iterator](_plugnet.authorityid.md#___iterator)
* [bitLength](_plugnet.authorityid.md#bitlength)
* [copyWithin](_plugnet.authorityid.md#copywithin)
* [entries](_plugnet.authorityid.md#entries)
* [eq](_plugnet.authorityid.md#eq)
* [every](_plugnet.authorityid.md#every)
* [fill](_plugnet.authorityid.md#fill)
* [filter](_plugnet.authorityid.md#filter)
* [find](_plugnet.authorityid.md#find)
* [findIndex](_plugnet.authorityid.md#findindex)
* [forEach](_plugnet.authorityid.md#foreach)
* [includes](_plugnet.authorityid.md#includes)
* [indexOf](_plugnet.authorityid.md#indexof)
* [join](_plugnet.authorityid.md#join)
* [keys](_plugnet.authorityid.md#keys)
* [lastIndexOf](_plugnet.authorityid.md#lastindexof)
* [map](_plugnet.authorityid.md#map)
* [reduce](_plugnet.authorityid.md#reduce)
* [reduceRight](_plugnet.authorityid.md#reduceright)
* [reverse](_plugnet.authorityid.md#reverse)
* [set](_plugnet.authorityid.md#set)
* [slice](_plugnet.authorityid.md#slice)
* [some](_plugnet.authorityid.md#some)
* [sort](_plugnet.authorityid.md#sort)
* [subarray](_plugnet.authorityid.md#subarray)
* [toHex](_plugnet.authorityid.md#tohex)
* [toJSON](_plugnet.authorityid.md#tojson)
* [toLocaleString](_plugnet.authorityid.md#tolocalestring)
* [toString](_plugnet.authorityid.md#tostring)
* [toU8a](_plugnet.authorityid.md#tou8a)
* [values](_plugnet.authorityid.md#values)
* [encode](_plugnet.authorityid.md#encode)
...
⊕ **new AuthorityId**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [AuthorityId](_plugnet.authorityid.md)
...
**Returns:** [AuthorityId](_plugnet.authorityid.md)
