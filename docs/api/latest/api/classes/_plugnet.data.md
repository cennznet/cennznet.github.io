[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Data](../classes/_plugnet.data.md)
...
* [constructor](_plugnet.data.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.data.md#bytes_per_element)
* [__@toStringTag](_plugnet.data.md#___tostringtag)
* [buffer](_plugnet.data.md#buffer)
* [byteLength](_plugnet.data.md#bytelength)
* [byteOffset](_plugnet.data.md#byteoffset)
* [encodedLength](_plugnet.data.md#encodedlength)
* [isEmpty](_plugnet.data.md#isempty)
* [length](_plugnet.data.md#length)

### Methods

* [__@iterator](_plugnet.data.md#___iterator)
* [copyWithin](_plugnet.data.md#copywithin)
* [entries](_plugnet.data.md#entries)
* [eq](_plugnet.data.md#eq)
* [every](_plugnet.data.md#every)
* [fill](_plugnet.data.md#fill)
* [filter](_plugnet.data.md#filter)
* [find](_plugnet.data.md#find)
* [findIndex](_plugnet.data.md#findindex)
* [forEach](_plugnet.data.md#foreach)
* [includes](_plugnet.data.md#includes)
* [indexOf](_plugnet.data.md#indexof)
* [join](_plugnet.data.md#join)
* [keys](_plugnet.data.md#keys)
* [lastIndexOf](_plugnet.data.md#lastindexof)
* [map](_plugnet.data.md#map)
* [reduce](_plugnet.data.md#reduce)
* [reduceRight](_plugnet.data.md#reduceright)
* [reverse](_plugnet.data.md#reverse)
* [set](_plugnet.data.md#set)
* [slice](_plugnet.data.md#slice)
* [some](_plugnet.data.md#some)
* [sort](_plugnet.data.md#sort)
* [subarray](_plugnet.data.md#subarray)
* [toHex](_plugnet.data.md#tohex)
* [toJSON](_plugnet.data.md#tojson)
* [toLocaleString](_plugnet.data.md#tolocalestring)
* [toString](_plugnet.data.md#tostring)
* [toU8a](_plugnet.data.md#tou8a)
* [values](_plugnet.data.md#values)
...
⊕ **new Data**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [Data](_plugnet.data.md)

*Inherited from [U8a](_plugnet.u8a.md).[constructor](_plugnet.u8a.md#constructor)*
