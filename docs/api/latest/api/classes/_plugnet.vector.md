[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Vector](../classes/_plugnet.vector.md)
...
↳  [AbstractArray](_plugnet.abstractarray.md)<`T`>

**↳ Vector**

↳  [Broadcast](_plugnet.broadcast.md)

↳  [Extrinsics](_plugnet.extrinsics.md)

↳  [AuthoritiesChange](_plugnet.authoritieschange.md)

↳  [Meta](_cennznet_types.meta-1.md)

↳  [PreKeyBundlesResponse](_cennznet_types.prekeybundlesresponse-1.md)

↳  [Meta](_cennznet_types.meta.md)

↳  [PreKeyBundlesResponse](_cennznet_types.prekeybundlesresponse.md)
...
* [constructor](_plugnet.vector.md#constructor)

### Properties

* [Type](_plugnet.vector.md#type)
* [encodedLength](_plugnet.vector.md#encodedlength)
* [isEmpty](_plugnet.vector.md#isempty)
* [length](_plugnet.vector.md#length)

### Methods

* [__@iterator](_plugnet.vector.md#___iterator)
* [__@unscopables](_plugnet.vector.md#___unscopables)
* [concat](_plugnet.vector.md#concat)
* [copyWithin](_plugnet.vector.md#copywithin)
* [entries](_plugnet.vector.md#entries)
* [eq](_plugnet.vector.md#eq)
* [every](_plugnet.vector.md#every)
* [fill](_plugnet.vector.md#fill)
* [filter](_plugnet.vector.md#filter)
* [find](_plugnet.vector.md#find)
* [findIndex](_plugnet.vector.md#findindex)
* [forEach](_plugnet.vector.md#foreach)
* [includes](_plugnet.vector.md#includes)
* [indexOf](_plugnet.vector.md#indexof)
* [join](_plugnet.vector.md#join)
* [keys](_plugnet.vector.md#keys)
* [lastIndexOf](_plugnet.vector.md#lastindexof)
* [map](_plugnet.vector.md#map)
* [pop](_plugnet.vector.md#pop)
* [push](_plugnet.vector.md#push)
* [reduce](_plugnet.vector.md#reduce)
* [reduceRight](_plugnet.vector.md#reduceright)
* [reverse](_plugnet.vector.md#reverse)
* [shift](_plugnet.vector.md#shift)
* [slice](_plugnet.vector.md#slice)
* [some](_plugnet.vector.md#some)
* [sort](_plugnet.vector.md#sort)
* [splice](_plugnet.vector.md#splice)
* [toArray](_plugnet.vector.md#toarray)
* [toHex](_plugnet.vector.md#tohex)
* [toJSON](_plugnet.vector.md#tojson)
* [toLocaleString](_plugnet.vector.md#tolocalestring)
* [toString](_plugnet.vector.md#tostring)
* [toU8a](_plugnet.vector.md#tou8a)
* [unshift](_plugnet.vector.md#unshift)
* [values](_plugnet.vector.md#values)
* [decodeVector](_plugnet.vector.md#decodevector)
* [with](_plugnet.vector.md#with)
...
⊕ **new Vector**(Type: *[Constructor](../interfaces/_plugnet.constructor.md)<`T`>*, value?: *[Vector](_plugnet.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [Vector](_plugnet.vector.md)
...
**Returns:** [Vector](_plugnet.vector.md)
