[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [Group](../classes/_cennznet_types.group.md)
...
* [constructor](_cennznet_types.group.md#constructor)

### Properties

* [Type](_cennznet_types.group.md#type)
* [__@toStringTag](_cennznet_types.group.md#___tostringtag)
* [encodedLength](_cennznet_types.group.md#encodedlength)
* [isEmpty](_cennznet_types.group.md#isempty)
* [size](_cennznet_types.group.md#size)

### Methods

* [__@iterator](_cennznet_types.group.md#___iterator)
* [clear](_cennznet_types.group.md#clear)
* [delete](_cennznet_types.group.md#delete)
* [entries](_cennznet_types.group.md#entries)
* [eq](_cennznet_types.group.md#eq)
* [forEach](_cennznet_types.group.md#foreach)
* [get](_cennznet_types.group.md#get)
* [getAtIndex](_cennznet_types.group.md#getatindex)
* [has](_cennznet_types.group.md#has)
* [keys](_cennznet_types.group.md#keys)
* [set](_cennznet_types.group.md#set)
* [toArray](_cennznet_types.group.md#toarray)
* [toHex](_cennznet_types.group.md#tohex)
* [toJSON](_cennznet_types.group.md#tojson)
* [toString](_cennznet_types.group.md#tostring)
* [toU8a](_cennznet_types.group.md#tou8a)
* [values](_cennznet_types.group.md#values)
* [with](_cennznet_types.group.md#with)
...
⊕ **new Group**(value: *`any`*): [Group](_cennznet_types.group.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in packages/types/src/runtime/sylo.ts:20*
...
**Returns:** [Group](_cennznet_types.group.md)
