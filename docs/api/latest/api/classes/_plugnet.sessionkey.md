[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [SessionKey](../classes/_plugnet.sessionkey.md)

# Class: SessionKey

*__name__*: SessionKey

*__description__*: Wrapper for a SessionKey. Same as an normal [AuthorityId](_plugnet.authorityid.md), i.e. a wrapper around publicKey.

## Hierarchy

↳  [AuthorityId](_plugnet.authorityid.md)
...
* [constructor](_plugnet.sessionkey.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.sessionkey.md#bytes_per_element)
* [__@toStringTag](_plugnet.sessionkey.md#___tostringtag)
* [buffer](_plugnet.sessionkey.md#buffer)
* [byteLength](_plugnet.sessionkey.md#bytelength)
* [byteOffset](_plugnet.sessionkey.md#byteoffset)
* [encodedLength](_plugnet.sessionkey.md#encodedlength)
* [isEmpty](_plugnet.sessionkey.md#isempty)
* [length](_plugnet.sessionkey.md#length)

### Methods

* [__@iterator](_plugnet.sessionkey.md#___iterator)
* [bitLength](_plugnet.sessionkey.md#bitlength)
* [copyWithin](_plugnet.sessionkey.md#copywithin)
* [entries](_plugnet.sessionkey.md#entries)
* [eq](_plugnet.sessionkey.md#eq)
* [every](_plugnet.sessionkey.md#every)
* [fill](_plugnet.sessionkey.md#fill)
* [filter](_plugnet.sessionkey.md#filter)
* [find](_plugnet.sessionkey.md#find)
* [findIndex](_plugnet.sessionkey.md#findindex)
* [forEach](_plugnet.sessionkey.md#foreach)
* [includes](_plugnet.sessionkey.md#includes)
* [indexOf](_plugnet.sessionkey.md#indexof)
* [join](_plugnet.sessionkey.md#join)
* [keys](_plugnet.sessionkey.md#keys)
* [lastIndexOf](_plugnet.sessionkey.md#lastindexof)
* [map](_plugnet.sessionkey.md#map)
* [reduce](_plugnet.sessionkey.md#reduce)
* [reduceRight](_plugnet.sessionkey.md#reduceright)
* [reverse](_plugnet.sessionkey.md#reverse)
* [set](_plugnet.sessionkey.md#set)
* [slice](_plugnet.sessionkey.md#slice)
* [some](_plugnet.sessionkey.md#some)
* [sort](_plugnet.sessionkey.md#sort)
* [subarray](_plugnet.sessionkey.md#subarray)
* [toHex](_plugnet.sessionkey.md#tohex)
* [toJSON](_plugnet.sessionkey.md#tojson)
* [toLocaleString](_plugnet.sessionkey.md#tolocalestring)
* [toString](_plugnet.sessionkey.md#tostring)
* [toU8a](_plugnet.sessionkey.md#tou8a)
* [values](_plugnet.sessionkey.md#values)
* [encode](_plugnet.sessionkey.md#encode)
...
⊕ **new SessionKey**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [SessionKey](_plugnet.sessionkey.md)
...
**Returns:** [SessionKey](_plugnet.sessionkey.md)
