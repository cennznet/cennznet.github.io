[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [DeviceIdResponse](../classes/_cennznet_types.deviceidresponse.md)

# Class: DeviceIdResponse

## Hierarchy

↳  [DeviceId](_cennznet_types.deviceid-1.md)
...
* [constructor](_cennznet_types.deviceidresponse.md#constructor)

### Properties

* [encodedLength](_cennznet_types.deviceidresponse.md#encodedlength)
* [isEmpty](_cennznet_types.deviceidresponse.md#isempty)

### Methods

* [abs](_cennznet_types.deviceidresponse.md#abs)
* [add](_cennznet_types.deviceidresponse.md#add)
* [addn](_cennznet_types.deviceidresponse.md#addn)
* [and](_cennznet_types.deviceidresponse.md#and)
* [andln](_cennznet_types.deviceidresponse.md#andln)
* [bincn](_cennznet_types.deviceidresponse.md#bincn)
* [bitLength](_cennznet_types.deviceidresponse.md#bitlength)
* [byteLength](_cennznet_types.deviceidresponse.md#bytelength)
* [clone](_cennznet_types.deviceidresponse.md#clone)
* [cmp](_cennznet_types.deviceidresponse.md#cmp)
* [cmpn](_cennznet_types.deviceidresponse.md#cmpn)
* [div](_cennznet_types.deviceidresponse.md#div)
* [divRound](_cennznet_types.deviceidresponse.md#divround)
* [divn](_cennznet_types.deviceidresponse.md#divn)
* [egcd](_cennznet_types.deviceidresponse.md#egcd)
* [eq](_cennznet_types.deviceidresponse.md#eq)
* [eqn](_cennznet_types.deviceidresponse.md#eqn)
* [fromTwos](_cennznet_types.deviceidresponse.md#fromtwos)
* [gcd](_cennznet_types.deviceidresponse.md#gcd)
* [gt](_cennznet_types.deviceidresponse.md#gt)
* [gte](_cennznet_types.deviceidresponse.md#gte)
* [gten](_cennznet_types.deviceidresponse.md#gten)
* [gtn](_cennznet_types.deviceidresponse.md#gtn)
* [iabs](_cennznet_types.deviceidresponse.md#iabs)
* [iadd](_cennznet_types.deviceidresponse.md#iadd)
* [iaddn](_cennznet_types.deviceidresponse.md#iaddn)
* [iand](_cennznet_types.deviceidresponse.md#iand)
* [idivn](_cennznet_types.deviceidresponse.md#idivn)
* [imaskn](_cennznet_types.deviceidresponse.md#imaskn)
* [imul](_cennznet_types.deviceidresponse.md#imul)
* [imuln](_cennznet_types.deviceidresponse.md#imuln)
* [ineg](_cennznet_types.deviceidresponse.md#ineg)
* [inotn](_cennznet_types.deviceidresponse.md#inotn)
* [invm](_cennznet_types.deviceidresponse.md#invm)
* [ior](_cennznet_types.deviceidresponse.md#ior)
* [isEven](_cennznet_types.deviceidresponse.md#iseven)
* [isNeg](_cennznet_types.deviceidresponse.md#isneg)
* [isOdd](_cennznet_types.deviceidresponse.md#isodd)
* [isZero](_cennznet_types.deviceidresponse.md#iszero)
* [ishln](_cennznet_types.deviceidresponse.md#ishln)
* [ishrn](_cennznet_types.deviceidresponse.md#ishrn)
* [isqr](_cennznet_types.deviceidresponse.md#isqr)
* [isub](_cennznet_types.deviceidresponse.md#isub)
* [isubn](_cennznet_types.deviceidresponse.md#isubn)
* [iuand](_cennznet_types.deviceidresponse.md#iuand)
* [iuor](_cennznet_types.deviceidresponse.md#iuor)
* [iushln](_cennznet_types.deviceidresponse.md#iushln)
* [iushrn](_cennznet_types.deviceidresponse.md#iushrn)
* [iuxor](_cennznet_types.deviceidresponse.md#iuxor)
* [ixor](_cennznet_types.deviceidresponse.md#ixor)
* [lt](_cennznet_types.deviceidresponse.md#lt)
* [lte](_cennznet_types.deviceidresponse.md#lte)
* [lten](_cennznet_types.deviceidresponse.md#lten)
* [ltn](_cennznet_types.deviceidresponse.md#ltn)
* [maskn](_cennznet_types.deviceidresponse.md#maskn)
* [mod](_cennznet_types.deviceidresponse.md#mod)
* [modn](_cennznet_types.deviceidresponse.md#modn)
* [mul](_cennznet_types.deviceidresponse.md#mul)
* [muln](_cennznet_types.deviceidresponse.md#muln)
* [neg](_cennznet_types.deviceidresponse.md#neg)
* [notn](_cennznet_types.deviceidresponse.md#notn)
* [or](_cennznet_types.deviceidresponse.md#or)
* [pow](_cennznet_types.deviceidresponse.md#pow)
* [setn](_cennznet_types.deviceidresponse.md#setn)
* [shln](_cennznet_types.deviceidresponse.md#shln)
* [shrn](_cennznet_types.deviceidresponse.md#shrn)
* [sqr](_cennznet_types.deviceidresponse.md#sqr)
* [sub](_cennznet_types.deviceidresponse.md#sub)
* [subn](_cennznet_types.deviceidresponse.md#subn)
* [testn](_cennznet_types.deviceidresponse.md#testn)
* [toArray](_cennznet_types.deviceidresponse.md#toarray)
* [toArrayLike](_cennznet_types.deviceidresponse.md#toarraylike)
* [toBn](_cennznet_types.deviceidresponse.md#tobn)
* [toBuffer](_cennznet_types.deviceidresponse.md#tobuffer)
* [toHex](_cennznet_types.deviceidresponse.md#tohex)
* [toJSON](_cennznet_types.deviceidresponse.md#tojson)
* [toNumber](_cennznet_types.deviceidresponse.md#tonumber)
* [toRed](_cennznet_types.deviceidresponse.md#tored)
* [toString](_cennznet_types.deviceidresponse.md#tostring)
* [toTwos](_cennznet_types.deviceidresponse.md#totwos)
* [toU8a](_cennznet_types.deviceidresponse.md#tou8a)
* [uand](_cennznet_types.deviceidresponse.md#uand)
* [ucmp](_cennznet_types.deviceidresponse.md#ucmp)
* [umod](_cennznet_types.deviceidresponse.md#umod)
* [uor](_cennznet_types.deviceidresponse.md#uor)
* [ushln](_cennznet_types.deviceidresponse.md#ushln)
* [ushrn](_cennznet_types.deviceidresponse.md#ushrn)
* [uxor](_cennznet_types.deviceidresponse.md#uxor)
* [xor](_cennznet_types.deviceidresponse.md#xor)
* [zeroBits](_cennznet_types.deviceidresponse.md#zerobits)
* [decodeAbstracInt](_cennznet_types.deviceidresponse.md#decodeabstracint)
* [isBN](_cennznet_types.deviceidresponse.md#isbn)
* [max](_cennznet_types.deviceidresponse.md#max)
* [min](_cennznet_types.deviceidresponse.md#min)
* [mont](_cennznet_types.deviceidresponse.md#mont)
* [red](_cennznet_types.deviceidresponse.md#red)
...
⊕ **new DeviceIdResponse**(value?: *[AnyNumber](../modules/_plugnet.md#anynumber)*): [DeviceIdResponse](_cennznet_types.deviceidresponse.md)
...
**Returns:** [DeviceIdResponse](_cennznet_types.deviceidresponse.md)
