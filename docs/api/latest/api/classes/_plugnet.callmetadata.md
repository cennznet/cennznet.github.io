[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [CallMetadata](../classes/_plugnet.callmetadata.md)
...
* [constructor](_plugnet.callmetadata.md#constructor)

### Properties

* [Type](_plugnet.callmetadata.md#type)
* [__@toStringTag](_plugnet.callmetadata.md#___tostringtag)
* [encodedLength](_plugnet.callmetadata.md#encodedlength)
* [functions](_plugnet.callmetadata.md#functions)
* [isEmpty](_plugnet.callmetadata.md#isempty)
* [name](_plugnet.callmetadata.md#name)
* [size](_plugnet.callmetadata.md#size)

### Methods

* [__@iterator](_plugnet.callmetadata.md#___iterator)
* [clear](_plugnet.callmetadata.md#clear)
* [delete](_plugnet.callmetadata.md#delete)
* [entries](_plugnet.callmetadata.md#entries)
* [eq](_plugnet.callmetadata.md#eq)
* [forEach](_plugnet.callmetadata.md#foreach)
* [get](_plugnet.callmetadata.md#get)
* [getAtIndex](_plugnet.callmetadata.md#getatindex)
* [has](_plugnet.callmetadata.md#has)
* [keys](_plugnet.callmetadata.md#keys)
* [set](_plugnet.callmetadata.md#set)
* [toArray](_plugnet.callmetadata.md#toarray)
* [toHex](_plugnet.callmetadata.md#tohex)
* [toJSON](_plugnet.callmetadata.md#tojson)
* [toString](_plugnet.callmetadata.md#tostring)
* [toU8a](_plugnet.callmetadata.md#tou8a)
* [values](_plugnet.callmetadata.md#values)
* [with](_plugnet.callmetadata.md#with)
...
⊕ **new CallMetadata**(value?: *`any`*): [CallMetadata](_plugnet.callmetadata.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Modules.d.ts:43*
...
**Returns:** [CallMetadata](_plugnet.callmetadata.md)
...
**● functions**: *[Vector](_plugnet.vector.md)<[FunctionMetadata](_plugnet.functionmetadata.md)>*

*Defined in node_modules/@plugnet/types/Metadata/v0/Modules.d.ts:48*

*__description__*: The functions available as [FunctionMetadata](_plugnet.functionmetadata.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Modules.d.ts:52*
