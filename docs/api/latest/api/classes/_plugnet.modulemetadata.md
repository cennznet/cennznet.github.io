[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [ModuleMetadata](../classes/_plugnet.modulemetadata.md)
...
* [constructor](_plugnet.modulemetadata.md#constructor)

### Properties

* [Type](_plugnet.modulemetadata.md#type)
* [__@toStringTag](_plugnet.modulemetadata.md#___tostringtag)
* [call](_plugnet.modulemetadata.md#call)
* [encodedLength](_plugnet.modulemetadata.md#encodedlength)
* [isEmpty](_plugnet.modulemetadata.md#isempty)
* [name](_plugnet.modulemetadata.md#name)
* [size](_plugnet.modulemetadata.md#size)

### Methods

* [__@iterator](_plugnet.modulemetadata.md#___iterator)
* [clear](_plugnet.modulemetadata.md#clear)
* [delete](_plugnet.modulemetadata.md#delete)
* [entries](_plugnet.modulemetadata.md#entries)
* [eq](_plugnet.modulemetadata.md#eq)
* [forEach](_plugnet.modulemetadata.md#foreach)
* [get](_plugnet.modulemetadata.md#get)
* [getAtIndex](_plugnet.modulemetadata.md#getatindex)
* [has](_plugnet.modulemetadata.md#has)
* [keys](_plugnet.modulemetadata.md#keys)
* [set](_plugnet.modulemetadata.md#set)
* [toArray](_plugnet.modulemetadata.md#toarray)
* [toHex](_plugnet.modulemetadata.md#tohex)
* [toJSON](_plugnet.modulemetadata.md#tojson)
* [toString](_plugnet.modulemetadata.md#tostring)
* [toU8a](_plugnet.modulemetadata.md#tou8a)
* [values](_plugnet.modulemetadata.md#values)
* [with](_plugnet.modulemetadata.md#with)
...
⊕ **new ModuleMetadata**(value?: *`any`*): [ModuleMetadata](_plugnet.modulemetadata.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Modules.d.ts:54*
...
**Returns:** [ModuleMetadata](_plugnet.modulemetadata.md)
...
**● call**: *[CallMetadata](_plugnet.callmetadata.md)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Modules.d.ts:59*

*__description__*: The calls as [CallMetadata](_plugnet.callmetadata.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Modules.d.ts:63*
