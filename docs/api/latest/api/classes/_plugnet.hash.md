[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Hash](../classes/_plugnet.hash.md)

# Class: Hash

*__name__*: Hash

*__description__*: The default hash that is used accross the system. It is basically just a thin wrapper around [H256](_plugnet.h256.md), representing a 32-byte blake2b (Substrate) value
...
↳  [Finalized](_plugnet.finalized.md)

↳  [Usurped](_plugnet.usurped.md)

↳  [ChangesTrieRoot](_plugnet.changestrieroot.md)

↳  [CodeHash](_plugnet.codehash.md)

↳  [TombstoneContractInfo](_plugnet.tombstonecontractinfo.md)

↳  [SeedOf](_plugnet.seedof.md)
...
* [constructor](_plugnet.hash.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.hash.md#bytes_per_element)
* [__@toStringTag](_plugnet.hash.md#___tostringtag)
* [buffer](_plugnet.hash.md#buffer)
* [byteLength](_plugnet.hash.md#bytelength)
* [byteOffset](_plugnet.hash.md#byteoffset)
* [encodedLength](_plugnet.hash.md#encodedlength)
* [isEmpty](_plugnet.hash.md#isempty)
* [length](_plugnet.hash.md#length)

### Methods

* [__@iterator](_plugnet.hash.md#___iterator)
* [bitLength](_plugnet.hash.md#bitlength)
* [copyWithin](_plugnet.hash.md#copywithin)
* [entries](_plugnet.hash.md#entries)
* [eq](_plugnet.hash.md#eq)
* [every](_plugnet.hash.md#every)
* [fill](_plugnet.hash.md#fill)
* [filter](_plugnet.hash.md#filter)
* [find](_plugnet.hash.md#find)
* [findIndex](_plugnet.hash.md#findindex)
* [forEach](_plugnet.hash.md#foreach)
* [includes](_plugnet.hash.md#includes)
* [indexOf](_plugnet.hash.md#indexof)
* [join](_plugnet.hash.md#join)
* [keys](_plugnet.hash.md#keys)
* [lastIndexOf](_plugnet.hash.md#lastindexof)
* [map](_plugnet.hash.md#map)
* [reduce](_plugnet.hash.md#reduce)
* [reduceRight](_plugnet.hash.md#reduceright)
* [reverse](_plugnet.hash.md#reverse)
* [set](_plugnet.hash.md#set)
* [slice](_plugnet.hash.md#slice)
* [some](_plugnet.hash.md#some)
* [sort](_plugnet.hash.md#sort)
* [subarray](_plugnet.hash.md#subarray)
* [toHex](_plugnet.hash.md#tohex)
* [toJSON](_plugnet.hash.md#tojson)
* [toLocaleString](_plugnet.hash.md#tolocalestring)
* [toString](_plugnet.hash.md#tostring)
* [toU8a](_plugnet.hash.md#tou8a)
* [values](_plugnet.hash.md#values)
...
⊕ **new Hash**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [Hash](_plugnet.hash.md)
