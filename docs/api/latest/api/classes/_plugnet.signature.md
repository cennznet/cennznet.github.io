[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Signature](../classes/_plugnet.signature.md)

# Class: Signature

*__name__*: Signature

*__description__*: The default signature that is used accross the system. It is currectly defined as a 512-bit value, represented by a [H512](_plugnet.h512.md).
...
↳  [Ed25519Signature](_plugnet.ed25519signature.md)

↳  [Sr25519Signature](_plugnet.sr25519signature.md)
...
* [constructor](_plugnet.signature.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.signature.md#bytes_per_element)
* [__@toStringTag](_plugnet.signature.md#___tostringtag)
* [buffer](_plugnet.signature.md#buffer)
* [byteLength](_plugnet.signature.md#bytelength)
* [byteOffset](_plugnet.signature.md#byteoffset)
* [encodedLength](_plugnet.signature.md#encodedlength)
* [isEmpty](_plugnet.signature.md#isempty)
* [length](_plugnet.signature.md#length)

### Methods

* [__@iterator](_plugnet.signature.md#___iterator)
* [bitLength](_plugnet.signature.md#bitlength)
* [copyWithin](_plugnet.signature.md#copywithin)
* [entries](_plugnet.signature.md#entries)
* [eq](_plugnet.signature.md#eq)
* [every](_plugnet.signature.md#every)
* [fill](_plugnet.signature.md#fill)
* [filter](_plugnet.signature.md#filter)
* [find](_plugnet.signature.md#find)
* [findIndex](_plugnet.signature.md#findindex)
* [forEach](_plugnet.signature.md#foreach)
* [includes](_plugnet.signature.md#includes)
* [indexOf](_plugnet.signature.md#indexof)
* [join](_plugnet.signature.md#join)
* [keys](_plugnet.signature.md#keys)
* [lastIndexOf](_plugnet.signature.md#lastindexof)
* [map](_plugnet.signature.md#map)
* [reduce](_plugnet.signature.md#reduce)
* [reduceRight](_plugnet.signature.md#reduceright)
* [reverse](_plugnet.signature.md#reverse)
* [set](_plugnet.signature.md#set)
* [slice](_plugnet.signature.md#slice)
* [some](_plugnet.signature.md#some)
* [sort](_plugnet.signature.md#sort)
* [subarray](_plugnet.signature.md#subarray)
* [toHex](_plugnet.signature.md#tohex)
* [toJSON](_plugnet.signature.md#tojson)
* [toLocaleString](_plugnet.signature.md#tolocalestring)
* [toString](_plugnet.signature.md#tostring)
* [toU8a](_plugnet.signature.md#tou8a)
* [values](_plugnet.signature.md#values)
...
⊕ **new Signature**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [Signature](_plugnet.signature.md)
