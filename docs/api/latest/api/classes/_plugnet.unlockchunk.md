[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [UnlockChunk](../classes/_plugnet.unlockchunk.md)

# Class: UnlockChunk

*__name__*: UnlockChunk

*__description__*: Just a Balance/BlockNumber tuple to encode when a chunk of funds will be unlocked
...
* [constructor](_plugnet.unlockchunk.md#constructor)

### Properties

* [Type](_plugnet.unlockchunk.md#type)
* [__@toStringTag](_plugnet.unlockchunk.md#___tostringtag)
* [encodedLength](_plugnet.unlockchunk.md#encodedlength)
* [era](_plugnet.unlockchunk.md#era)
* [isEmpty](_plugnet.unlockchunk.md#isempty)
* [size](_plugnet.unlockchunk.md#size)
* [value](_plugnet.unlockchunk.md#value)

### Methods

* [__@iterator](_plugnet.unlockchunk.md#___iterator)
* [clear](_plugnet.unlockchunk.md#clear)
* [delete](_plugnet.unlockchunk.md#delete)
* [entries](_plugnet.unlockchunk.md#entries)
* [eq](_plugnet.unlockchunk.md#eq)
* [forEach](_plugnet.unlockchunk.md#foreach)
* [get](_plugnet.unlockchunk.md#get)
* [getAtIndex](_plugnet.unlockchunk.md#getatindex)
* [has](_plugnet.unlockchunk.md#has)
* [keys](_plugnet.unlockchunk.md#keys)
* [set](_plugnet.unlockchunk.md#set)
* [toArray](_plugnet.unlockchunk.md#toarray)
* [toHex](_plugnet.unlockchunk.md#tohex)
* [toJSON](_plugnet.unlockchunk.md#tojson)
* [toString](_plugnet.unlockchunk.md#tostring)
* [toU8a](_plugnet.unlockchunk.md#tou8a)
* [values](_plugnet.unlockchunk.md#values)
* [with](_plugnet.unlockchunk.md#with)
...
⊕ **new UnlockChunk**(value?: *`any`*): [UnlockChunk](_plugnet.unlockchunk.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/UnlockChunk.d.ts:9*
...
**Returns:** [UnlockChunk](_plugnet.unlockchunk.md)
...
**● era**: *[BlockNumber](_plugnet.blocknumber.md)*

*Defined in node_modules/@plugnet/types/type/UnlockChunk.d.ts:14*

*__description__*: Era number at which point it'll be unlocked
...
*Defined in node_modules/@plugnet/types/type/UnlockChunk.d.ts:18*

*__description__*: Amount of funds to be unlocked
