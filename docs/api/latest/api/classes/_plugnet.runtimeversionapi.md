[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [RuntimeVersionApi](../classes/_plugnet.runtimeversionapi.md)

# Class: RuntimeVersionApi

*__name__*: RuntimeVersionApi

*__description__*: A [Tuple](_plugnet.tuple.md) that conatins the [ApiId](_plugnet.apiid.md) and [U32](_plugnet.u32.md) version
...
* [constructor](_plugnet.runtimeversionapi.md#constructor)

### Properties

* [Types](_plugnet.runtimeversionapi.md#types)
* [encodedLength](_plugnet.runtimeversionapi.md#encodedlength)
* [id](_plugnet.runtimeversionapi.md#id)
* [isEmpty](_plugnet.runtimeversionapi.md#isempty)
* [length](_plugnet.runtimeversionapi.md#length)
* [version](_plugnet.runtimeversionapi.md#version)

### Methods

* [__@iterator](_plugnet.runtimeversionapi.md#___iterator)
* [__@unscopables](_plugnet.runtimeversionapi.md#___unscopables)
* [concat](_plugnet.runtimeversionapi.md#concat)
* [copyWithin](_plugnet.runtimeversionapi.md#copywithin)
* [entries](_plugnet.runtimeversionapi.md#entries)
* [eq](_plugnet.runtimeversionapi.md#eq)
* [every](_plugnet.runtimeversionapi.md#every)
* [fill](_plugnet.runtimeversionapi.md#fill)
* [filter](_plugnet.runtimeversionapi.md#filter)
* [find](_plugnet.runtimeversionapi.md#find)
* [findIndex](_plugnet.runtimeversionapi.md#findindex)
* [forEach](_plugnet.runtimeversionapi.md#foreach)
* [includes](_plugnet.runtimeversionapi.md#includes)
* [indexOf](_plugnet.runtimeversionapi.md#indexof)
* [join](_plugnet.runtimeversionapi.md#join)
* [keys](_plugnet.runtimeversionapi.md#keys)
* [lastIndexOf](_plugnet.runtimeversionapi.md#lastindexof)
* [map](_plugnet.runtimeversionapi.md#map)
* [pop](_plugnet.runtimeversionapi.md#pop)
* [push](_plugnet.runtimeversionapi.md#push)
* [reduce](_plugnet.runtimeversionapi.md#reduce)
* [reduceRight](_plugnet.runtimeversionapi.md#reduceright)
* [reverse](_plugnet.runtimeversionapi.md#reverse)
* [shift](_plugnet.runtimeversionapi.md#shift)
* [slice](_plugnet.runtimeversionapi.md#slice)
* [some](_plugnet.runtimeversionapi.md#some)
* [sort](_plugnet.runtimeversionapi.md#sort)
* [splice](_plugnet.runtimeversionapi.md#splice)
* [toArray](_plugnet.runtimeversionapi.md#toarray)
* [toHex](_plugnet.runtimeversionapi.md#tohex)
* [toJSON](_plugnet.runtimeversionapi.md#tojson)
* [toLocaleString](_plugnet.runtimeversionapi.md#tolocalestring)
* [toString](_plugnet.runtimeversionapi.md#tostring)
* [toU8a](_plugnet.runtimeversionapi.md#tou8a)
* [unshift](_plugnet.runtimeversionapi.md#unshift)
* [values](_plugnet.runtimeversionapi.md#values)
* [with](_plugnet.runtimeversionapi.md#with)
...
⊕ **new RuntimeVersionApi**(value?: *[RuntimeVersionApiValue](../modules/_plugnet.md#runtimeversionapivalue) \| `Uint8Array`*): [RuntimeVersionApi](_plugnet.runtimeversionapi.md)

*Overrides [Tuple](_plugnet.tuple.md).[constructor](_plugnet.tuple.md#constructor)*

*Defined in node_modules/@plugnet/types/rpc/RuntimeVersion.d.ts:25*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [RuntimeVersionApiValue](../modules/_plugnet.md#runtimeversionapivalue) \| `Uint8Array` |

**Returns:** [RuntimeVersionApi](_plugnet.runtimeversionapi.md)
...
**● id**: *[ApiId](_plugnet.apiid.md)*

*Defined in node_modules/@plugnet/types/rpc/RuntimeVersion.d.ts:30*

*__description__*: The [ApiId](_plugnet.apiid.md)
...
*Defined in node_modules/@plugnet/types/rpc/RuntimeVersion.d.ts:34*

*__description__*: The specific version as [U32](_plugnet.u32.md)
