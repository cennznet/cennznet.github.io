[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [PrefabWasmModule](../classes/_plugnet.prefabwasmmodule.md)
...
* [constructor](_plugnet.prefabwasmmodule.md#constructor)

### Properties

* [Type](_plugnet.prefabwasmmodule.md#type)
* [__@toStringTag](_plugnet.prefabwasmmodule.md#___tostringtag)
* [code](_plugnet.prefabwasmmodule.md#code)
* [encodedLength](_plugnet.prefabwasmmodule.md#encodedlength)
* [initial](_plugnet.prefabwasmmodule.md#initial)
* [isEmpty](_plugnet.prefabwasmmodule.md#isempty)
* [maximum](_plugnet.prefabwasmmodule.md#maximum)
* [scheduleVersion](_plugnet.prefabwasmmodule.md#scheduleversion)
* [size](_plugnet.prefabwasmmodule.md#size)

### Methods

* [__@iterator](_plugnet.prefabwasmmodule.md#___iterator)
* [clear](_plugnet.prefabwasmmodule.md#clear)
* [delete](_plugnet.prefabwasmmodule.md#delete)
* [entries](_plugnet.prefabwasmmodule.md#entries)
* [eq](_plugnet.prefabwasmmodule.md#eq)
* [forEach](_plugnet.prefabwasmmodule.md#foreach)
* [get](_plugnet.prefabwasmmodule.md#get)
* [getAtIndex](_plugnet.prefabwasmmodule.md#getatindex)
* [has](_plugnet.prefabwasmmodule.md#has)
* [keys](_plugnet.prefabwasmmodule.md#keys)
* [set](_plugnet.prefabwasmmodule.md#set)
* [toArray](_plugnet.prefabwasmmodule.md#toarray)
* [toHex](_plugnet.prefabwasmmodule.md#tohex)
* [toJSON](_plugnet.prefabwasmmodule.md#tojson)
* [toString](_plugnet.prefabwasmmodule.md#tostring)
* [toU8a](_plugnet.prefabwasmmodule.md#tou8a)
* [values](_plugnet.prefabwasmmodule.md#values)
* [with](_plugnet.prefabwasmmodule.md#with)
...
⊕ **new PrefabWasmModule**(value?: *`any`*): [PrefabWasmModule](_plugnet.prefabwasmmodule.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/PrefabWasmModule.d.ts:8*
...
**Returns:** [PrefabWasmModule](_plugnet.prefabwasmmodule.md)
...
**● code**: *[Bytes](_plugnet.bytes.md)*

*Defined in node_modules/@plugnet/types/type/PrefabWasmModule.d.ts:13*

*__description__*: The code as [Bytes](_plugnet.bytes.md)
...
**● initial**: *[Compact](_plugnet.compact.md)*

*Defined in node_modules/@plugnet/types/type/PrefabWasmModule.d.ts:17*

*__description__*: The initial as [Compact](../interfaces/_plugnet.compact-1.md)
...
**● maximum**: *[Compact](_plugnet.compact.md)*

*Defined in node_modules/@plugnet/types/type/PrefabWasmModule.d.ts:21*

*__description__*: The maximum as [Compact](../interfaces/_plugnet.compact-1.md)
...
**● scheduleVersion**: *[Compact](_plugnet.compact.md)*

*Defined in node_modules/@plugnet/types/type/PrefabWasmModule.d.ts:25*

*__description__*: The scheduleVersion value as [Compact](../interfaces/_plugnet.compact-1.md)
