[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MetadataV2](../classes/_plugnet.metadatav2.md)
...
* [constructor](_plugnet.metadatav2.md#constructor)

### Properties

* [Type](_plugnet.metadatav2.md#type)
* [__@toStringTag](_plugnet.metadatav2.md#___tostringtag)
* [encodedLength](_plugnet.metadatav2.md#encodedlength)
* [isEmpty](_plugnet.metadatav2.md#isempty)
* [modules](_plugnet.metadatav2.md#modules)
* [size](_plugnet.metadatav2.md#size)

### Methods

* [__@iterator](_plugnet.metadatav2.md#___iterator)
* [clear](_plugnet.metadatav2.md#clear)
* [delete](_plugnet.metadatav2.md#delete)
* [entries](_plugnet.metadatav2.md#entries)
* [eq](_plugnet.metadatav2.md#eq)
* [forEach](_plugnet.metadatav2.md#foreach)
* [get](_plugnet.metadatav2.md#get)
* [getAtIndex](_plugnet.metadatav2.md#getatindex)
* [getUniqTypes](_plugnet.metadatav2.md#getuniqtypes)
* [has](_plugnet.metadatav2.md#has)
* [keys](_plugnet.metadatav2.md#keys)
* [set](_plugnet.metadatav2.md#set)
* [toArray](_plugnet.metadatav2.md#toarray)
* [toHex](_plugnet.metadatav2.md#tohex)
* [toJSON](_plugnet.metadatav2.md#tojson)
* [toString](_plugnet.metadatav2.md#tostring)
* [toU8a](_plugnet.metadatav2.md#tou8a)
* [values](_plugnet.metadatav2.md#values)
* [with](_plugnet.metadatav2.md#with)
...
⊕ **new MetadataV2**(value?: *`any`*): [MetadataV2](_plugnet.metadatav2.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v2/Metadata.d.ts:42*
...
**Returns:** [MetadataV2](_plugnet.metadatav2.md)
...
**● modules**: *[Vector](_plugnet.vector.md)<[MetadataModule](_plugnet.metadatamodule.md)>*

*Defined in node_modules/@plugnet/types/Metadata/v2/Metadata.d.ts:47*
...
*Defined in node_modules/@plugnet/types/Metadata/v2/Metadata.d.ts:54*
