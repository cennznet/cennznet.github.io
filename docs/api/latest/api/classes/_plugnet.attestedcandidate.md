[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [AttestedCandidate](../classes/_plugnet.attestedcandidate.md)
...
* [constructor](_plugnet.attestedcandidate.md#constructor)

### Properties

* [Type](_plugnet.attestedcandidate.md#type)
* [__@toStringTag](_plugnet.attestedcandidate.md#___tostringtag)
* [encodedLength](_plugnet.attestedcandidate.md#encodedlength)
* [isEmpty](_plugnet.attestedcandidate.md#isempty)
* [size](_plugnet.attestedcandidate.md#size)

### Methods

* [__@iterator](_plugnet.attestedcandidate.md#___iterator)
* [clear](_plugnet.attestedcandidate.md#clear)
* [delete](_plugnet.attestedcandidate.md#delete)
* [entries](_plugnet.attestedcandidate.md#entries)
* [eq](_plugnet.attestedcandidate.md#eq)
* [forEach](_plugnet.attestedcandidate.md#foreach)
* [get](_plugnet.attestedcandidate.md#get)
* [getAtIndex](_plugnet.attestedcandidate.md#getatindex)
* [has](_plugnet.attestedcandidate.md#has)
* [keys](_plugnet.attestedcandidate.md#keys)
* [set](_plugnet.attestedcandidate.md#set)
* [toArray](_plugnet.attestedcandidate.md#toarray)
* [toHex](_plugnet.attestedcandidate.md#tohex)
* [toJSON](_plugnet.attestedcandidate.md#tojson)
* [toString](_plugnet.attestedcandidate.md#tostring)
* [toU8a](_plugnet.attestedcandidate.md#tou8a)
* [values](_plugnet.attestedcandidate.md#values)
* [with](_plugnet.attestedcandidate.md#with)
...
⊕ **new AttestedCandidate**(value?: *`any`*): [AttestedCandidate](_plugnet.attestedcandidate.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/AttestedCandidate.d.ts:46*
...
**Returns:** [AttestedCandidate](_plugnet.attestedcandidate.md)
