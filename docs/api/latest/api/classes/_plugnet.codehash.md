[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [CodeHash](../classes/_plugnet.codehash.md)

# Class: CodeHash

*__name__*: CodeHash

*__description__*: The default contract code hash that is used accross the system. It is a wrapper around [Hash](_plugnet.hash.md), representing a 32-byte blake2b (Substrate) value
...
* [constructor](_plugnet.codehash.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.codehash.md#bytes_per_element)
* [__@toStringTag](_plugnet.codehash.md#___tostringtag)
* [buffer](_plugnet.codehash.md#buffer)
* [byteLength](_plugnet.codehash.md#bytelength)
* [byteOffset](_plugnet.codehash.md#byteoffset)
* [encodedLength](_plugnet.codehash.md#encodedlength)
* [isEmpty](_plugnet.codehash.md#isempty)
* [length](_plugnet.codehash.md#length)

### Methods

* [__@iterator](_plugnet.codehash.md#___iterator)
* [bitLength](_plugnet.codehash.md#bitlength)
* [copyWithin](_plugnet.codehash.md#copywithin)
* [entries](_plugnet.codehash.md#entries)
* [eq](_plugnet.codehash.md#eq)
* [every](_plugnet.codehash.md#every)
* [fill](_plugnet.codehash.md#fill)
* [filter](_plugnet.codehash.md#filter)
* [find](_plugnet.codehash.md#find)
* [findIndex](_plugnet.codehash.md#findindex)
* [forEach](_plugnet.codehash.md#foreach)
* [includes](_plugnet.codehash.md#includes)
* [indexOf](_plugnet.codehash.md#indexof)
* [join](_plugnet.codehash.md#join)
* [keys](_plugnet.codehash.md#keys)
* [lastIndexOf](_plugnet.codehash.md#lastindexof)
* [map](_plugnet.codehash.md#map)
* [reduce](_plugnet.codehash.md#reduce)
* [reduceRight](_plugnet.codehash.md#reduceright)
* [reverse](_plugnet.codehash.md#reverse)
* [set](_plugnet.codehash.md#set)
* [slice](_plugnet.codehash.md#slice)
* [some](_plugnet.codehash.md#some)
* [sort](_plugnet.codehash.md#sort)
* [subarray](_plugnet.codehash.md#subarray)
* [toHex](_plugnet.codehash.md#tohex)
* [toJSON](_plugnet.codehash.md#tojson)
* [toLocaleString](_plugnet.codehash.md#tolocalestring)
* [toString](_plugnet.codehash.md#tostring)
* [toU8a](_plugnet.codehash.md#tou8a)
* [values](_plugnet.codehash.md#values)
...
⊕ **new CodeHash**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [CodeHash](_plugnet.codehash.md)
...
**Returns:** [CodeHash](_plugnet.codehash.md)
