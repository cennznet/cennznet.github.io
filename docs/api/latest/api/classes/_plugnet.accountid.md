[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [AccountId](../classes/_plugnet.accountid.md)
...
↳  [AccountIdOf](_plugnet.accountidof.md)
...
* [constructor](_plugnet.accountid.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.accountid.md#bytes_per_element)
* [__@toStringTag](_plugnet.accountid.md#___tostringtag)
* [buffer](_plugnet.accountid.md#buffer)
* [byteLength](_plugnet.accountid.md#bytelength)
* [byteOffset](_plugnet.accountid.md#byteoffset)
* [encodedLength](_plugnet.accountid.md#encodedlength)
* [isEmpty](_plugnet.accountid.md#isempty)
* [length](_plugnet.accountid.md#length)

### Methods

* [__@iterator](_plugnet.accountid.md#___iterator)
* [bitLength](_plugnet.accountid.md#bitlength)
* [copyWithin](_plugnet.accountid.md#copywithin)
* [entries](_plugnet.accountid.md#entries)
* [eq](_plugnet.accountid.md#eq)
* [every](_plugnet.accountid.md#every)
* [fill](_plugnet.accountid.md#fill)
* [filter](_plugnet.accountid.md#filter)
* [find](_plugnet.accountid.md#find)
* [findIndex](_plugnet.accountid.md#findindex)
* [forEach](_plugnet.accountid.md#foreach)
* [includes](_plugnet.accountid.md#includes)
* [indexOf](_plugnet.accountid.md#indexof)
* [join](_plugnet.accountid.md#join)
* [keys](_plugnet.accountid.md#keys)
* [lastIndexOf](_plugnet.accountid.md#lastindexof)
* [map](_plugnet.accountid.md#map)
* [reduce](_plugnet.accountid.md#reduce)
* [reduceRight](_plugnet.accountid.md#reduceright)
* [reverse](_plugnet.accountid.md#reverse)
* [set](_plugnet.accountid.md#set)
* [slice](_plugnet.accountid.md#slice)
* [some](_plugnet.accountid.md#some)
* [sort](_plugnet.accountid.md#sort)
* [subarray](_plugnet.accountid.md#subarray)
* [toHex](_plugnet.accountid.md#tohex)
* [toJSON](_plugnet.accountid.md#tojson)
* [toLocaleString](_plugnet.accountid.md#tolocalestring)
* [toString](_plugnet.accountid.md#tostring)
* [toU8a](_plugnet.accountid.md#tou8a)
* [values](_plugnet.accountid.md#values)
* [encode](_plugnet.accountid.md#encode)
...
⊕ **new AccountId**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [AccountId](_plugnet.accountid.md)
...
**Returns:** [AccountId](_plugnet.accountid.md)
