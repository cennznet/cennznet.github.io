[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [FeeExchange](../classes/_cennznet_types.feeexchange.md)
...
* [constructor](_cennznet_types.feeexchange.md#constructor)

### Properties

* [Type](_cennznet_types.feeexchange.md#type)
* [__@toStringTag](_cennznet_types.feeexchange.md#___tostringtag)
* [encodedLength](_cennznet_types.feeexchange.md#encodedlength)
* [isEmpty](_cennznet_types.feeexchange.md#isempty)
* [size](_cennznet_types.feeexchange.md#size)

### Methods

* [__@iterator](_cennznet_types.feeexchange.md#___iterator)
* [clear](_cennznet_types.feeexchange.md#clear)
* [delete](_cennznet_types.feeexchange.md#delete)
* [entries](_cennznet_types.feeexchange.md#entries)
* [eq](_cennznet_types.feeexchange.md#eq)
* [forEach](_cennznet_types.feeexchange.md#foreach)
* [get](_cennznet_types.feeexchange.md#get)
* [getAtIndex](_cennznet_types.feeexchange.md#getatindex)
* [has](_cennznet_types.feeexchange.md#has)
* [keys](_cennznet_types.feeexchange.md#keys)
* [set](_cennznet_types.feeexchange.md#set)
* [toArray](_cennznet_types.feeexchange.md#toarray)
* [toHex](_cennznet_types.feeexchange.md#tohex)
* [toJSON](_cennznet_types.feeexchange.md#tojson)
* [toString](_cennznet_types.feeexchange.md#tostring)
* [toU8a](_cennznet_types.feeexchange.md#tou8a)
* [values](_cennznet_types.feeexchange.md#values)
* [with](_cennznet_types.feeexchange.md#with)
...
⊕ **new FeeExchange**(value?: *`any`*): [FeeExchange](_cennznet_types.feeexchange.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@cennznet/types/src/extrinsic/FeeExchange.ts:17*
...
**Returns:** [FeeExchange](_cennznet_types.feeexchange.md)
