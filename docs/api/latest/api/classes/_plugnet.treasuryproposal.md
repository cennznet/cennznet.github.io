[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [TreasuryProposal](../classes/_plugnet.treasuryproposal.md)

# Class: TreasuryProposal

*__name__*: TreasuryProposal

*__description__*: A Proposal made for Treasury
...
* [constructor](_plugnet.treasuryproposal.md#constructor)

### Properties

* [Type](_plugnet.treasuryproposal.md#type)
* [__@toStringTag](_plugnet.treasuryproposal.md#___tostringtag)
* [beneficiary](_plugnet.treasuryproposal.md#beneficiary)
* [bond](_plugnet.treasuryproposal.md#bond)
* [encodedLength](_plugnet.treasuryproposal.md#encodedlength)
* [isEmpty](_plugnet.treasuryproposal.md#isempty)
* [proposer](_plugnet.treasuryproposal.md#proposer)
* [size](_plugnet.treasuryproposal.md#size)
* [value](_plugnet.treasuryproposal.md#value)

### Methods

* [__@iterator](_plugnet.treasuryproposal.md#___iterator)
* [clear](_plugnet.treasuryproposal.md#clear)
* [delete](_plugnet.treasuryproposal.md#delete)
* [entries](_plugnet.treasuryproposal.md#entries)
* [eq](_plugnet.treasuryproposal.md#eq)
* [forEach](_plugnet.treasuryproposal.md#foreach)
* [get](_plugnet.treasuryproposal.md#get)
* [getAtIndex](_plugnet.treasuryproposal.md#getatindex)
* [has](_plugnet.treasuryproposal.md#has)
* [keys](_plugnet.treasuryproposal.md#keys)
* [set](_plugnet.treasuryproposal.md#set)
* [toArray](_plugnet.treasuryproposal.md#toarray)
* [toHex](_plugnet.treasuryproposal.md#tohex)
* [toJSON](_plugnet.treasuryproposal.md#tojson)
* [toString](_plugnet.treasuryproposal.md#tostring)
* [toU8a](_plugnet.treasuryproposal.md#tou8a)
* [values](_plugnet.treasuryproposal.md#values)
* [with](_plugnet.treasuryproposal.md#with)
...
⊕ **new TreasuryProposal**(value: *`any`*): [TreasuryProposal](_plugnet.treasuryproposal.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/TreasuryProposal.d.ts:9*
...
**Returns:** [TreasuryProposal](_plugnet.treasuryproposal.md)
...
**● beneficiary**: *[AccountId](_plugnet.accountid.md)*

*Defined in node_modules/@plugnet/types/type/TreasuryProposal.d.ts:14*

*__description__*: The beneficiary
...
**● bond**: *[Balance](_plugnet.balance.md)*

*Defined in node_modules/@plugnet/types/type/TreasuryProposal.d.ts:18*

*__description__*: The bond
...
**● proposer**: *[AccountId](_plugnet.accountid.md)*

*Defined in node_modules/@plugnet/types/type/TreasuryProposal.d.ts:22*

*__description__*: The proposer
...
**● value**: *[Balance](_plugnet.balance.md)*

*Defined in node_modules/@plugnet/types/type/TreasuryProposal.d.ts:26*
