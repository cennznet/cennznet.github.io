[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [PermissionsV1](../classes/_cennznet_types.permissionsv1.md)
...
* [constructor](_cennznet_types.permissionsv1.md#constructor)

### Properties

* [Type](_cennznet_types.permissionsv1.md#type)
* [__@toStringTag](_cennznet_types.permissionsv1.md#___tostringtag)
* [encodedLength](_cennznet_types.permissionsv1.md#encodedlength)
* [isEmpty](_cennznet_types.permissionsv1.md#isempty)
* [size](_cennznet_types.permissionsv1.md#size)

### Accessors

* [burn](_cennznet_types.permissionsv1.md#burn)
* [mint](_cennznet_types.permissionsv1.md#mint)
* [update](_cennznet_types.permissionsv1.md#update)

### Methods

* [__@iterator](_cennznet_types.permissionsv1.md#___iterator)
* [clear](_cennznet_types.permissionsv1.md#clear)
* [delete](_cennznet_types.permissionsv1.md#delete)
* [entries](_cennznet_types.permissionsv1.md#entries)
* [eq](_cennznet_types.permissionsv1.md#eq)
* [forEach](_cennznet_types.permissionsv1.md#foreach)
* [get](_cennznet_types.permissionsv1.md#get)
* [getAtIndex](_cennznet_types.permissionsv1.md#getatindex)
* [has](_cennznet_types.permissionsv1.md#has)
* [keys](_cennznet_types.permissionsv1.md#keys)
* [set](_cennznet_types.permissionsv1.md#set)
* [toArray](_cennznet_types.permissionsv1.md#toarray)
* [toHex](_cennznet_types.permissionsv1.md#tohex)
* [toJSON](_cennznet_types.permissionsv1.md#tojson)
* [toString](_cennznet_types.permissionsv1.md#tostring)
* [toU8a](_cennznet_types.permissionsv1.md#tou8a)
* [values](_cennznet_types.permissionsv1.md#values)
* [with](_cennznet_types.permissionsv1.md#with)
...
⊕ **new PermissionsV1**(value: *`any`*): [PermissionsV1](_cennznet_types.permissionsv1.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@cennznet/types/src/runtime/ga/PermissionsV1.ts:21*
...
**Returns:** [PermissionsV1](_cennznet_types.permissionsv1.md)
...
**get burn**(): [Owner](_cennznet_types.owner.md)

*Defined in node_modules/@cennznet/types/src/runtime/ga/PermissionsV1.ts:34*
...
**get mint**(): [Owner](_cennznet_types.owner.md)

*Defined in node_modules/@cennznet/types/src/runtime/ga/PermissionsV1.ts:30*
...
**get update**(): [Owner](_cennznet_types.owner.md)

*Defined in node_modules/@cennznet/types/src/runtime/ga/PermissionsV1.ts:26*
