[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [KeyValueOption](../classes/_plugnet.keyvalueoption.md)

# Class: KeyValueOption

*__name__*: KeyValueOption

*__description__*: A key/value change. This is similar to the [KeyValue](_plugnet.keyvalue.md) structure, however in this case the value could be optional. Here it extends from a [Tuple](_plugnet.tuple.md), indicating the use inside areas such as [StorageChangeSet](_plugnet.storagechangeset.md)
...
* [constructor](_plugnet.keyvalueoption.md#constructor)

### Properties

* [Types](_plugnet.keyvalueoption.md#types)
* [encodedLength](_plugnet.keyvalueoption.md#encodedlength)
* [isEmpty](_plugnet.keyvalueoption.md#isempty)
* [key](_plugnet.keyvalueoption.md#key)
* [length](_plugnet.keyvalueoption.md#length)
* [value](_plugnet.keyvalueoption.md#value)

### Methods

* [__@iterator](_plugnet.keyvalueoption.md#___iterator)
* [__@unscopables](_plugnet.keyvalueoption.md#___unscopables)
* [concat](_plugnet.keyvalueoption.md#concat)
* [copyWithin](_plugnet.keyvalueoption.md#copywithin)
* [entries](_plugnet.keyvalueoption.md#entries)
* [eq](_plugnet.keyvalueoption.md#eq)
* [every](_plugnet.keyvalueoption.md#every)
* [fill](_plugnet.keyvalueoption.md#fill)
* [filter](_plugnet.keyvalueoption.md#filter)
* [find](_plugnet.keyvalueoption.md#find)
* [findIndex](_plugnet.keyvalueoption.md#findindex)
* [forEach](_plugnet.keyvalueoption.md#foreach)
* [includes](_plugnet.keyvalueoption.md#includes)
* [indexOf](_plugnet.keyvalueoption.md#indexof)
* [join](_plugnet.keyvalueoption.md#join)
* [keys](_plugnet.keyvalueoption.md#keys)
* [lastIndexOf](_plugnet.keyvalueoption.md#lastindexof)
* [map](_plugnet.keyvalueoption.md#map)
* [pop](_plugnet.keyvalueoption.md#pop)
* [push](_plugnet.keyvalueoption.md#push)
* [reduce](_plugnet.keyvalueoption.md#reduce)
* [reduceRight](_plugnet.keyvalueoption.md#reduceright)
* [reverse](_plugnet.keyvalueoption.md#reverse)
* [shift](_plugnet.keyvalueoption.md#shift)
* [slice](_plugnet.keyvalueoption.md#slice)
* [some](_plugnet.keyvalueoption.md#some)
* [sort](_plugnet.keyvalueoption.md#sort)
* [splice](_plugnet.keyvalueoption.md#splice)
* [toArray](_plugnet.keyvalueoption.md#toarray)
* [toHex](_plugnet.keyvalueoption.md#tohex)
* [toJSON](_plugnet.keyvalueoption.md#tojson)
* [toLocaleString](_plugnet.keyvalueoption.md#tolocalestring)
* [toString](_plugnet.keyvalueoption.md#tostring)
* [toU8a](_plugnet.keyvalueoption.md#tou8a)
* [unshift](_plugnet.keyvalueoption.md#unshift)
* [values](_plugnet.keyvalueoption.md#values)
* [with](_plugnet.keyvalueoption.md#with)
...
⊕ **new KeyValueOption**(value?: *[KeyValueOptionValue](../modules/_plugnet.md#keyvalueoptionvalue) \| `Uint8Array`*): [KeyValueOption](_plugnet.keyvalueoption.md)

*Overrides [Tuple](_plugnet.tuple.md).[constructor](_plugnet.tuple.md#constructor)*

*Defined in node_modules/@plugnet/types/type/KeyValue.d.ts:38*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [KeyValueOptionValue](../modules/_plugnet.md#keyvalueoptionvalue) \| `Uint8Array` |

**Returns:** [KeyValueOption](_plugnet.keyvalueoption.md)
...
*Defined in node_modules/@plugnet/types/type/KeyValue.d.ts:43*
...
**● value**: *[Option](_plugnet.option.md)<[StorageData](_plugnet.storagedata.md)>*

*Defined in node_modules/@plugnet/types/type/KeyValue.d.ts:47*

*__description__*: The [Option](_plugnet.option.md) [StorageData](_plugnet.storagedata.md)
