[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [LinkageResult](../classes/_plugnet.linkageresult.md)
...
* [constructor](_plugnet.linkageresult.md#constructor)

### Properties

* [Types](_plugnet.linkageresult.md#types)
* [encodedLength](_plugnet.linkageresult.md#encodedlength)
* [isEmpty](_plugnet.linkageresult.md#isempty)
* [length](_plugnet.linkageresult.md#length)

### Methods

* [__@iterator](_plugnet.linkageresult.md#___iterator)
* [__@unscopables](_plugnet.linkageresult.md#___unscopables)
* [concat](_plugnet.linkageresult.md#concat)
* [copyWithin](_plugnet.linkageresult.md#copywithin)
* [entries](_plugnet.linkageresult.md#entries)
* [eq](_plugnet.linkageresult.md#eq)
* [every](_plugnet.linkageresult.md#every)
* [fill](_plugnet.linkageresult.md#fill)
* [filter](_plugnet.linkageresult.md#filter)
* [find](_plugnet.linkageresult.md#find)
* [findIndex](_plugnet.linkageresult.md#findindex)
* [forEach](_plugnet.linkageresult.md#foreach)
* [includes](_plugnet.linkageresult.md#includes)
* [indexOf](_plugnet.linkageresult.md#indexof)
* [join](_plugnet.linkageresult.md#join)
* [keys](_plugnet.linkageresult.md#keys)
* [lastIndexOf](_plugnet.linkageresult.md#lastindexof)
* [map](_plugnet.linkageresult.md#map)
* [pop](_plugnet.linkageresult.md#pop)
* [push](_plugnet.linkageresult.md#push)
* [reduce](_plugnet.linkageresult.md#reduce)
* [reduceRight](_plugnet.linkageresult.md#reduceright)
* [reverse](_plugnet.linkageresult.md#reverse)
* [shift](_plugnet.linkageresult.md#shift)
* [slice](_plugnet.linkageresult.md#slice)
* [some](_plugnet.linkageresult.md#some)
* [sort](_plugnet.linkageresult.md#sort)
* [splice](_plugnet.linkageresult.md#splice)
* [toArray](_plugnet.linkageresult.md#toarray)
* [toHex](_plugnet.linkageresult.md#tohex)
* [toJSON](_plugnet.linkageresult.md#tojson)
* [toLocaleString](_plugnet.linkageresult.md#tolocalestring)
* [toString](_plugnet.linkageresult.md#tostring)
* [toU8a](_plugnet.linkageresult.md#tou8a)
* [unshift](_plugnet.linkageresult.md#unshift)
* [values](_plugnet.linkageresult.md#values)
* [with](_plugnet.linkageresult.md#with)
...
⊕ **new LinkageResult**(__namedParameters: *[[Constructor](../interfaces/_plugnet.constructor.md), `Array`]*, __namedParameters: *[[Constructor](../interfaces/_plugnet.constructor.md), `Array`]*): [LinkageResult](_plugnet.linkageresult.md)

*Overrides [Tuple](_plugnet.tuple.md).[constructor](_plugnet.tuple.md#constructor)*

*Defined in node_modules/@plugnet/types/codec/Linkage.d.ts:10*

**Parameters:**

| Name | Type |
| ------ | ------ |
| __namedParameters | [[Constructor](../interfaces/_plugnet.constructor.md), `Array`] |
| __namedParameters | [[Constructor](../interfaces/_plugnet.constructor.md), `Array`] |

**Returns:** [LinkageResult](_plugnet.linkageresult.md)
