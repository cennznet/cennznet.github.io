[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [IndividualExposure](../classes/_plugnet.individualexposure.md)

# Class: IndividualExposure

*__name__*: IndividualExposure

*__description__*: The Substrate IndividualExposure for staking
...
* [constructor](_plugnet.individualexposure.md#constructor)

### Properties

* [Type](_plugnet.individualexposure.md#type)
* [__@toStringTag](_plugnet.individualexposure.md#___tostringtag)
* [encodedLength](_plugnet.individualexposure.md#encodedlength)
* [isEmpty](_plugnet.individualexposure.md#isempty)
* [size](_plugnet.individualexposure.md#size)
* [value](_plugnet.individualexposure.md#value)
* [who](_plugnet.individualexposure.md#who)

### Methods

* [__@iterator](_plugnet.individualexposure.md#___iterator)
* [clear](_plugnet.individualexposure.md#clear)
* [delete](_plugnet.individualexposure.md#delete)
* [entries](_plugnet.individualexposure.md#entries)
* [eq](_plugnet.individualexposure.md#eq)
* [forEach](_plugnet.individualexposure.md#foreach)
* [get](_plugnet.individualexposure.md#get)
* [getAtIndex](_plugnet.individualexposure.md#getatindex)
* [has](_plugnet.individualexposure.md#has)
* [keys](_plugnet.individualexposure.md#keys)
* [set](_plugnet.individualexposure.md#set)
* [toArray](_plugnet.individualexposure.md#toarray)
* [toHex](_plugnet.individualexposure.md#tohex)
* [toJSON](_plugnet.individualexposure.md#tojson)
* [toString](_plugnet.individualexposure.md#tostring)
* [toU8a](_plugnet.individualexposure.md#tou8a)
* [values](_plugnet.individualexposure.md#values)
* [with](_plugnet.individualexposure.md#with)
...
⊕ **new IndividualExposure**(value?: *`any`*): [IndividualExposure](_plugnet.individualexposure.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/IndividualExposure.d.ts:9*
...
**Returns:** [IndividualExposure](_plugnet.individualexposure.md)
...
*Defined in node_modules/@plugnet/types/type/IndividualExposure.d.ts:14*

*__description__*: The value
...
**● who**: *[AccountId](_plugnet.accountid.md)*

*Defined in node_modules/@plugnet/types/type/IndividualExposure.d.ts:18*

*__description__*: The AccountId
