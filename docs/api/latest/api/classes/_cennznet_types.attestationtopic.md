[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [AttestationTopic](../classes/_cennznet_types.attestationtopic.md)
...
* [constructor](_cennznet_types.attestationtopic.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_cennznet_types.attestationtopic.md#bytes_per_element)
* [__@toStringTag](_cennznet_types.attestationtopic.md#___tostringtag)
* [buffer](_cennznet_types.attestationtopic.md#buffer)
* [byteLength](_cennznet_types.attestationtopic.md#bytelength)
* [byteOffset](_cennznet_types.attestationtopic.md#byteoffset)
* [encodedLength](_cennznet_types.attestationtopic.md#encodedlength)
* [isEmpty](_cennznet_types.attestationtopic.md#isempty)
* [length](_cennznet_types.attestationtopic.md#length)

### Methods

* [__@iterator](_cennznet_types.attestationtopic.md#___iterator)
* [bitLength](_cennznet_types.attestationtopic.md#bitlength)
* [copyWithin](_cennznet_types.attestationtopic.md#copywithin)
* [entries](_cennznet_types.attestationtopic.md#entries)
* [eq](_cennznet_types.attestationtopic.md#eq)
* [every](_cennznet_types.attestationtopic.md#every)
* [fill](_cennznet_types.attestationtopic.md#fill)
* [filter](_cennznet_types.attestationtopic.md#filter)
* [find](_cennznet_types.attestationtopic.md#find)
* [findIndex](_cennznet_types.attestationtopic.md#findindex)
* [forEach](_cennznet_types.attestationtopic.md#foreach)
* [includes](_cennznet_types.attestationtopic.md#includes)
* [indexOf](_cennznet_types.attestationtopic.md#indexof)
* [join](_cennznet_types.attestationtopic.md#join)
* [keys](_cennznet_types.attestationtopic.md#keys)
* [lastIndexOf](_cennznet_types.attestationtopic.md#lastindexof)
* [map](_cennznet_types.attestationtopic.md#map)
* [reduce](_cennznet_types.attestationtopic.md#reduce)
* [reduceRight](_cennznet_types.attestationtopic.md#reduceright)
* [reverse](_cennznet_types.attestationtopic.md#reverse)
* [set](_cennznet_types.attestationtopic.md#set)
* [slice](_cennznet_types.attestationtopic.md#slice)
* [some](_cennznet_types.attestationtopic.md#some)
* [sort](_cennznet_types.attestationtopic.md#sort)
* [subarray](_cennznet_types.attestationtopic.md#subarray)
* [toHex](_cennznet_types.attestationtopic.md#tohex)
* [toJSON](_cennznet_types.attestationtopic.md#tojson)
* [toLocaleString](_cennznet_types.attestationtopic.md#tolocalestring)
* [toString](_cennznet_types.attestationtopic.md#tostring)
* [toU8a](_cennznet_types.attestationtopic.md#tou8a)
* [values](_cennznet_types.attestationtopic.md#values)
...
⊕ **new AttestationTopic**(value: *`string` \| `Uint8Array`*): [AttestationTopic](_cennznet_types.attestationtopic.md)

*Overrides [H256](_plugnet.h256.md).[constructor](_plugnet.h256.md#constructor)*

*Defined in node_modules/@cennznet/types/src/runtime/attestation/Topic.ts:49*
...
**Returns:** [AttestationTopic](_cennznet_types.attestationtopic.md)
...
*Defined in node_modules/@cennznet/types/src/runtime/attestation/Topic.ts:59*
