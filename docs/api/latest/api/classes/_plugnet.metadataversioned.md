[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MetadataVersioned](../classes/_plugnet.metadataversioned.md)
...
* [constructor](_plugnet.metadataversioned.md#constructor)

### Properties

* [Type](_plugnet.metadataversioned.md#type)
* [__@toStringTag](_plugnet.metadataversioned.md#___tostringtag)
* [asV0](_plugnet.metadataversioned.md#asv0)
* [asV1](_plugnet.metadataversioned.md#asv1)
* [asV2](_plugnet.metadataversioned.md#asv2)
* [asV3](_plugnet.metadataversioned.md#asv3)
* [asV4](_plugnet.metadataversioned.md#asv4)
* [encodedLength](_plugnet.metadataversioned.md#encodedlength)
* [isEmpty](_plugnet.metadataversioned.md#isempty)
* [magicNumber](_plugnet.metadataversioned.md#magicnumber)
* [size](_plugnet.metadataversioned.md#size)
* [version](_plugnet.metadataversioned.md#version)

### Methods

* [__@iterator](_plugnet.metadataversioned.md#___iterator)
* [clear](_plugnet.metadataversioned.md#clear)
* [delete](_plugnet.metadataversioned.md#delete)
* [entries](_plugnet.metadataversioned.md#entries)
* [eq](_plugnet.metadataversioned.md#eq)
* [forEach](_plugnet.metadataversioned.md#foreach)
* [get](_plugnet.metadataversioned.md#get)
* [getAtIndex](_plugnet.metadataversioned.md#getatindex)
* [getUniqTypes](_plugnet.metadataversioned.md#getuniqtypes)
* [has](_plugnet.metadataversioned.md#has)
* [keys](_plugnet.metadataversioned.md#keys)
* [set](_plugnet.metadataversioned.md#set)
* [toArray](_plugnet.metadataversioned.md#toarray)
* [toHex](_plugnet.metadataversioned.md#tohex)
* [toJSON](_plugnet.metadataversioned.md#tojson)
* [toString](_plugnet.metadataversioned.md#tostring)
* [toU8a](_plugnet.metadataversioned.md#tou8a)
* [values](_plugnet.metadataversioned.md#values)
* [with](_plugnet.metadataversioned.md#with)
...
⊕ **new MetadataVersioned**(value?: *`any`*): [MetadataVersioned](_plugnet.metadataversioned.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/MetadataVersioned.d.ts:18*
...
**Returns:** [MetadataVersioned](_plugnet.metadataversioned.md)
