[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Tuple](../classes/_plugnet.tuple.md)
...
↳  [AbstractArray](_plugnet.abstractarray.md)<[Codec](../interfaces/_plugnet.codec.md)>

**↳ Tuple**

↳  [OuterEventMetadataEvent](_plugnet.outereventmetadataevent.md)

↳  [RuntimeVersionApi](_plugnet.runtimeversionapi.md)

↳  [Seal](_plugnet.seal.md)

↳  [Consensus](_plugnet.consensus.md)

↳  [BftAuthoritySignature](_plugnet.bftauthoritysignature.md)

↳  [BftHashSignature](_plugnet.bfthashsignature.md)

↳  [KeyValueOption](_plugnet.keyvalueoption.md)

↳  [BalanceUpload](_plugnet.balanceupload.md)

↳  [EgressQueueRoot](_plugnet.egressqueueroot.md)

↳  [AvailabilityVote](_plugnet.availabilityvote.md)

↳  [ValidityVote](_plugnet.validityvote.md)

↳  [EventData](_plugnet.eventdata.md)

↳  [InherentOfflineReport](_plugnet.inherentofflinereport.md)

↳  [NextAuthority](_plugnet.nextauthority.md)

↳  [ExchangeKey](_cennznet_types.exchangekey-1.md)

↳  [WithdrawnPreKeyBundle](_cennznet_types.withdrawnprekeybundle.md)

↳  [ExchangeKey](_cennznet_types.exchangekey.md)

↳  [WithdrawnPreKeyBundle](_cennznet_types.withdrawnprekeybundle-1.md)

↳  [LinkageResult](_plugnet.linkageresult.md)
...
* [constructor](_plugnet.tuple.md#constructor)

### Properties

* [Types](_plugnet.tuple.md#types)
* [encodedLength](_plugnet.tuple.md#encodedlength)
* [isEmpty](_plugnet.tuple.md#isempty)
* [length](_plugnet.tuple.md#length)

### Methods

* [__@iterator](_plugnet.tuple.md#___iterator)
* [__@unscopables](_plugnet.tuple.md#___unscopables)
* [concat](_plugnet.tuple.md#concat)
* [copyWithin](_plugnet.tuple.md#copywithin)
* [entries](_plugnet.tuple.md#entries)
* [eq](_plugnet.tuple.md#eq)
* [every](_plugnet.tuple.md#every)
* [fill](_plugnet.tuple.md#fill)
* [filter](_plugnet.tuple.md#filter)
* [find](_plugnet.tuple.md#find)
* [findIndex](_plugnet.tuple.md#findindex)
* [forEach](_plugnet.tuple.md#foreach)
* [includes](_plugnet.tuple.md#includes)
* [indexOf](_plugnet.tuple.md#indexof)
* [join](_plugnet.tuple.md#join)
* [keys](_plugnet.tuple.md#keys)
* [lastIndexOf](_plugnet.tuple.md#lastindexof)
* [map](_plugnet.tuple.md#map)
* [pop](_plugnet.tuple.md#pop)
* [push](_plugnet.tuple.md#push)
* [reduce](_plugnet.tuple.md#reduce)
* [reduceRight](_plugnet.tuple.md#reduceright)
* [reverse](_plugnet.tuple.md#reverse)
* [shift](_plugnet.tuple.md#shift)
* [slice](_plugnet.tuple.md#slice)
* [some](_plugnet.tuple.md#some)
* [sort](_plugnet.tuple.md#sort)
* [splice](_plugnet.tuple.md#splice)
* [toArray](_plugnet.tuple.md#toarray)
* [toHex](_plugnet.tuple.md#tohex)
* [toJSON](_plugnet.tuple.md#tojson)
* [toLocaleString](_plugnet.tuple.md#tolocalestring)
* [toString](_plugnet.tuple.md#tostring)
* [toU8a](_plugnet.tuple.md#tou8a)
* [unshift](_plugnet.tuple.md#unshift)
* [values](_plugnet.tuple.md#values)
* [with](_plugnet.tuple.md#with)
...
⊕ **new Tuple**(Types: *[TupleConstructors](../modules/_plugnet.md#tupleconstructors)*, value: *`any`*): [Tuple](_plugnet.tuple.md)

*Defined in node_modules/@plugnet/types/codec/Tuple.d.ts:13*
...
**Returns:** [Tuple](_plugnet.tuple.md)
