[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [StorageChangeSet](../classes/_plugnet.storagechangeset.md)

# Class: StorageChangeSet

*__name__*: StorageChangeSet

*__description__*: A set of storage changes. It contains the [Block](_plugnet.block.md) hash and a list of the actual changes that took place as an array of [KeyValueOption](_plugnet.keyvalueoption.md)
...
* [constructor](_plugnet.storagechangeset.md#constructor)

### Properties

* [Type](_plugnet.storagechangeset.md#type)
* [__@toStringTag](_plugnet.storagechangeset.md#___tostringtag)
* [block](_plugnet.storagechangeset.md#block)
* [changes](_plugnet.storagechangeset.md#changes)
* [encodedLength](_plugnet.storagechangeset.md#encodedlength)
* [isEmpty](_plugnet.storagechangeset.md#isempty)
* [size](_plugnet.storagechangeset.md#size)

### Methods

* [__@iterator](_plugnet.storagechangeset.md#___iterator)
* [clear](_plugnet.storagechangeset.md#clear)
* [delete](_plugnet.storagechangeset.md#delete)
* [entries](_plugnet.storagechangeset.md#entries)
* [eq](_plugnet.storagechangeset.md#eq)
* [forEach](_plugnet.storagechangeset.md#foreach)
* [get](_plugnet.storagechangeset.md#get)
* [getAtIndex](_plugnet.storagechangeset.md#getatindex)
* [has](_plugnet.storagechangeset.md#has)
* [keys](_plugnet.storagechangeset.md#keys)
* [set](_plugnet.storagechangeset.md#set)
* [toArray](_plugnet.storagechangeset.md#toarray)
* [toHex](_plugnet.storagechangeset.md#tohex)
* [toJSON](_plugnet.storagechangeset.md#tojson)
* [toString](_plugnet.storagechangeset.md#tostring)
* [toU8a](_plugnet.storagechangeset.md#tou8a)
* [values](_plugnet.storagechangeset.md#values)
* [with](_plugnet.storagechangeset.md#with)
...
⊕ **new StorageChangeSet**(value?: *[StorageChangeSetValue](../modules/_plugnet.md#storagechangesetvalue) \| `Uint8Array`*): [StorageChangeSet](_plugnet.storagechangeset.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/rpc/StorageChangeSet.d.ts:17*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [StorageChangeSetValue](../modules/_plugnet.md#storagechangesetvalue) \| `Uint8Array` |

**Returns:** [StorageChangeSet](_plugnet.storagechangeset.md)
...
**● block**: *[Hash](_plugnet.hash.md)*

*Defined in node_modules/@plugnet/types/rpc/StorageChangeSet.d.ts:26*

*__description__*: The block [Hash](_plugnet.hash.md)
...
**● changes**: *[Vector](_plugnet.vector.md)<[KeyValueOption](_plugnet.keyvalueoption.md)>*

*Defined in node_modules/@plugnet/types/rpc/StorageChangeSet.d.ts:22*

*__description__*: The applicable changes as [KeyValueOption](_plugnet.keyvalueoption.md)
