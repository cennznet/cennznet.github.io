[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [StorageMetadata](../classes/_plugnet.storagemetadata.md)
...
* [constructor](_plugnet.storagemetadata.md#constructor)

### Properties

* [Type](_plugnet.storagemetadata.md#type)
* [__@toStringTag](_plugnet.storagemetadata.md#___tostringtag)
* [encodedLength](_plugnet.storagemetadata.md#encodedlength)
* [functions](_plugnet.storagemetadata.md#functions)
* [isEmpty](_plugnet.storagemetadata.md#isempty)
* [prefix](_plugnet.storagemetadata.md#prefix)
* [size](_plugnet.storagemetadata.md#size)

### Methods

* [__@iterator](_plugnet.storagemetadata.md#___iterator)
* [clear](_plugnet.storagemetadata.md#clear)
* [delete](_plugnet.storagemetadata.md#delete)
* [entries](_plugnet.storagemetadata.md#entries)
* [eq](_plugnet.storagemetadata.md#eq)
* [forEach](_plugnet.storagemetadata.md#foreach)
* [get](_plugnet.storagemetadata.md#get)
* [getAtIndex](_plugnet.storagemetadata.md#getatindex)
* [has](_plugnet.storagemetadata.md#has)
* [keys](_plugnet.storagemetadata.md#keys)
* [set](_plugnet.storagemetadata.md#set)
* [toArray](_plugnet.storagemetadata.md#toarray)
* [toHex](_plugnet.storagemetadata.md#tohex)
* [toJSON](_plugnet.storagemetadata.md#tojson)
* [toString](_plugnet.storagemetadata.md#tostring)
* [toU8a](_plugnet.storagemetadata.md#tou8a)
* [values](_plugnet.storagemetadata.md#values)
* [with](_plugnet.storagemetadata.md#with)
...
⊕ **new StorageMetadata**(value?: *`any`*): [StorageMetadata](_plugnet.storagemetadata.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:107*
...
**Returns:** [StorageMetadata](_plugnet.storagemetadata.md)
...
**● functions**: *[Vector](_plugnet.vector.md)<[StorageFunctionMetadata](_plugnet.storagefunctionmetadata-3.md)>*

*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:112*

*__description__*: The [StorageFunctionMetadata](_plugnet.storagefunctionmetadata-3.md) for the section
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Storage.d.ts:116*
