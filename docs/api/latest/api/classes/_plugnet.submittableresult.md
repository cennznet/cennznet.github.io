[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [SubmittableResult](../classes/_plugnet.submittableresult.md)
...
* [constructor](_plugnet.submittableresult.md#constructor)

### Properties

* [Type](_plugnet.submittableresult.md#type)
* [__@toStringTag](_plugnet.submittableresult.md#___tostringtag)
* [encodedLength](_plugnet.submittableresult.md#encodedlength)
* [events](_plugnet.submittableresult.md#events)
* [isEmpty](_plugnet.submittableresult.md#isempty)
* [size](_plugnet.submittableresult.md#size)
* [status](_plugnet.submittableresult.md#status)

### Methods

* [__@iterator](_plugnet.submittableresult.md#___iterator)
* [clear](_plugnet.submittableresult.md#clear)
* [delete](_plugnet.submittableresult.md#delete)
* [entries](_plugnet.submittableresult.md#entries)
* [eq](_plugnet.submittableresult.md#eq)
* [findRecord](_plugnet.submittableresult.md#findrecord)
* [forEach](_plugnet.submittableresult.md#foreach)
* [get](_plugnet.submittableresult.md#get)
* [getAtIndex](_plugnet.submittableresult.md#getatindex)
* [has](_plugnet.submittableresult.md#has)
* [keys](_plugnet.submittableresult.md#keys)
* [set](_plugnet.submittableresult.md#set)
* [toArray](_plugnet.submittableresult.md#toarray)
* [toHex](_plugnet.submittableresult.md#tohex)
* [toJSON](_plugnet.submittableresult.md#tojson)
* [toString](_plugnet.submittableresult.md#tostring)
* [toU8a](_plugnet.submittableresult.md#tou8a)
* [values](_plugnet.submittableresult.md#values)
* [with](_plugnet.submittableresult.md#with)
...
⊕ **new SubmittableResult**(value?: *`any`*): [SubmittableResult](_plugnet.submittableresult.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/api/SubmittableExtrinsic.d.ts:9*
...
**Returns:** [SubmittableResult](_plugnet.submittableresult.md)
...
**● events**: *`Array`<[EventRecord](_plugnet.eventrecord.md)>*

*Defined in node_modules/@plugnet/api/SubmittableExtrinsic.d.ts:14*
...
**● status**: *[ExtrinsicStatus](_plugnet.extrinsicstatus.md)*

*Defined in node_modules/@plugnet/api/SubmittableExtrinsic.d.ts:18*
...
▸ **findRecord**(section: *`string`*, method: *`string`*): [EventRecord](_plugnet.eventrecord.md) \| `undefined`

*Defined in node_modules/@plugnet/api/SubmittableExtrinsic.d.ts:22*
...
**Returns:** [EventRecord](_plugnet.eventrecord.md) \| `undefined`
