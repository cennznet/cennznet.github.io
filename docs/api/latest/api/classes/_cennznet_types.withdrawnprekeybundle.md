[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [WithdrawnPreKeyBundle](../classes/_cennznet_types.withdrawnprekeybundle.md)
...
* [constructor](_cennznet_types.withdrawnprekeybundle.md#constructor)

### Properties

* [Types](_cennznet_types.withdrawnprekeybundle.md#types)
* [encodedLength](_cennznet_types.withdrawnprekeybundle.md#encodedlength)
* [isEmpty](_cennznet_types.withdrawnprekeybundle.md#isempty)
* [length](_cennznet_types.withdrawnprekeybundle.md#length)

### Methods

* [__@iterator](_cennznet_types.withdrawnprekeybundle.md#___iterator)
* [__@unscopables](_cennznet_types.withdrawnprekeybundle.md#___unscopables)
* [concat](_cennznet_types.withdrawnprekeybundle.md#concat)
* [copyWithin](_cennznet_types.withdrawnprekeybundle.md#copywithin)
* [entries](_cennznet_types.withdrawnprekeybundle.md#entries)
* [eq](_cennznet_types.withdrawnprekeybundle.md#eq)
* [every](_cennznet_types.withdrawnprekeybundle.md#every)
* [fill](_cennznet_types.withdrawnprekeybundle.md#fill)
* [filter](_cennznet_types.withdrawnprekeybundle.md#filter)
* [find](_cennznet_types.withdrawnprekeybundle.md#find)
* [findIndex](_cennznet_types.withdrawnprekeybundle.md#findindex)
* [forEach](_cennznet_types.withdrawnprekeybundle.md#foreach)
* [includes](_cennznet_types.withdrawnprekeybundle.md#includes)
* [indexOf](_cennznet_types.withdrawnprekeybundle.md#indexof)
* [join](_cennznet_types.withdrawnprekeybundle.md#join)
* [keys](_cennznet_types.withdrawnprekeybundle.md#keys)
* [lastIndexOf](_cennznet_types.withdrawnprekeybundle.md#lastindexof)
* [map](_cennznet_types.withdrawnprekeybundle.md#map)
* [pop](_cennznet_types.withdrawnprekeybundle.md#pop)
* [push](_cennznet_types.withdrawnprekeybundle.md#push)
* [reduce](_cennznet_types.withdrawnprekeybundle.md#reduce)
* [reduceRight](_cennznet_types.withdrawnprekeybundle.md#reduceright)
* [reverse](_cennznet_types.withdrawnprekeybundle.md#reverse)
* [shift](_cennznet_types.withdrawnprekeybundle.md#shift)
* [slice](_cennznet_types.withdrawnprekeybundle.md#slice)
* [some](_cennznet_types.withdrawnprekeybundle.md#some)
* [sort](_cennznet_types.withdrawnprekeybundle.md#sort)
* [splice](_cennznet_types.withdrawnprekeybundle.md#splice)
* [toArray](_cennznet_types.withdrawnprekeybundle.md#toarray)
* [toHex](_cennznet_types.withdrawnprekeybundle.md#tohex)
* [toJSON](_cennznet_types.withdrawnprekeybundle.md#tojson)
* [toLocaleString](_cennznet_types.withdrawnprekeybundle.md#tolocalestring)
* [toString](_cennznet_types.withdrawnprekeybundle.md#tostring)
* [toU8a](_cennznet_types.withdrawnprekeybundle.md#tou8a)
* [unshift](_cennznet_types.withdrawnprekeybundle.md#unshift)
* [values](_cennznet_types.withdrawnprekeybundle.md#values)
* [with](_cennznet_types.withdrawnprekeybundle.md#with)
...
⊕ **new WithdrawnPreKeyBundle**(values: *`any`*): [WithdrawnPreKeyBundle](_cennznet_types.withdrawnprekeybundle.md)

*Overrides [Tuple](_plugnet.tuple.md).[constructor](_plugnet.tuple.md#constructor)*

*Defined in packages/types/src/runtime/sylo.ts:117*
...
**Returns:** [WithdrawnPreKeyBundle](_cennznet_types.withdrawnprekeybundle.md)
...
*Defined in packages/types/src/runtime/sylo.ts:122*
