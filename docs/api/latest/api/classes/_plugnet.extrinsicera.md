[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [ExtrinsicEra](../classes/_plugnet.extrinsicera.md)
...
* [constructor](_plugnet.extrinsicera.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.extrinsicera.md#bytes_per_element)
* [__@toStringTag](_plugnet.extrinsicera.md#___tostringtag)
* [buffer](_plugnet.extrinsicera.md#buffer)
* [byteLength](_plugnet.extrinsicera.md#bytelength)
* [byteOffset](_plugnet.extrinsicera.md#byteoffset)
* [encodedLength](_plugnet.extrinsicera.md#encodedlength)
* [isEmpty](_plugnet.extrinsicera.md#isempty)
* [length](_plugnet.extrinsicera.md#length)

### Methods

* [__@iterator](_plugnet.extrinsicera.md#___iterator)
* [copyWithin](_plugnet.extrinsicera.md#copywithin)
* [entries](_plugnet.extrinsicera.md#entries)
* [eq](_plugnet.extrinsicera.md#eq)
* [every](_plugnet.extrinsicera.md#every)
* [fill](_plugnet.extrinsicera.md#fill)
* [filter](_plugnet.extrinsicera.md#filter)
* [find](_plugnet.extrinsicera.md#find)
* [findIndex](_plugnet.extrinsicera.md#findindex)
* [forEach](_plugnet.extrinsicera.md#foreach)
* [includes](_plugnet.extrinsicera.md#includes)
* [indexOf](_plugnet.extrinsicera.md#indexof)
* [join](_plugnet.extrinsicera.md#join)
* [keys](_plugnet.extrinsicera.md#keys)
* [lastIndexOf](_plugnet.extrinsicera.md#lastindexof)
* [map](_plugnet.extrinsicera.md#map)
* [reduce](_plugnet.extrinsicera.md#reduce)
* [reduceRight](_plugnet.extrinsicera.md#reduceright)
* [reverse](_plugnet.extrinsicera.md#reverse)
* [set](_plugnet.extrinsicera.md#set)
* [slice](_plugnet.extrinsicera.md#slice)
* [some](_plugnet.extrinsicera.md#some)
* [sort](_plugnet.extrinsicera.md#sort)
* [subarray](_plugnet.extrinsicera.md#subarray)
* [toHex](_plugnet.extrinsicera.md#tohex)
* [toJSON](_plugnet.extrinsicera.md#tojson)
* [toLocaleString](_plugnet.extrinsicera.md#tolocalestring)
* [toString](_plugnet.extrinsicera.md#tostring)
* [toU8a](_plugnet.extrinsicera.md#tou8a)
* [values](_plugnet.extrinsicera.md#values)
* [decodeExtrinsicEra](_plugnet.extrinsicera.md#decodeextrinsicera)
...
⊕ **new ExtrinsicEra**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [ExtrinsicEra](_plugnet.extrinsicera.md)

*Overrides [U8a](_plugnet.u8a.md).[constructor](_plugnet.u8a.md#constructor)*

*Defined in node_modules/@plugnet/types/type/ExtrinsicEra.d.ts:8*
...
▸ **decodeExtrinsicEra**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): `Uint8Array`

*Defined in node_modules/@plugnet/types/type/ExtrinsicEra.d.ts:10*
