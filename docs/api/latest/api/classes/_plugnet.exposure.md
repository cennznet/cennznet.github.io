[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Exposure](../classes/_plugnet.exposure.md)

# Class: Exposure

*__name__*: Exposure

*__description__*: A snapshot of the stake backing a single validator in the system
...
* [constructor](_plugnet.exposure.md#constructor)

### Properties

* [Type](_plugnet.exposure.md#type)
* [__@toStringTag](_plugnet.exposure.md#___tostringtag)
* [encodedLength](_plugnet.exposure.md#encodedlength)
* [isEmpty](_plugnet.exposure.md#isempty)
* [others](_plugnet.exposure.md#others)
* [own](_plugnet.exposure.md#own)
* [size](_plugnet.exposure.md#size)
* [total](_plugnet.exposure.md#total)

### Methods

* [__@iterator](_plugnet.exposure.md#___iterator)
* [clear](_plugnet.exposure.md#clear)
* [delete](_plugnet.exposure.md#delete)
* [entries](_plugnet.exposure.md#entries)
* [eq](_plugnet.exposure.md#eq)
* [forEach](_plugnet.exposure.md#foreach)
* [get](_plugnet.exposure.md#get)
* [getAtIndex](_plugnet.exposure.md#getatindex)
* [has](_plugnet.exposure.md#has)
* [keys](_plugnet.exposure.md#keys)
* [set](_plugnet.exposure.md#set)
* [toArray](_plugnet.exposure.md#toarray)
* [toHex](_plugnet.exposure.md#tohex)
* [toJSON](_plugnet.exposure.md#tojson)
* [toString](_plugnet.exposure.md#tostring)
* [toU8a](_plugnet.exposure.md#tou8a)
* [values](_plugnet.exposure.md#values)
* [with](_plugnet.exposure.md#with)
...
⊕ **new Exposure**(value?: *`any`*): [Exposure](_plugnet.exposure.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/Exposure.d.ts:10*
...
**Returns:** [Exposure](_plugnet.exposure.md)
...
**● others**: *[Vector](_plugnet.vector.md)<[IndividualExposure](_plugnet.individualexposure.md)>*

*Defined in node_modules/@plugnet/types/type/Exposure.d.ts:23*

*__description__*: The portions of nominators stashes that are exposed
...
**● own**: *[Balance](_plugnet.balance.md)*

*Defined in node_modules/@plugnet/types/type/Exposure.d.ts:15*

*__description__*: The validator's own stash that is exposed
...
*Defined in node_modules/@plugnet/types/type/Exposure.d.ts:19*

*__description__*: The total balance backing this validator
