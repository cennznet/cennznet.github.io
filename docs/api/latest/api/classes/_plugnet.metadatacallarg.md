[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MetadataCallArg](../classes/_plugnet.metadatacallarg.md)

# Class: MetadataCallArg
...
* [constructor](_plugnet.metadatacallarg.md#constructor)

### Properties

* [Type](_plugnet.metadatacallarg.md#type)
* [__@toStringTag](_plugnet.metadatacallarg.md#___tostringtag)
* [encodedLength](_plugnet.metadatacallarg.md#encodedlength)
* [isEmpty](_plugnet.metadatacallarg.md#isempty)
* [name](_plugnet.metadatacallarg.md#name)
* [size](_plugnet.metadatacallarg.md#size)
* [type](_plugnet.metadatacallarg.md#type-1)

### Methods

* [__@iterator](_plugnet.metadatacallarg.md#___iterator)
* [clear](_plugnet.metadatacallarg.md#clear)
* [delete](_plugnet.metadatacallarg.md#delete)
* [entries](_plugnet.metadatacallarg.md#entries)
* [eq](_plugnet.metadatacallarg.md#eq)
* [forEach](_plugnet.metadatacallarg.md#foreach)
* [get](_plugnet.metadatacallarg.md#get)
* [getAtIndex](_plugnet.metadatacallarg.md#getatindex)
* [has](_plugnet.metadatacallarg.md#has)
* [keys](_plugnet.metadatacallarg.md#keys)
* [set](_plugnet.metadatacallarg.md#set)
* [toArray](_plugnet.metadatacallarg.md#toarray)
* [toHex](_plugnet.metadatacallarg.md#tohex)
* [toJSON](_plugnet.metadatacallarg.md#tojson)
* [toString](_plugnet.metadatacallarg.md#tostring)
* [toU8a](_plugnet.metadatacallarg.md#tou8a)
* [values](_plugnet.metadatacallarg.md#values)
* [with](_plugnet.metadatacallarg.md#with)
...
⊕ **new MetadataCallArg**(value?: *`any`*): [MetadataCallArg](_plugnet.metadatacallarg.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v1/Calls.d.ts:5*
...
**Returns:** [MetadataCallArg](_plugnet.metadatacallarg.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v1/Calls.d.ts:10*
...
*Defined in node_modules/@plugnet/types/Metadata/v1/Calls.d.ts:14*

*__description__*: The [Type](_plugnet.metadatacallarg.md#type)
