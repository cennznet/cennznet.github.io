[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [IHash](../interfaces/_plugnet.ihash.md)
...
* [constructor](_plugnet.ihash.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.ihash.md#bytes_per_element)
* [__@toStringTag](_plugnet.ihash.md#___tostringtag)
* [buffer](_plugnet.ihash.md#buffer)
* [byteLength](_plugnet.ihash.md#bytelength)
* [byteOffset](_plugnet.ihash.md#byteoffset)
* [encodedLength](_plugnet.ihash.md#encodedlength)
* [isEmpty](_plugnet.ihash.md#isempty)
* [length](_plugnet.ihash.md#length)

### Methods

* [__@iterator](_plugnet.ihash.md#___iterator)
* [copyWithin](_plugnet.ihash.md#copywithin)
* [entries](_plugnet.ihash.md#entries)
* [eq](_plugnet.ihash.md#eq)
* [every](_plugnet.ihash.md#every)
* [fill](_plugnet.ihash.md#fill)
* [filter](_plugnet.ihash.md#filter)
* [find](_plugnet.ihash.md#find)
* [findIndex](_plugnet.ihash.md#findindex)
* [forEach](_plugnet.ihash.md#foreach)
* [includes](_plugnet.ihash.md#includes)
* [indexOf](_plugnet.ihash.md#indexof)
* [join](_plugnet.ihash.md#join)
* [keys](_plugnet.ihash.md#keys)
* [lastIndexOf](_plugnet.ihash.md#lastindexof)
* [map](_plugnet.ihash.md#map)
* [reduce](_plugnet.ihash.md#reduce)
* [reduceRight](_plugnet.ihash.md#reduceright)
* [reverse](_plugnet.ihash.md#reverse)
* [set](_plugnet.ihash.md#set)
* [slice](_plugnet.ihash.md#slice)
* [some](_plugnet.ihash.md#some)
* [sort](_plugnet.ihash.md#sort)
* [subarray](_plugnet.ihash.md#subarray)
* [toHex](_plugnet.ihash.md#tohex)
* [toJSON](_plugnet.ihash.md#tojson)
* [toLocaleString](_plugnet.ihash.md#tolocalestring)
* [toString](_plugnet.ihash.md#tostring)
* [toU8a](_plugnet.ihash.md#tou8a)
* [values](_plugnet.ihash.md#values)
...
⊕ **new IHash**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [IHash](_plugnet.ihash.md)

*Inherited from [U8a](../classes/_plugnet.u8a.md).[constructor](../classes/_plugnet.u8a.md#constructor)*
...
**Returns:** [IHash](_plugnet.ihash.md)
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[encodedLength](../classes/_plugnet.u8a.md#encodedlength)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[isEmpty](../classes/_plugnet.u8a.md#isempty)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[length](../classes/_plugnet.u8a.md#length)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[eq](../classes/_plugnet.u8a.md#eq)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[subarray](../classes/_plugnet.u8a.md#subarray)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[toHex](../classes/_plugnet.u8a.md#tohex)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[toJSON](../classes/_plugnet.u8a.md#tojson)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[toString](../classes/_plugnet.u8a.md#tostring)*
...
*Inherited from [U8a](../classes/_plugnet.u8a.md).[toU8a](../classes/_plugnet.u8a.md#tou8a)*
