[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MetadataV0](../classes/_plugnet.metadatav0.md)
...
* [constructor](_plugnet.metadatav0.md#constructor)

### Properties

* [Type](_plugnet.metadatav0.md#type)
* [__@toStringTag](_plugnet.metadatav0.md#___tostringtag)
* [calls](_plugnet.metadatav0.md#calls)
* [encodedLength](_plugnet.metadatav0.md#encodedlength)
* [events](_plugnet.metadatav0.md#events)
* [isEmpty](_plugnet.metadatav0.md#isempty)
* [modules](_plugnet.metadatav0.md#modules)
* [size](_plugnet.metadatav0.md#size)

### Methods

* [__@iterator](_plugnet.metadatav0.md#___iterator)
* [clear](_plugnet.metadatav0.md#clear)
* [delete](_plugnet.metadatav0.md#delete)
* [entries](_plugnet.metadatav0.md#entries)
* [eq](_plugnet.metadatav0.md#eq)
* [forEach](_plugnet.metadatav0.md#foreach)
* [get](_plugnet.metadatav0.md#get)
* [getAtIndex](_plugnet.metadatav0.md#getatindex)
* [getUniqTypes](_plugnet.metadatav0.md#getuniqtypes)
* [has](_plugnet.metadatav0.md#has)
* [keys](_plugnet.metadatav0.md#keys)
* [set](_plugnet.metadatav0.md#set)
* [toArray](_plugnet.metadatav0.md#toarray)
* [toHex](_plugnet.metadatav0.md#tohex)
* [toJSON](_plugnet.metadatav0.md#tojson)
* [toString](_plugnet.metadatav0.md#tostring)
* [toU8a](_plugnet.metadatav0.md#tou8a)
* [values](_plugnet.metadatav0.md#values)
* [decodeMetadata](_plugnet.metadatav0.md#decodemetadata)
* [with](_plugnet.metadatav0.md#with)
...
⊕ **new MetadataV0**(value?: *`any`*): [MetadataV0](_plugnet.metadatav0.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Metadata.d.ts:12*
...
**Returns:** [MetadataV0](_plugnet.metadatav0.md)
...
**● calls**: *[Vector](_plugnet.vector.md)<[OuterDispatchCall](_plugnet.outerdispatchcall.md)>*

*Defined in node_modules/@plugnet/types/Metadata/v0/Metadata.d.ts:18*

*__description__*: Wrapped [OuterDispatchCall](_plugnet.outerdispatchcall.md)
...
**● events**: *[Vector](_plugnet.vector.md)<[OuterEventMetadataEvent](_plugnet.outereventmetadataevent.md)>*

*Defined in node_modules/@plugnet/types/Metadata/v0/Metadata.d.ts:22*

*__description__*: Wrapped [OuterEventMetadataEvent](_plugnet.outereventmetadataevent.md)
...
**● modules**: *[Vector](_plugnet.vector.md)<[RuntimeModuleMetadata](_plugnet.runtimemodulemetadata.md)>*

*Defined in node_modules/@plugnet/types/Metadata/v0/Metadata.d.ts:26*

*__description__*: Wrapped [RuntimeModuleMetadata](_plugnet.runtimemodulemetadata.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Metadata.d.ts:33*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Metadata.d.ts:14*
