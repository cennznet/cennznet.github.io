[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [CandidateSignature](../classes/_plugnet.candidatesignature.md)
...
↳  [ExplicitCandidateSignature](_plugnet.explicitcandidatesignature.md)

↳  [ImplicitCandidateSignature](_plugnet.implicitcandidatesignature.md)
...
* [constructor](_plugnet.candidatesignature.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.candidatesignature.md#bytes_per_element)
* [__@toStringTag](_plugnet.candidatesignature.md#___tostringtag)
* [buffer](_plugnet.candidatesignature.md#buffer)
* [byteLength](_plugnet.candidatesignature.md#bytelength)
* [byteOffset](_plugnet.candidatesignature.md#byteoffset)
* [encodedLength](_plugnet.candidatesignature.md#encodedlength)
* [isEmpty](_plugnet.candidatesignature.md#isempty)
* [length](_plugnet.candidatesignature.md#length)

### Methods

* [__@iterator](_plugnet.candidatesignature.md#___iterator)
* [bitLength](_plugnet.candidatesignature.md#bitlength)
* [copyWithin](_plugnet.candidatesignature.md#copywithin)
* [entries](_plugnet.candidatesignature.md#entries)
* [eq](_plugnet.candidatesignature.md#eq)
* [every](_plugnet.candidatesignature.md#every)
* [fill](_plugnet.candidatesignature.md#fill)
* [filter](_plugnet.candidatesignature.md#filter)
* [find](_plugnet.candidatesignature.md#find)
* [findIndex](_plugnet.candidatesignature.md#findindex)
* [forEach](_plugnet.candidatesignature.md#foreach)
* [includes](_plugnet.candidatesignature.md#includes)
* [indexOf](_plugnet.candidatesignature.md#indexof)
* [join](_plugnet.candidatesignature.md#join)
* [keys](_plugnet.candidatesignature.md#keys)
* [lastIndexOf](_plugnet.candidatesignature.md#lastindexof)
* [map](_plugnet.candidatesignature.md#map)
* [reduce](_plugnet.candidatesignature.md#reduce)
* [reduceRight](_plugnet.candidatesignature.md#reduceright)
* [reverse](_plugnet.candidatesignature.md#reverse)
* [set](_plugnet.candidatesignature.md#set)
* [slice](_plugnet.candidatesignature.md#slice)
* [some](_plugnet.candidatesignature.md#some)
* [sort](_plugnet.candidatesignature.md#sort)
* [subarray](_plugnet.candidatesignature.md#subarray)
* [toHex](_plugnet.candidatesignature.md#tohex)
* [toJSON](_plugnet.candidatesignature.md#tojson)
* [toLocaleString](_plugnet.candidatesignature.md#tolocalestring)
* [toString](_plugnet.candidatesignature.md#tostring)
* [toU8a](_plugnet.candidatesignature.md#tou8a)
* [values](_plugnet.candidatesignature.md#values)
...
⊕ **new CandidateSignature**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [CandidateSignature](_plugnet.candidatesignature.md)
...
**Returns:** [CandidateSignature](_plugnet.candidatesignature.md)
