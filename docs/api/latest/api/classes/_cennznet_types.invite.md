[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [Invite](../classes/_cennznet_types.invite.md)
...
* [constructor](_cennznet_types.invite.md#constructor)

### Properties

* [Type](_cennznet_types.invite.md#type)
* [__@toStringTag](_cennznet_types.invite.md#___tostringtag)
* [encodedLength](_cennznet_types.invite.md#encodedlength)
* [isEmpty](_cennznet_types.invite.md#isempty)
* [size](_cennznet_types.invite.md#size)

### Methods

* [__@iterator](_cennznet_types.invite.md#___iterator)
* [clear](_cennznet_types.invite.md#clear)
* [delete](_cennznet_types.invite.md#delete)
* [entries](_cennznet_types.invite.md#entries)
* [eq](_cennznet_types.invite.md#eq)
* [forEach](_cennznet_types.invite.md#foreach)
* [get](_cennznet_types.invite.md#get)
* [getAtIndex](_cennznet_types.invite.md#getatindex)
* [has](_cennznet_types.invite.md#has)
* [keys](_cennznet_types.invite.md#keys)
* [set](_cennznet_types.invite.md#set)
* [toArray](_cennznet_types.invite.md#toarray)
* [toHex](_cennznet_types.invite.md#tohex)
* [toJSON](_cennznet_types.invite.md#tojson)
* [toString](_cennznet_types.invite.md#tostring)
* [toU8a](_cennznet_types.invite.md#tou8a)
* [values](_cennznet_types.invite.md#values)
* [with](_cennznet_types.invite.md#with)
...
⊕ **new Invite**(value: *`any`*): [Invite](_cennznet_types.invite.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in packages/types/src/runtime/sylo.ts:75*
...
**Returns:** [Invite](_cennznet_types.invite.md)
