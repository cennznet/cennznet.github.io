[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [ChangesTrieRoot](../classes/_plugnet.changestrieroot.md)
...
* [constructor](_plugnet.changestrieroot.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.changestrieroot.md#bytes_per_element)
* [__@toStringTag](_plugnet.changestrieroot.md#___tostringtag)
* [buffer](_plugnet.changestrieroot.md#buffer)
* [byteLength](_plugnet.changestrieroot.md#bytelength)
* [byteOffset](_plugnet.changestrieroot.md#byteoffset)
* [encodedLength](_plugnet.changestrieroot.md#encodedlength)
* [isEmpty](_plugnet.changestrieroot.md#isempty)
* [length](_plugnet.changestrieroot.md#length)

### Methods

* [__@iterator](_plugnet.changestrieroot.md#___iterator)
* [bitLength](_plugnet.changestrieroot.md#bitlength)
* [copyWithin](_plugnet.changestrieroot.md#copywithin)
* [entries](_plugnet.changestrieroot.md#entries)
* [eq](_plugnet.changestrieroot.md#eq)
* [every](_plugnet.changestrieroot.md#every)
* [fill](_plugnet.changestrieroot.md#fill)
* [filter](_plugnet.changestrieroot.md#filter)
* [find](_plugnet.changestrieroot.md#find)
* [findIndex](_plugnet.changestrieroot.md#findindex)
* [forEach](_plugnet.changestrieroot.md#foreach)
* [includes](_plugnet.changestrieroot.md#includes)
* [indexOf](_plugnet.changestrieroot.md#indexof)
* [join](_plugnet.changestrieroot.md#join)
* [keys](_plugnet.changestrieroot.md#keys)
* [lastIndexOf](_plugnet.changestrieroot.md#lastindexof)
* [map](_plugnet.changestrieroot.md#map)
* [reduce](_plugnet.changestrieroot.md#reduce)
* [reduceRight](_plugnet.changestrieroot.md#reduceright)
* [reverse](_plugnet.changestrieroot.md#reverse)
* [set](_plugnet.changestrieroot.md#set)
* [slice](_plugnet.changestrieroot.md#slice)
* [some](_plugnet.changestrieroot.md#some)
* [sort](_plugnet.changestrieroot.md#sort)
* [subarray](_plugnet.changestrieroot.md#subarray)
* [toHex](_plugnet.changestrieroot.md#tohex)
* [toJSON](_plugnet.changestrieroot.md#tojson)
* [toLocaleString](_plugnet.changestrieroot.md#tolocalestring)
* [toString](_plugnet.changestrieroot.md#tostring)
* [toU8a](_plugnet.changestrieroot.md#tou8a)
* [values](_plugnet.changestrieroot.md#values)
...
⊕ **new ChangesTrieRoot**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [ChangesTrieRoot](_plugnet.changestrieroot.md)
...
**Returns:** [ChangesTrieRoot](_plugnet.changestrieroot.md)
