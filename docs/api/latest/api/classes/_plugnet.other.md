[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Other](../classes/_plugnet.other.md)

# Class: Other

*__name__*: Other

*__description__*: Log item that is just a stream of [Bytes](_plugnet.bytes.md)
...
* [constructor](_plugnet.other.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.other.md#bytes_per_element)
* [__@toStringTag](_plugnet.other.md#___tostringtag)
* [buffer](_plugnet.other.md#buffer)
* [byteLength](_plugnet.other.md#bytelength)
* [byteOffset](_plugnet.other.md#byteoffset)
* [encodedLength](_plugnet.other.md#encodedlength)
* [isEmpty](_plugnet.other.md#isempty)
* [length](_plugnet.other.md#length)

### Methods

* [__@iterator](_plugnet.other.md#___iterator)
* [copyWithin](_plugnet.other.md#copywithin)
* [entries](_plugnet.other.md#entries)
* [eq](_plugnet.other.md#eq)
* [every](_plugnet.other.md#every)
* [fill](_plugnet.other.md#fill)
* [filter](_plugnet.other.md#filter)
* [find](_plugnet.other.md#find)
* [findIndex](_plugnet.other.md#findindex)
* [forEach](_plugnet.other.md#foreach)
* [includes](_plugnet.other.md#includes)
* [indexOf](_plugnet.other.md#indexof)
* [join](_plugnet.other.md#join)
* [keys](_plugnet.other.md#keys)
* [lastIndexOf](_plugnet.other.md#lastindexof)
* [map](_plugnet.other.md#map)
* [reduce](_plugnet.other.md#reduce)
* [reduceRight](_plugnet.other.md#reduceright)
* [reverse](_plugnet.other.md#reverse)
* [set](_plugnet.other.md#set)
* [slice](_plugnet.other.md#slice)
* [some](_plugnet.other.md#some)
* [sort](_plugnet.other.md#sort)
* [subarray](_plugnet.other.md#subarray)
* [toHex](_plugnet.other.md#tohex)
* [toJSON](_plugnet.other.md#tojson)
* [toLocaleString](_plugnet.other.md#tolocalestring)
* [toString](_plugnet.other.md#tostring)
* [toU8a](_plugnet.other.md#tou8a)
* [values](_plugnet.other.md#values)
...
⊕ **new Other**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [Other](_plugnet.other.md)
...
**Returns:** [Other](_plugnet.other.md)
