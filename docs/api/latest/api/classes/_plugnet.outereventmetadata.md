[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [OuterEventMetadata](../classes/_plugnet.outereventmetadata.md)

# Class: OuterEventMetadata
...
* [constructor](_plugnet.outereventmetadata.md#constructor)

### Properties

* [Type](_plugnet.outereventmetadata.md#type)
* [__@toStringTag](_plugnet.outereventmetadata.md#___tostringtag)
* [encodedLength](_plugnet.outereventmetadata.md#encodedlength)
* [events](_plugnet.outereventmetadata.md#events)
* [isEmpty](_plugnet.outereventmetadata.md#isempty)
* [name](_plugnet.outereventmetadata.md#name)
* [size](_plugnet.outereventmetadata.md#size)

### Methods

* [__@iterator](_plugnet.outereventmetadata.md#___iterator)
* [clear](_plugnet.outereventmetadata.md#clear)
* [delete](_plugnet.outereventmetadata.md#delete)
* [entries](_plugnet.outereventmetadata.md#entries)
* [eq](_plugnet.outereventmetadata.md#eq)
* [forEach](_plugnet.outereventmetadata.md#foreach)
* [get](_plugnet.outereventmetadata.md#get)
* [getAtIndex](_plugnet.outereventmetadata.md#getatindex)
* [has](_plugnet.outereventmetadata.md#has)
* [keys](_plugnet.outereventmetadata.md#keys)
* [set](_plugnet.outereventmetadata.md#set)
* [toArray](_plugnet.outereventmetadata.md#toarray)
* [toHex](_plugnet.outereventmetadata.md#tohex)
* [toJSON](_plugnet.outereventmetadata.md#tojson)
* [toString](_plugnet.outereventmetadata.md#tostring)
* [toU8a](_plugnet.outereventmetadata.md#tou8a)
* [values](_plugnet.outereventmetadata.md#values)
* [with](_plugnet.outereventmetadata.md#with)
...
⊕ **new OuterEventMetadata**(value?: *`any`*): [OuterEventMetadata](_plugnet.outereventmetadata.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Events.d.ts:37*
...
**Returns:** [OuterEventMetadata](_plugnet.outereventmetadata.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Events.d.ts:42*

*__description__*: The [OuterEventMetadataEvent](_plugnet.outereventmetadataevent.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Events.d.ts:46*
