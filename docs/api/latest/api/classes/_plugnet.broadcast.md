[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Broadcast](../classes/_plugnet.broadcast.md)

# Class: Broadcast

*__name__*: Broadcast

*__description__*: An [ExtrinsicStatus](_plugnet.extrinsicstatus.md) indicating that the [Extrinsic](_plugnet.extrinsic.md) has been boradcast to peers
...
* [constructor](_plugnet.broadcast.md#constructor)

### Properties

* [Type](_plugnet.broadcast.md#type)
* [encodedLength](_plugnet.broadcast.md#encodedlength)
* [isEmpty](_plugnet.broadcast.md#isempty)
* [length](_plugnet.broadcast.md#length)

### Methods

* [__@iterator](_plugnet.broadcast.md#___iterator)
* [__@unscopables](_plugnet.broadcast.md#___unscopables)
* [concat](_plugnet.broadcast.md#concat)
* [copyWithin](_plugnet.broadcast.md#copywithin)
* [entries](_plugnet.broadcast.md#entries)
* [eq](_plugnet.broadcast.md#eq)
* [every](_plugnet.broadcast.md#every)
* [fill](_plugnet.broadcast.md#fill)
* [filter](_plugnet.broadcast.md#filter)
* [find](_plugnet.broadcast.md#find)
* [findIndex](_plugnet.broadcast.md#findindex)
* [forEach](_plugnet.broadcast.md#foreach)
* [includes](_plugnet.broadcast.md#includes)
* [indexOf](_plugnet.broadcast.md#indexof)
* [join](_plugnet.broadcast.md#join)
* [keys](_plugnet.broadcast.md#keys)
* [lastIndexOf](_plugnet.broadcast.md#lastindexof)
* [map](_plugnet.broadcast.md#map)
* [pop](_plugnet.broadcast.md#pop)
* [push](_plugnet.broadcast.md#push)
* [reduce](_plugnet.broadcast.md#reduce)
* [reduceRight](_plugnet.broadcast.md#reduceright)
* [reverse](_plugnet.broadcast.md#reverse)
* [shift](_plugnet.broadcast.md#shift)
* [slice](_plugnet.broadcast.md#slice)
* [some](_plugnet.broadcast.md#some)
* [sort](_plugnet.broadcast.md#sort)
* [splice](_plugnet.broadcast.md#splice)
* [toArray](_plugnet.broadcast.md#toarray)
* [toHex](_plugnet.broadcast.md#tohex)
* [toJSON](_plugnet.broadcast.md#tojson)
* [toLocaleString](_plugnet.broadcast.md#tolocalestring)
* [toString](_plugnet.broadcast.md#tostring)
* [toU8a](_plugnet.broadcast.md#tou8a)
* [unshift](_plugnet.broadcast.md#unshift)
* [values](_plugnet.broadcast.md#values)
* [decodeVector](_plugnet.broadcast.md#decodevector)
* [with](_plugnet.broadcast.md#with)
...
⊕ **new Broadcast**(Type: *[Constructor](../interfaces/_plugnet.constructor.md)<`T`>*, value?: *[Vector](_plugnet.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [Broadcast](_plugnet.broadcast.md)
...
**Returns:** [Broadcast](_plugnet.broadcast.md)
