[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MetadataV1](../classes/_plugnet.metadatav1.md)
...
* [constructor](_plugnet.metadatav1.md#constructor)

### Properties

* [Type](_plugnet.metadatav1.md#type)
* [__@toStringTag](_plugnet.metadatav1.md#___tostringtag)
* [encodedLength](_plugnet.metadatav1.md#encodedlength)
* [isEmpty](_plugnet.metadatav1.md#isempty)
* [modules](_plugnet.metadatav1.md#modules)
* [size](_plugnet.metadatav1.md#size)

### Methods

* [__@iterator](_plugnet.metadatav1.md#___iterator)
* [clear](_plugnet.metadatav1.md#clear)
* [delete](_plugnet.metadatav1.md#delete)
* [entries](_plugnet.metadatav1.md#entries)
* [eq](_plugnet.metadatav1.md#eq)
* [forEach](_plugnet.metadatav1.md#foreach)
* [get](_plugnet.metadatav1.md#get)
* [getAtIndex](_plugnet.metadatav1.md#getatindex)
* [getUniqTypes](_plugnet.metadatav1.md#getuniqtypes)
* [has](_plugnet.metadatav1.md#has)
* [keys](_plugnet.metadatav1.md#keys)
* [set](_plugnet.metadatav1.md#set)
* [toArray](_plugnet.metadatav1.md#toarray)
* [toHex](_plugnet.metadatav1.md#tohex)
* [toJSON](_plugnet.metadatav1.md#tojson)
* [toString](_plugnet.metadatav1.md#tostring)
* [toU8a](_plugnet.metadatav1.md#tou8a)
* [values](_plugnet.metadatav1.md#values)
* [with](_plugnet.metadatav1.md#with)
...
⊕ **new MetadataV1**(value?: *`any`*): [MetadataV1](_plugnet.metadatav1.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v1/Metadata.d.ts:42*
...
**Returns:** [MetadataV1](_plugnet.metadatav1.md)
...
**● modules**: *[Vector](_plugnet.vector.md)<[MetadataModule](_plugnet.metadatamodule-1.md)>*

*Defined in node_modules/@plugnet/types/Metadata/v1/Metadata.d.ts:47*
...
*Defined in node_modules/@plugnet/types/Metadata/v1/Metadata.d.ts:54*
