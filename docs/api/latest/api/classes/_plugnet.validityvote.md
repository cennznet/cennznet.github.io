[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [ValidityVote](../classes/_plugnet.validityvote.md)
...
* [constructor](_plugnet.validityvote.md#constructor)

### Properties

* [Types](_plugnet.validityvote.md#types)
* [encodedLength](_plugnet.validityvote.md#encodedlength)
* [isEmpty](_plugnet.validityvote.md#isempty)
* [length](_plugnet.validityvote.md#length)

### Methods

* [__@iterator](_plugnet.validityvote.md#___iterator)
* [__@unscopables](_plugnet.validityvote.md#___unscopables)
* [concat](_plugnet.validityvote.md#concat)
* [copyWithin](_plugnet.validityvote.md#copywithin)
* [entries](_plugnet.validityvote.md#entries)
* [eq](_plugnet.validityvote.md#eq)
* [every](_plugnet.validityvote.md#every)
* [fill](_plugnet.validityvote.md#fill)
* [filter](_plugnet.validityvote.md#filter)
* [find](_plugnet.validityvote.md#find)
* [findIndex](_plugnet.validityvote.md#findindex)
* [forEach](_plugnet.validityvote.md#foreach)
* [includes](_plugnet.validityvote.md#includes)
* [indexOf](_plugnet.validityvote.md#indexof)
* [join](_plugnet.validityvote.md#join)
* [keys](_plugnet.validityvote.md#keys)
* [lastIndexOf](_plugnet.validityvote.md#lastindexof)
* [map](_plugnet.validityvote.md#map)
* [pop](_plugnet.validityvote.md#pop)
* [push](_plugnet.validityvote.md#push)
* [reduce](_plugnet.validityvote.md#reduce)
* [reduceRight](_plugnet.validityvote.md#reduceright)
* [reverse](_plugnet.validityvote.md#reverse)
* [shift](_plugnet.validityvote.md#shift)
* [slice](_plugnet.validityvote.md#slice)
* [some](_plugnet.validityvote.md#some)
* [sort](_plugnet.validityvote.md#sort)
* [splice](_plugnet.validityvote.md#splice)
* [toArray](_plugnet.validityvote.md#toarray)
* [toHex](_plugnet.validityvote.md#tohex)
* [toJSON](_plugnet.validityvote.md#tojson)
* [toLocaleString](_plugnet.validityvote.md#tolocalestring)
* [toString](_plugnet.validityvote.md#tostring)
* [toU8a](_plugnet.validityvote.md#tou8a)
* [unshift](_plugnet.validityvote.md#unshift)
* [values](_plugnet.validityvote.md#values)
* [with](_plugnet.validityvote.md#with)
...
⊕ **new ValidityVote**(Types: *[TupleConstructors](../modules/_plugnet.md#tupleconstructors)*, value: *`any`*): [ValidityVote](_plugnet.validityvote.md)
...
**Returns:** [ValidityVote](_plugnet.validityvote.md)
