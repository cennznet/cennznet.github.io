[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Finalized](../classes/_plugnet.finalized.md)

# Class: Finalized

*__name__*: Finalized

*__description__*: An \[\[ExtrinsicStatus\] indicating that the [Extrinsic](_plugnet.extrinsic.md)\] has been finalized and included
...
* [constructor](_plugnet.finalized.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.finalized.md#bytes_per_element)
* [__@toStringTag](_plugnet.finalized.md#___tostringtag)
* [buffer](_plugnet.finalized.md#buffer)
* [byteLength](_plugnet.finalized.md#bytelength)
* [byteOffset](_plugnet.finalized.md#byteoffset)
* [encodedLength](_plugnet.finalized.md#encodedlength)
* [isEmpty](_plugnet.finalized.md#isempty)
* [length](_plugnet.finalized.md#length)

### Methods

* [__@iterator](_plugnet.finalized.md#___iterator)
* [bitLength](_plugnet.finalized.md#bitlength)
* [copyWithin](_plugnet.finalized.md#copywithin)
* [entries](_plugnet.finalized.md#entries)
* [eq](_plugnet.finalized.md#eq)
* [every](_plugnet.finalized.md#every)
* [fill](_plugnet.finalized.md#fill)
* [filter](_plugnet.finalized.md#filter)
* [find](_plugnet.finalized.md#find)
* [findIndex](_plugnet.finalized.md#findindex)
* [forEach](_plugnet.finalized.md#foreach)
* [includes](_plugnet.finalized.md#includes)
* [indexOf](_plugnet.finalized.md#indexof)
* [join](_plugnet.finalized.md#join)
* [keys](_plugnet.finalized.md#keys)
* [lastIndexOf](_plugnet.finalized.md#lastindexof)
* [map](_plugnet.finalized.md#map)
* [reduce](_plugnet.finalized.md#reduce)
* [reduceRight](_plugnet.finalized.md#reduceright)
* [reverse](_plugnet.finalized.md#reverse)
* [set](_plugnet.finalized.md#set)
* [slice](_plugnet.finalized.md#slice)
* [some](_plugnet.finalized.md#some)
* [sort](_plugnet.finalized.md#sort)
* [subarray](_plugnet.finalized.md#subarray)
* [toHex](_plugnet.finalized.md#tohex)
* [toJSON](_plugnet.finalized.md#tojson)
* [toLocaleString](_plugnet.finalized.md#tolocalestring)
* [toString](_plugnet.finalized.md#tostring)
* [toU8a](_plugnet.finalized.md#tou8a)
* [values](_plugnet.finalized.md#values)
...
⊕ **new Finalized**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [Finalized](_plugnet.finalized.md)
...
**Returns:** [Finalized](_plugnet.finalized.md)
