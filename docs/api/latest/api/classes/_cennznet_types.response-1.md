[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [Response](../classes/_cennznet_types.response-1.md)

# Class: Response

## Hierarchy

↳  [EnumType](_plugnet.enumtype.md)<[DeviceIdResponse](_cennznet_types.deviceidresponse-1.md) \| [PreKeyBundlesResponse](_cennznet_types.prekeybundlesresponse-1.md)>
...
* [constructor](_cennznet_types.response-1.md#constructor)

### Properties

* [encodedLength](_cennznet_types.response-1.md#encodedlength)
* [index](_cennznet_types.response-1.md#index)
* [isEmpty](_cennznet_types.response-1.md#isempty)
* [isNone](_cennznet_types.response-1.md#isnone)
* [isNull](_cennznet_types.response-1.md#isnull)
* [type](_cennznet_types.response-1.md#type)
* [value](_cennznet_types.response-1.md#value)

### Methods

* [eq](_cennznet_types.response-1.md#eq)
* [toHex](_cennznet_types.response-1.md#tohex)
* [toJSON](_cennznet_types.response-1.md#tojson)
* [toNumber](_cennznet_types.response-1.md#tonumber)
* [toString](_cennznet_types.response-1.md#tostring)
* [toU8a](_cennznet_types.response-1.md#tou8a)
* [with](_cennznet_types.response-1.md#with)
...
⊕ **new Response**(value: *`any`*, index: *`any`*): [Response](_cennznet_types.response-1.md)

*Overrides [EnumType](_plugnet.enumtype.md).[constructor](_plugnet.enumtype.md#constructor)*

*Defined in packages/types/src/runtime/sylo.ts:133*
...
**Returns:** [Response](_cennznet_types.response-1.md)
