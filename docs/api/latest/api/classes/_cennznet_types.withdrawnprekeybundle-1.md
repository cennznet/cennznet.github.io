[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [WithdrawnPreKeyBundle](../classes/_cennznet_types.withdrawnprekeybundle-1.md)

# Class: WithdrawnPreKeyBundle
...
* [constructor](_cennznet_types.withdrawnprekeybundle-1.md#constructor)

### Properties

* [Types](_cennznet_types.withdrawnprekeybundle-1.md#types)
* [encodedLength](_cennznet_types.withdrawnprekeybundle-1.md#encodedlength)
* [isEmpty](_cennznet_types.withdrawnprekeybundle-1.md#isempty)
* [length](_cennznet_types.withdrawnprekeybundle-1.md#length)

### Methods

* [__@iterator](_cennznet_types.withdrawnprekeybundle-1.md#___iterator)
* [__@unscopables](_cennznet_types.withdrawnprekeybundle-1.md#___unscopables)
* [concat](_cennznet_types.withdrawnprekeybundle-1.md#concat)
* [copyWithin](_cennznet_types.withdrawnprekeybundle-1.md#copywithin)
* [entries](_cennznet_types.withdrawnprekeybundle-1.md#entries)
* [eq](_cennznet_types.withdrawnprekeybundle-1.md#eq)
* [every](_cennznet_types.withdrawnprekeybundle-1.md#every)
* [fill](_cennznet_types.withdrawnprekeybundle-1.md#fill)
* [filter](_cennznet_types.withdrawnprekeybundle-1.md#filter)
* [find](_cennznet_types.withdrawnprekeybundle-1.md#find)
* [findIndex](_cennznet_types.withdrawnprekeybundle-1.md#findindex)
* [forEach](_cennznet_types.withdrawnprekeybundle-1.md#foreach)
* [includes](_cennznet_types.withdrawnprekeybundle-1.md#includes)
* [indexOf](_cennznet_types.withdrawnprekeybundle-1.md#indexof)
* [join](_cennznet_types.withdrawnprekeybundle-1.md#join)
* [keys](_cennznet_types.withdrawnprekeybundle-1.md#keys)
* [lastIndexOf](_cennznet_types.withdrawnprekeybundle-1.md#lastindexof)
* [map](_cennznet_types.withdrawnprekeybundle-1.md#map)
* [pop](_cennznet_types.withdrawnprekeybundle-1.md#pop)
* [push](_cennznet_types.withdrawnprekeybundle-1.md#push)
* [reduce](_cennznet_types.withdrawnprekeybundle-1.md#reduce)
* [reduceRight](_cennznet_types.withdrawnprekeybundle-1.md#reduceright)
* [reverse](_cennznet_types.withdrawnprekeybundle-1.md#reverse)
* [shift](_cennznet_types.withdrawnprekeybundle-1.md#shift)
* [slice](_cennznet_types.withdrawnprekeybundle-1.md#slice)
* [some](_cennznet_types.withdrawnprekeybundle-1.md#some)
* [sort](_cennznet_types.withdrawnprekeybundle-1.md#sort)
* [splice](_cennznet_types.withdrawnprekeybundle-1.md#splice)
* [toArray](_cennznet_types.withdrawnprekeybundle-1.md#toarray)
* [toHex](_cennznet_types.withdrawnprekeybundle-1.md#tohex)
* [toJSON](_cennznet_types.withdrawnprekeybundle-1.md#tojson)
* [toLocaleString](_cennznet_types.withdrawnprekeybundle-1.md#tolocalestring)
* [toString](_cennznet_types.withdrawnprekeybundle-1.md#tostring)
* [toU8a](_cennznet_types.withdrawnprekeybundle-1.md#tou8a)
* [unshift](_cennznet_types.withdrawnprekeybundle-1.md#unshift)
* [values](_cennznet_types.withdrawnprekeybundle-1.md#values)
* [with](_cennznet_types.withdrawnprekeybundle-1.md#with)
...
⊕ **new WithdrawnPreKeyBundle**(values: *`any`*): [WithdrawnPreKeyBundle](_cennznet_types.withdrawnprekeybundle-1.md)

*Overrides [Tuple](_plugnet.tuple.md).[constructor](_plugnet.tuple.md#constructor)*

*Defined in node_modules/@cennznet/types/src/runtime/sylo.ts:117*
...
**Returns:** [WithdrawnPreKeyBundle](_cennznet_types.withdrawnprekeybundle-1.md)
...
*Overrides [AbstractArray](_plugnet.abstractarray.md).[toJSON](_plugnet.abstractarray.md#tojson)*

*Defined in node_modules/@cennznet/types/src/runtime/sylo.ts:122*
