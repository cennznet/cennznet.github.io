[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [PreKeyBundle](../classes/_cennznet_types.prekeybundle.md)
...
* [constructor](_cennznet_types.prekeybundle.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_cennznet_types.prekeybundle.md#bytes_per_element)
* [__@toStringTag](_cennznet_types.prekeybundle.md#___tostringtag)
* [buffer](_cennznet_types.prekeybundle.md#buffer)
* [byteLength](_cennznet_types.prekeybundle.md#bytelength)
* [byteOffset](_cennznet_types.prekeybundle.md#byteoffset)
* [encodedLength](_cennznet_types.prekeybundle.md#encodedlength)
* [isEmpty](_cennznet_types.prekeybundle.md#isempty)
* [length](_cennznet_types.prekeybundle.md#length)

### Methods

* [__@iterator](_cennznet_types.prekeybundle.md#___iterator)
* [copyWithin](_cennznet_types.prekeybundle.md#copywithin)
* [entries](_cennznet_types.prekeybundle.md#entries)
* [eq](_cennznet_types.prekeybundle.md#eq)
* [every](_cennznet_types.prekeybundle.md#every)
* [fill](_cennznet_types.prekeybundle.md#fill)
* [filter](_cennznet_types.prekeybundle.md#filter)
* [find](_cennznet_types.prekeybundle.md#find)
* [findIndex](_cennznet_types.prekeybundle.md#findindex)
* [forEach](_cennznet_types.prekeybundle.md#foreach)
* [includes](_cennznet_types.prekeybundle.md#includes)
* [indexOf](_cennznet_types.prekeybundle.md#indexof)
* [join](_cennznet_types.prekeybundle.md#join)
* [keys](_cennznet_types.prekeybundle.md#keys)
* [lastIndexOf](_cennznet_types.prekeybundle.md#lastindexof)
* [map](_cennznet_types.prekeybundle.md#map)
* [reduce](_cennznet_types.prekeybundle.md#reduce)
* [reduceRight](_cennznet_types.prekeybundle.md#reduceright)
* [reverse](_cennznet_types.prekeybundle.md#reverse)
* [set](_cennznet_types.prekeybundle.md#set)
* [slice](_cennznet_types.prekeybundle.md#slice)
* [some](_cennznet_types.prekeybundle.md#some)
* [sort](_cennznet_types.prekeybundle.md#sort)
* [subarray](_cennznet_types.prekeybundle.md#subarray)
* [toHex](_cennznet_types.prekeybundle.md#tohex)
* [toJSON](_cennznet_types.prekeybundle.md#tojson)
* [toLocaleString](_cennznet_types.prekeybundle.md#tolocalestring)
* [toString](_cennznet_types.prekeybundle.md#tostring)
* [toU8a](_cennznet_types.prekeybundle.md#tou8a)
* [values](_cennznet_types.prekeybundle.md#values)
...
⊕ **new PreKeyBundle**(values: *`any`*): [PreKeyBundle](_cennznet_types.prekeybundle.md)

*Overrides [Bytes](_plugnet.bytes.md).[constructor](_plugnet.bytes.md#constructor)*

*Defined in node_modules/@cennznet/types/src/runtime/sylo.ts:109*
...
**Returns:** [PreKeyBundle](_cennznet_types.prekeybundle.md)
