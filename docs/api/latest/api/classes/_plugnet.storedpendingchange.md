[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [StoredPendingChange](../classes/_plugnet.storedpendingchange.md)
...
* [constructor](_plugnet.storedpendingchange.md#constructor)

### Properties

* [Type](_plugnet.storedpendingchange.md#type)
* [__@toStringTag](_plugnet.storedpendingchange.md#___tostringtag)
* [delay](_plugnet.storedpendingchange.md#delay)
* [encodedLength](_plugnet.storedpendingchange.md#encodedlength)
* [isEmpty](_plugnet.storedpendingchange.md#isempty)
* [nextAuthorities](_plugnet.storedpendingchange.md#nextauthorities)
* [scheduledAt](_plugnet.storedpendingchange.md#scheduledat)
* [size](_plugnet.storedpendingchange.md#size)

### Methods

* [__@iterator](_plugnet.storedpendingchange.md#___iterator)
* [clear](_plugnet.storedpendingchange.md#clear)
* [delete](_plugnet.storedpendingchange.md#delete)
* [entries](_plugnet.storedpendingchange.md#entries)
* [eq](_plugnet.storedpendingchange.md#eq)
* [forEach](_plugnet.storedpendingchange.md#foreach)
* [get](_plugnet.storedpendingchange.md#get)
* [getAtIndex](_plugnet.storedpendingchange.md#getatindex)
* [has](_plugnet.storedpendingchange.md#has)
* [keys](_plugnet.storedpendingchange.md#keys)
* [set](_plugnet.storedpendingchange.md#set)
* [toArray](_plugnet.storedpendingchange.md#toarray)
* [toHex](_plugnet.storedpendingchange.md#tohex)
* [toJSON](_plugnet.storedpendingchange.md#tojson)
* [toString](_plugnet.storedpendingchange.md#tostring)
* [toU8a](_plugnet.storedpendingchange.md#tou8a)
* [values](_plugnet.storedpendingchange.md#values)
* [with](_plugnet.storedpendingchange.md#with)
...
⊕ **new StoredPendingChange**(value?: *`Uint8Array` \| [StoredPendingChangeValue](../modules/_plugnet.md#storedpendingchangevalue)*): [StoredPendingChange](_plugnet.storedpendingchange.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/StoredPendingChange.d.ts:32*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | `Uint8Array` \| [StoredPendingChangeValue](../modules/_plugnet.md#storedpendingchangevalue) |

**Returns:** [StoredPendingChange](_plugnet.storedpendingchange.md)
...
*Defined in node_modules/@plugnet/types/type/StoredPendingChange.d.ts:34*
...
**● nextAuthorities**: *[Vector](_plugnet.vector.md)<[NextAuthority](_plugnet.nextauthority.md)>*

*Defined in node_modules/@plugnet/types/type/StoredPendingChange.d.ts:35*
...
**● scheduledAt**: *[BlockNumber](_plugnet.blocknumber.md)*

*Defined in node_modules/@plugnet/types/type/StoredPendingChange.d.ts:36*
