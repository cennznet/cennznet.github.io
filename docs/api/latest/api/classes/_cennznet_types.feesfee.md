[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [FeesFee](../classes/_cennznet_types.feesfee.md)
...
⊕ **new FeesFee**(index?: *`string` \| `Uint8Array` \| `number`*): [FeesFee](_cennznet_types.feesfee.md)
