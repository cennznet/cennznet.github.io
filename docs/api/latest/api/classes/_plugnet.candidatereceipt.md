[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [CandidateReceipt](../classes/_plugnet.candidatereceipt.md)
...
* [constructor](_plugnet.candidatereceipt.md#constructor)

### Properties

* [Type](_plugnet.candidatereceipt.md#type)
* [__@toStringTag](_plugnet.candidatereceipt.md#___tostringtag)
* [encodedLength](_plugnet.candidatereceipt.md#encodedlength)
* [isEmpty](_plugnet.candidatereceipt.md#isempty)
* [size](_plugnet.candidatereceipt.md#size)

### Methods

* [__@iterator](_plugnet.candidatereceipt.md#___iterator)
* [clear](_plugnet.candidatereceipt.md#clear)
* [delete](_plugnet.candidatereceipt.md#delete)
* [entries](_plugnet.candidatereceipt.md#entries)
* [eq](_plugnet.candidatereceipt.md#eq)
* [forEach](_plugnet.candidatereceipt.md#foreach)
* [get](_plugnet.candidatereceipt.md#get)
* [getAtIndex](_plugnet.candidatereceipt.md#getatindex)
* [has](_plugnet.candidatereceipt.md#has)
* [keys](_plugnet.candidatereceipt.md#keys)
* [set](_plugnet.candidatereceipt.md#set)
* [toArray](_plugnet.candidatereceipt.md#toarray)
* [toHex](_plugnet.candidatereceipt.md#tohex)
* [toJSON](_plugnet.candidatereceipt.md#tojson)
* [toString](_plugnet.candidatereceipt.md#tostring)
* [toU8a](_plugnet.candidatereceipt.md#tou8a)
* [values](_plugnet.candidatereceipt.md#values)
* [with](_plugnet.candidatereceipt.md#with)
...
⊕ **new CandidateReceipt**(value?: *`any`*): [CandidateReceipt](_plugnet.candidatereceipt.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/AttestedCandidate.d.ts:17*
...
**Returns:** [CandidateReceipt](_plugnet.candidatereceipt.md)
