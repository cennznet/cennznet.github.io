[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [BftHashSignature](../classes/_plugnet.bfthashsignature.md)
...
* [constructor](_plugnet.bfthashsignature.md#constructor)

### Properties

* [Types](_plugnet.bfthashsignature.md#types)
* [encodedLength](_plugnet.bfthashsignature.md#encodedlength)
* [hash](_plugnet.bfthashsignature.md#hash)
* [isEmpty](_plugnet.bfthashsignature.md#isempty)
* [length](_plugnet.bfthashsignature.md#length)
* [signature](_plugnet.bfthashsignature.md#signature)

### Methods

* [__@iterator](_plugnet.bfthashsignature.md#___iterator)
* [__@unscopables](_plugnet.bfthashsignature.md#___unscopables)
* [concat](_plugnet.bfthashsignature.md#concat)
* [copyWithin](_plugnet.bfthashsignature.md#copywithin)
* [entries](_plugnet.bfthashsignature.md#entries)
* [eq](_plugnet.bfthashsignature.md#eq)
* [every](_plugnet.bfthashsignature.md#every)
* [fill](_plugnet.bfthashsignature.md#fill)
* [filter](_plugnet.bfthashsignature.md#filter)
* [find](_plugnet.bfthashsignature.md#find)
* [findIndex](_plugnet.bfthashsignature.md#findindex)
* [forEach](_plugnet.bfthashsignature.md#foreach)
* [includes](_plugnet.bfthashsignature.md#includes)
* [indexOf](_plugnet.bfthashsignature.md#indexof)
* [join](_plugnet.bfthashsignature.md#join)
* [keys](_plugnet.bfthashsignature.md#keys)
* [lastIndexOf](_plugnet.bfthashsignature.md#lastindexof)
* [map](_plugnet.bfthashsignature.md#map)
* [pop](_plugnet.bfthashsignature.md#pop)
* [push](_plugnet.bfthashsignature.md#push)
* [reduce](_plugnet.bfthashsignature.md#reduce)
* [reduceRight](_plugnet.bfthashsignature.md#reduceright)
* [reverse](_plugnet.bfthashsignature.md#reverse)
* [shift](_plugnet.bfthashsignature.md#shift)
* [slice](_plugnet.bfthashsignature.md#slice)
* [some](_plugnet.bfthashsignature.md#some)
* [sort](_plugnet.bfthashsignature.md#sort)
* [splice](_plugnet.bfthashsignature.md#splice)
* [toArray](_plugnet.bfthashsignature.md#toarray)
* [toHex](_plugnet.bfthashsignature.md#tohex)
* [toJSON](_plugnet.bfthashsignature.md#tojson)
* [toLocaleString](_plugnet.bfthashsignature.md#tolocalestring)
* [toString](_plugnet.bfthashsignature.md#tostring)
* [toU8a](_plugnet.bfthashsignature.md#tou8a)
* [unshift](_plugnet.bfthashsignature.md#unshift)
* [values](_plugnet.bfthashsignature.md#values)
* [with](_plugnet.bfthashsignature.md#with)
...
⊕ **new BftHashSignature**(value?: *[BftHashSignatureValue](../modules/_plugnet.md#bfthashsignaturevalue) \| `Uint8Array`*): [BftHashSignature](_plugnet.bfthashsignature.md)

*Overrides [Tuple](_plugnet.tuple.md).[constructor](_plugnet.tuple.md#constructor)*

*Defined in node_modules/@plugnet/types/type/Bft.d.ts:31*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [BftHashSignatureValue](../modules/_plugnet.md#bfthashsignaturevalue) \| `Uint8Array` |

**Returns:** [BftHashSignature](_plugnet.bfthashsignature.md)
...
*Defined in node_modules/@plugnet/types/type/Bft.d.ts:36*

*__description__*: The wrapped [Hash](_plugnet.hash.md)
...
*Defined in node_modules/@plugnet/types/type/Bft.d.ts:40*

*__description__*: The wrapped [Signature](_plugnet.signature.md)
