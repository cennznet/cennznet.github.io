[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [PendingExtrinsics](../classes/_plugnet.pendingextrinsics.md)

# Class: PendingExtrinsics

*__name__*: PendingExtrinsics

*__description__*: A list of pending [Extrinsics](_plugnet.extrinsics.md)

## Type parameters
#### T :  [Codec](../interfaces/_plugnet.codec.md)
## Hierarchy

↳  [Extrinsics](_plugnet.extrinsics.md)
...
* [constructor](_plugnet.pendingextrinsics.md#constructor)

### Properties

* [Type](_plugnet.pendingextrinsics.md#type)
* [encodedLength](_plugnet.pendingextrinsics.md#encodedlength)
* [isEmpty](_plugnet.pendingextrinsics.md#isempty)
* [length](_plugnet.pendingextrinsics.md#length)

### Methods

* [__@iterator](_plugnet.pendingextrinsics.md#___iterator)
* [__@unscopables](_plugnet.pendingextrinsics.md#___unscopables)
* [concat](_plugnet.pendingextrinsics.md#concat)
* [copyWithin](_plugnet.pendingextrinsics.md#copywithin)
* [entries](_plugnet.pendingextrinsics.md#entries)
* [eq](_plugnet.pendingextrinsics.md#eq)
* [every](_plugnet.pendingextrinsics.md#every)
* [fill](_plugnet.pendingextrinsics.md#fill)
* [filter](_plugnet.pendingextrinsics.md#filter)
* [find](_plugnet.pendingextrinsics.md#find)
* [findIndex](_plugnet.pendingextrinsics.md#findindex)
* [forEach](_plugnet.pendingextrinsics.md#foreach)
* [includes](_plugnet.pendingextrinsics.md#includes)
* [indexOf](_plugnet.pendingextrinsics.md#indexof)
* [join](_plugnet.pendingextrinsics.md#join)
* [keys](_plugnet.pendingextrinsics.md#keys)
* [lastIndexOf](_plugnet.pendingextrinsics.md#lastindexof)
* [map](_plugnet.pendingextrinsics.md#map)
* [pop](_plugnet.pendingextrinsics.md#pop)
* [push](_plugnet.pendingextrinsics.md#push)
* [reduce](_plugnet.pendingextrinsics.md#reduce)
* [reduceRight](_plugnet.pendingextrinsics.md#reduceright)
* [reverse](_plugnet.pendingextrinsics.md#reverse)
* [shift](_plugnet.pendingextrinsics.md#shift)
* [slice](_plugnet.pendingextrinsics.md#slice)
* [some](_plugnet.pendingextrinsics.md#some)
* [sort](_plugnet.pendingextrinsics.md#sort)
* [splice](_plugnet.pendingextrinsics.md#splice)
* [toArray](_plugnet.pendingextrinsics.md#toarray)
* [toHex](_plugnet.pendingextrinsics.md#tohex)
* [toJSON](_plugnet.pendingextrinsics.md#tojson)
* [toLocaleString](_plugnet.pendingextrinsics.md#tolocalestring)
* [toString](_plugnet.pendingextrinsics.md#tostring)
* [toU8a](_plugnet.pendingextrinsics.md#tou8a)
* [unshift](_plugnet.pendingextrinsics.md#unshift)
* [values](_plugnet.pendingextrinsics.md#values)
* [decodeVector](_plugnet.pendingextrinsics.md#decodevector)
* [with](_plugnet.pendingextrinsics.md#with)
...
⊕ **new PendingExtrinsics**(Type: *[Constructor](../interfaces/_plugnet.constructor.md)<`T`>*, value?: *[Vector](_plugnet.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [PendingExtrinsics](_plugnet.pendingextrinsics.md)
...
**Returns:** [PendingExtrinsics](_plugnet.pendingextrinsics.md)
