[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Key](../classes/_plugnet.key.md)

# Class: Key

*__name__*: Key

*__description__*: The Substrate Key representation as a [Bytes](_plugnet.bytes.md) (`vec<u8>`).
...
* [constructor](_plugnet.key.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.key.md#bytes_per_element)
* [__@toStringTag](_plugnet.key.md#___tostringtag)
* [buffer](_plugnet.key.md#buffer)
* [byteLength](_plugnet.key.md#bytelength)
* [byteOffset](_plugnet.key.md#byteoffset)
* [encodedLength](_plugnet.key.md#encodedlength)
* [isEmpty](_plugnet.key.md#isempty)
* [length](_plugnet.key.md#length)

### Methods

* [__@iterator](_plugnet.key.md#___iterator)
* [copyWithin](_plugnet.key.md#copywithin)
* [entries](_plugnet.key.md#entries)
* [eq](_plugnet.key.md#eq)
* [every](_plugnet.key.md#every)
* [fill](_plugnet.key.md#fill)
* [filter](_plugnet.key.md#filter)
* [find](_plugnet.key.md#find)
* [findIndex](_plugnet.key.md#findindex)
* [forEach](_plugnet.key.md#foreach)
* [includes](_plugnet.key.md#includes)
* [indexOf](_plugnet.key.md#indexof)
* [join](_plugnet.key.md#join)
* [keys](_plugnet.key.md#keys)
* [lastIndexOf](_plugnet.key.md#lastindexof)
* [map](_plugnet.key.md#map)
* [reduce](_plugnet.key.md#reduce)
* [reduceRight](_plugnet.key.md#reduceright)
* [reverse](_plugnet.key.md#reverse)
* [set](_plugnet.key.md#set)
* [slice](_plugnet.key.md#slice)
* [some](_plugnet.key.md#some)
* [sort](_plugnet.key.md#sort)
* [subarray](_plugnet.key.md#subarray)
* [toHex](_plugnet.key.md#tohex)
* [toJSON](_plugnet.key.md#tojson)
* [toLocaleString](_plugnet.key.md#tolocalestring)
* [toString](_plugnet.key.md#tostring)
* [toU8a](_plugnet.key.md#tou8a)
* [values](_plugnet.key.md#values)
...
⊕ **new Key**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [Key](_plugnet.key.md)
