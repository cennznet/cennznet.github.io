[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Bytes](../classes/_plugnet.bytes.md)

# Class: Bytes

*__name__*: Bytes

*__description__*: A Bytes wrapper for Vec. The significant difference between this and a normal Uint8Array is that this version allows for length-encoding. (i.e. it is a variable-item codec, the same as what is found in [Text](_plugnet.text.md) and [Vector](_plugnet.vector.md))
...
↳  [StorageData](_plugnet.storagedata.md)

↳  [StorageKey](_plugnet.storagekey.md)

↳  [Other](_plugnet.other.md)

↳  [Justification](_plugnet.justification.md)

↳  [HeadData](_plugnet.headdata.md)

↳  [TrieId](_plugnet.trieid.md)

↳  [Key](_plugnet.key.md)

↳  [PreKeyBundle](_cennznet_types.prekeybundle-1.md)

↳  [VaultKey](_cennznet_types.vaultkey.md)

↳  [VaultValue](_cennznet_types.vaultvalue.md)

↳  [PreKeyBundle](_cennznet_types.prekeybundle.md)

↳  [VaultKey](_cennznet_types.vaultkey-1.md)

↳  [VaultValue](_cennznet_types.vaultvalue-1.md)
...
* [constructor](_plugnet.bytes.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.bytes.md#bytes_per_element)
* [__@toStringTag](_plugnet.bytes.md#___tostringtag)
* [buffer](_plugnet.bytes.md#buffer)
* [byteLength](_plugnet.bytes.md#bytelength)
* [byteOffset](_plugnet.bytes.md#byteoffset)
* [encodedLength](_plugnet.bytes.md#encodedlength)
* [isEmpty](_plugnet.bytes.md#isempty)
* [length](_plugnet.bytes.md#length)

### Methods

* [__@iterator](_plugnet.bytes.md#___iterator)
* [copyWithin](_plugnet.bytes.md#copywithin)
* [entries](_plugnet.bytes.md#entries)
* [eq](_plugnet.bytes.md#eq)
* [every](_plugnet.bytes.md#every)
* [fill](_plugnet.bytes.md#fill)
* [filter](_plugnet.bytes.md#filter)
* [find](_plugnet.bytes.md#find)
* [findIndex](_plugnet.bytes.md#findindex)
* [forEach](_plugnet.bytes.md#foreach)
* [includes](_plugnet.bytes.md#includes)
* [indexOf](_plugnet.bytes.md#indexof)
* [join](_plugnet.bytes.md#join)
* [keys](_plugnet.bytes.md#keys)
* [lastIndexOf](_plugnet.bytes.md#lastindexof)
* [map](_plugnet.bytes.md#map)
* [reduce](_plugnet.bytes.md#reduce)
* [reduceRight](_plugnet.bytes.md#reduceright)
* [reverse](_plugnet.bytes.md#reverse)
* [set](_plugnet.bytes.md#set)
* [slice](_plugnet.bytes.md#slice)
* [some](_plugnet.bytes.md#some)
* [sort](_plugnet.bytes.md#sort)
* [subarray](_plugnet.bytes.md#subarray)
* [toHex](_plugnet.bytes.md#tohex)
* [toJSON](_plugnet.bytes.md#tojson)
* [toLocaleString](_plugnet.bytes.md#tolocalestring)
* [toString](_plugnet.bytes.md#tostring)
* [toU8a](_plugnet.bytes.md#tou8a)
* [values](_plugnet.bytes.md#values)
...
⊕ **new Bytes**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [Bytes](_plugnet.bytes.md)
...
**Returns:** [Bytes](_plugnet.bytes.md)
