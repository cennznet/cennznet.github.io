[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [BalanceLock](../classes/_plugnet.balancelock.md)

# Class: BalanceLock

*__name__*: BalanceLock

*__description__*: The Substrate BalanceLock for staking
...
* [constructor](_plugnet.balancelock.md#constructor)

### Properties

* [Type](_plugnet.balancelock.md#type)
* [__@toStringTag](_plugnet.balancelock.md#___tostringtag)
* [amount](_plugnet.balancelock.md#amount)
* [encodedLength](_plugnet.balancelock.md#encodedlength)
* [id](_plugnet.balancelock.md#id)
* [isEmpty](_plugnet.balancelock.md#isempty)
* [reasons](_plugnet.balancelock.md#reasons)
* [size](_plugnet.balancelock.md#size)
* [until](_plugnet.balancelock.md#until)

### Methods

* [__@iterator](_plugnet.balancelock.md#___iterator)
* [clear](_plugnet.balancelock.md#clear)
* [delete](_plugnet.balancelock.md#delete)
* [entries](_plugnet.balancelock.md#entries)
* [eq](_plugnet.balancelock.md#eq)
* [forEach](_plugnet.balancelock.md#foreach)
* [get](_plugnet.balancelock.md#get)
* [getAtIndex](_plugnet.balancelock.md#getatindex)
* [has](_plugnet.balancelock.md#has)
* [keys](_plugnet.balancelock.md#keys)
* [set](_plugnet.balancelock.md#set)
* [toArray](_plugnet.balancelock.md#toarray)
* [toHex](_plugnet.balancelock.md#tohex)
* [toJSON](_plugnet.balancelock.md#tojson)
* [toString](_plugnet.balancelock.md#tostring)
* [toU8a](_plugnet.balancelock.md#tou8a)
* [values](_plugnet.balancelock.md#values)
* [with](_plugnet.balancelock.md#with)
...
⊕ **new BalanceLock**(value?: *`any`*): [BalanceLock](_plugnet.balancelock.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/BalanceLock.d.ts:11*
...
**Returns:** [BalanceLock](_plugnet.balancelock.md)
...
**● amount**: *[Balance](_plugnet.balance.md)*

*Defined in node_modules/@plugnet/types/type/BalanceLock.d.ts:16*

*__description__*: The amount
...
**● id**: *[LockIdentifier](_plugnet.lockidentifier.md)*

*Defined in node_modules/@plugnet/types/type/BalanceLock.d.ts:20*

*__description__*: The lock id
...
**● reasons**: *[WithdrawReasons](_plugnet.withdrawreasons.md)*

*Defined in node_modules/@plugnet/types/type/BalanceLock.d.ts:24*

*__description__*: The reasons
...
**● until**: *[BlockNumber](_plugnet.blocknumber.md)*

*Defined in node_modules/@plugnet/types/type/BalanceLock.d.ts:28*

*__description__*: Until when this is available
