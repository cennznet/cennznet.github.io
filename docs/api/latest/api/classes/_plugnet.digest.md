[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Digest](../classes/_plugnet.digest.md)

# Class: Digest

*__name__*: Digest

*__description__*: A [Header](_plugnet.header.md) Digest
...
* [constructor](_plugnet.digest.md#constructor)

### Properties

* [Type](_plugnet.digest.md#type)
* [__@toStringTag](_plugnet.digest.md#___tostringtag)
* [encodedLength](_plugnet.digest.md#encodedlength)
* [isEmpty](_plugnet.digest.md#isempty)
* [logs](_plugnet.digest.md#logs)
* [size](_plugnet.digest.md#size)

### Methods

* [__@iterator](_plugnet.digest.md#___iterator)
* [clear](_plugnet.digest.md#clear)
* [delete](_plugnet.digest.md#delete)
* [entries](_plugnet.digest.md#entries)
* [eq](_plugnet.digest.md#eq)
* [forEach](_plugnet.digest.md#foreach)
* [get](_plugnet.digest.md#get)
* [getAtIndex](_plugnet.digest.md#getatindex)
* [has](_plugnet.digest.md#has)
* [keys](_plugnet.digest.md#keys)
* [set](_plugnet.digest.md#set)
* [toArray](_plugnet.digest.md#toarray)
* [toHex](_plugnet.digest.md#tohex)
* [toJSON](_plugnet.digest.md#tojson)
* [toString](_plugnet.digest.md#tostring)
* [toU8a](_plugnet.digest.md#tou8a)
* [values](_plugnet.digest.md#values)
* [with](_plugnet.digest.md#with)
...
⊕ **new Digest**(value: *`any`*): [Digest](_plugnet.digest.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/Digest.d.ts:126*
...
**Returns:** [Digest](_plugnet.digest.md)
...
**● logs**: *[Vector](_plugnet.vector.md)<[DigestItem](_plugnet.digestitem.md)>*

*Defined in node_modules/@plugnet/types/type/Digest.d.ts:131*

*__description__*: The [DigestItem](_plugnet.digestitem.md) logs
