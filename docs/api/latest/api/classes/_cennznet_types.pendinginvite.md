[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [PendingInvite](../classes/_cennznet_types.pendinginvite.md)
...
* [constructor](_cennznet_types.pendinginvite.md#constructor)

### Properties

* [Type](_cennznet_types.pendinginvite.md#type)
* [__@toStringTag](_cennznet_types.pendinginvite.md#___tostringtag)
* [encodedLength](_cennznet_types.pendinginvite.md#encodedlength)
* [isEmpty](_cennznet_types.pendinginvite.md#isempty)
* [size](_cennznet_types.pendinginvite.md#size)

### Methods

* [__@iterator](_cennznet_types.pendinginvite.md#___iterator)
* [clear](_cennznet_types.pendinginvite.md#clear)
* [delete](_cennznet_types.pendinginvite.md#delete)
* [entries](_cennznet_types.pendinginvite.md#entries)
* [eq](_cennznet_types.pendinginvite.md#eq)
* [forEach](_cennznet_types.pendinginvite.md#foreach)
* [get](_cennznet_types.pendinginvite.md#get)
* [getAtIndex](_cennznet_types.pendinginvite.md#getatindex)
* [has](_cennznet_types.pendinginvite.md#has)
* [keys](_cennznet_types.pendinginvite.md#keys)
* [set](_cennznet_types.pendinginvite.md#set)
* [toArray](_cennznet_types.pendinginvite.md#toarray)
* [toHex](_cennznet_types.pendinginvite.md#tohex)
* [toJSON](_cennznet_types.pendinginvite.md#tojson)
* [toString](_cennznet_types.pendinginvite.md#tostring)
* [toU8a](_cennznet_types.pendinginvite.md#tou8a)
* [values](_cennznet_types.pendinginvite.md#values)
* [with](_cennznet_types.pendinginvite.md#with)
...
⊕ **new PendingInvite**(value: *`any`*): [PendingInvite](_cennznet_types.pendinginvite.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in packages/types/src/runtime/sylo.ts:87*
...
**Returns:** [PendingInvite](_cennznet_types.pendinginvite.md)
...
*Defined in packages/types/src/runtime/sylo.ts:92*
