[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [AccountIdOf](../classes/_plugnet.accountidof.md)

# Class: AccountIdOf

*__name__*: AccountIdOf

*__description__*: The Substrate AccountIdOf representation as a [AccountId](_plugnet.accountid.md).

## Hierarchy

↳  [AccountId](_plugnet.accountid.md)
...
* [constructor](_plugnet.accountidof.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.accountidof.md#bytes_per_element)
* [__@toStringTag](_plugnet.accountidof.md#___tostringtag)
* [buffer](_plugnet.accountidof.md#buffer)
* [byteLength](_plugnet.accountidof.md#bytelength)
* [byteOffset](_plugnet.accountidof.md#byteoffset)
* [encodedLength](_plugnet.accountidof.md#encodedlength)
* [isEmpty](_plugnet.accountidof.md#isempty)
* [length](_plugnet.accountidof.md#length)

### Methods

* [__@iterator](_plugnet.accountidof.md#___iterator)
* [bitLength](_plugnet.accountidof.md#bitlength)
* [copyWithin](_plugnet.accountidof.md#copywithin)
* [entries](_plugnet.accountidof.md#entries)
* [eq](_plugnet.accountidof.md#eq)
* [every](_plugnet.accountidof.md#every)
* [fill](_plugnet.accountidof.md#fill)
* [filter](_plugnet.accountidof.md#filter)
* [find](_plugnet.accountidof.md#find)
* [findIndex](_plugnet.accountidof.md#findindex)
* [forEach](_plugnet.accountidof.md#foreach)
* [includes](_plugnet.accountidof.md#includes)
* [indexOf](_plugnet.accountidof.md#indexof)
* [join](_plugnet.accountidof.md#join)
* [keys](_plugnet.accountidof.md#keys)
* [lastIndexOf](_plugnet.accountidof.md#lastindexof)
* [map](_plugnet.accountidof.md#map)
* [reduce](_plugnet.accountidof.md#reduce)
* [reduceRight](_plugnet.accountidof.md#reduceright)
* [reverse](_plugnet.accountidof.md#reverse)
* [set](_plugnet.accountidof.md#set)
* [slice](_plugnet.accountidof.md#slice)
* [some](_plugnet.accountidof.md#some)
* [sort](_plugnet.accountidof.md#sort)
* [subarray](_plugnet.accountidof.md#subarray)
* [toHex](_plugnet.accountidof.md#tohex)
* [toJSON](_plugnet.accountidof.md#tojson)
* [toLocaleString](_plugnet.accountidof.md#tolocalestring)
* [toString](_plugnet.accountidof.md#tostring)
* [toU8a](_plugnet.accountidof.md#tou8a)
* [values](_plugnet.accountidof.md#values)
* [encode](_plugnet.accountidof.md#encode)
...
⊕ **new AccountIdOf**(value?: *[AnyU8a](../modules/_plugnet.md#anyu8a)*): [AccountIdOf](_plugnet.accountidof.md)

*Inherited from [AccountId](_plugnet.accountid.md).[constructor](_plugnet.accountid.md#constructor)*

*Overrides [U8aFixed](_plugnet.u8afixed.md).[constructor](_plugnet.u8afixed.md#constructor)*

*Defined in node_modules/@plugnet/types/type/AccountId.d.ts:10*
...
**Returns:** [AccountIdOf](_plugnet.accountidof.md)
...
*Inherited from [AccountId](_plugnet.accountid.md).[eq](_plugnet.accountid.md#eq)*

*Overrides [U8a](_plugnet.u8a.md).[eq](_plugnet.u8a.md#eq)*

*Defined in node_modules/@plugnet/types/type/AccountId.d.ts:17*
...
*Inherited from [AccountId](_plugnet.accountid.md).[toJSON](_plugnet.accountid.md#tojson)*

*Overrides [U8a](_plugnet.u8a.md).[toJSON](_plugnet.u8a.md#tojson)*

*Defined in node_modules/@plugnet/types/type/AccountId.d.ts:21*
...
*Inherited from [AccountId](_plugnet.accountid.md).[toString](_plugnet.accountid.md#tostring)*

*Overrides [U8a](_plugnet.u8a.md).[toString](_plugnet.u8a.md#tostring)*

*Defined in node_modules/@plugnet/types/type/AccountId.d.ts:25*
...
*Inherited from [AccountId](_plugnet.accountid.md).[encode](_plugnet.accountid.md#encode)*

*Defined in node_modules/@plugnet/types/type/AccountId.d.ts:12*
