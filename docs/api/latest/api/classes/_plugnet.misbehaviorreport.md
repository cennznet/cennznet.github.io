[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MisbehaviorReport](../classes/_plugnet.misbehaviorreport.md)

# Class: MisbehaviorReport

*__name__*: MisbehaviorReport

*__description__*: A Misbehaviour report of \[\[MisbehavioirKind\]\] against a specific [AuthorityId](_plugnet.authorityid.md)
...
* [constructor](_plugnet.misbehaviorreport.md#constructor)

### Properties

* [Type](_plugnet.misbehaviorreport.md#type)
* [__@toStringTag](_plugnet.misbehaviorreport.md#___tostringtag)
* [encodedLength](_plugnet.misbehaviorreport.md#encodedlength)
* [isEmpty](_plugnet.misbehaviorreport.md#isempty)
* [misbehavior](_plugnet.misbehaviorreport.md#misbehavior)
* [parentHash](_plugnet.misbehaviorreport.md#parenthash)
* [parentNumber](_plugnet.misbehaviorreport.md#parentnumber)
* [size](_plugnet.misbehaviorreport.md#size)
* [target](_plugnet.misbehaviorreport.md#target)

### Methods

* [__@iterator](_plugnet.misbehaviorreport.md#___iterator)
* [clear](_plugnet.misbehaviorreport.md#clear)
* [delete](_plugnet.misbehaviorreport.md#delete)
* [entries](_plugnet.misbehaviorreport.md#entries)
* [eq](_plugnet.misbehaviorreport.md#eq)
* [forEach](_plugnet.misbehaviorreport.md#foreach)
* [get](_plugnet.misbehaviorreport.md#get)
* [getAtIndex](_plugnet.misbehaviorreport.md#getatindex)
* [has](_plugnet.misbehaviorreport.md#has)
* [keys](_plugnet.misbehaviorreport.md#keys)
* [set](_plugnet.misbehaviorreport.md#set)
* [toArray](_plugnet.misbehaviorreport.md#toarray)
* [toHex](_plugnet.misbehaviorreport.md#tohex)
* [toJSON](_plugnet.misbehaviorreport.md#tojson)
* [toString](_plugnet.misbehaviorreport.md#tostring)
* [toU8a](_plugnet.misbehaviorreport.md#tou8a)
* [values](_plugnet.misbehaviorreport.md#values)
* [with](_plugnet.misbehaviorreport.md#with)
...
⊕ **new MisbehaviorReport**(value?: *[MisbehaviorReportValue](../modules/_plugnet.md#misbehaviorreportvalue) \| `Uint8Array`*): [MisbehaviorReport](_plugnet.misbehaviorreport.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:125*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [MisbehaviorReportValue](../modules/_plugnet.md#misbehaviorreportvalue) \| `Uint8Array` |

**Returns:** [MisbehaviorReport](_plugnet.misbehaviorreport.md)
...
**● misbehavior**: *[MisbehaviorKind](_plugnet.misbehaviorkind.md)*

*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:130*

*__description__*: The [MisbehaviorKind](_plugnet.misbehaviorkind.md)
...
*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:134*

*__description__*: The [Hash](_plugnet.hash.md) of the parent block
...
**● parentNumber**: *[BlockNumber](_plugnet.blocknumber.md)*

*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:138*

*__description__*: The [BlockNumber](_plugnet.blocknumber.md) of the parent
...
**● target**: *[AuthorityId](_plugnet.authorityid.md)*

*Defined in node_modules/@plugnet/types/type/MisbehaviorReport.d.ts:142*

*__description__*: The [authorityId](_plugnet.bftauthoritysignature.md#authorityid) the report applies to
