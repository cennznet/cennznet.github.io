[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [EventRecord](../classes/_plugnet.eventrecord.md)

# Class: EventRecord

*__name__*: EventRecord

*__description__*: A record for an [Event](_plugnet.event.md) (as specified by [Metadata](_plugnet.metadata.md)) with the specific [Phase](_plugnet.phase.md) of application.
...
* [constructor](_plugnet.eventrecord.md#constructor)

### Properties

* [Type](_plugnet.eventrecord.md#type)
* [__@toStringTag](_plugnet.eventrecord.md#___tostringtag)
* [encodedLength](_plugnet.eventrecord.md#encodedlength)
* [event](_plugnet.eventrecord.md#event)
* [isEmpty](_plugnet.eventrecord.md#isempty)
* [phase](_plugnet.eventrecord.md#phase)
* [size](_plugnet.eventrecord.md#size)

### Methods

* [__@iterator](_plugnet.eventrecord.md#___iterator)
* [clear](_plugnet.eventrecord.md#clear)
* [delete](_plugnet.eventrecord.md#delete)
* [entries](_plugnet.eventrecord.md#entries)
* [eq](_plugnet.eventrecord.md#eq)
* [forEach](_plugnet.eventrecord.md#foreach)
* [get](_plugnet.eventrecord.md#get)
* [getAtIndex](_plugnet.eventrecord.md#getatindex)
* [has](_plugnet.eventrecord.md#has)
* [keys](_plugnet.eventrecord.md#keys)
* [set](_plugnet.eventrecord.md#set)
* [toArray](_plugnet.eventrecord.md#toarray)
* [toHex](_plugnet.eventrecord.md#tohex)
* [toJSON](_plugnet.eventrecord.md#tojson)
* [toString](_plugnet.eventrecord.md#tostring)
* [toU8a](_plugnet.eventrecord.md#tou8a)
* [values](_plugnet.eventrecord.md#values)
* [with](_plugnet.eventrecord.md#with)
...
⊕ **new EventRecord**(value: *`any`*): [EventRecord](_plugnet.eventrecord.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/EventRecord.d.ts:50*
...
**Returns:** [EventRecord](_plugnet.eventrecord.md)
...
**● event**: *[Event](_plugnet.event.md)*

*Defined in node_modules/@plugnet/types/type/EventRecord.d.ts:55*

*__description__*: The [Event](_plugnet.event.md) this record refers to
...
**● phase**: *[Phase](_plugnet.phase.md)*

*Defined in node_modules/@plugnet/types/type/EventRecord.d.ts:59*

*__description__*: The [Phase](_plugnet.phase.md) where the event was generated
