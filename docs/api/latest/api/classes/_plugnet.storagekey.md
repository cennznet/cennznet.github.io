[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [StorageKey](../classes/_plugnet.storagekey.md)
...
* [constructor](_plugnet.storagekey.md#constructor)

### Properties

* [BYTES_PER_ELEMENT](_plugnet.storagekey.md#bytes_per_element)
* [__@toStringTag](_plugnet.storagekey.md#___tostringtag)
* [buffer](_plugnet.storagekey.md#buffer)
* [byteLength](_plugnet.storagekey.md#bytelength)
* [byteOffset](_plugnet.storagekey.md#byteoffset)
* [encodedLength](_plugnet.storagekey.md#encodedlength)
* [isEmpty](_plugnet.storagekey.md#isempty)
* [length](_plugnet.storagekey.md#length)
* [meta](_plugnet.storagekey.md#meta)
* [outputType](_plugnet.storagekey.md#outputtype)

### Methods

* [__@iterator](_plugnet.storagekey.md#___iterator)
* [copyWithin](_plugnet.storagekey.md#copywithin)
* [entries](_plugnet.storagekey.md#entries)
* [eq](_plugnet.storagekey.md#eq)
* [every](_plugnet.storagekey.md#every)
* [fill](_plugnet.storagekey.md#fill)
* [filter](_plugnet.storagekey.md#filter)
* [find](_plugnet.storagekey.md#find)
* [findIndex](_plugnet.storagekey.md#findindex)
* [forEach](_plugnet.storagekey.md#foreach)
* [includes](_plugnet.storagekey.md#includes)
* [indexOf](_plugnet.storagekey.md#indexof)
* [join](_plugnet.storagekey.md#join)
* [keys](_plugnet.storagekey.md#keys)
* [lastIndexOf](_plugnet.storagekey.md#lastindexof)
* [map](_plugnet.storagekey.md#map)
* [reduce](_plugnet.storagekey.md#reduce)
* [reduceRight](_plugnet.storagekey.md#reduceright)
* [reverse](_plugnet.storagekey.md#reverse)
* [set](_plugnet.storagekey.md#set)
* [slice](_plugnet.storagekey.md#slice)
* [some](_plugnet.storagekey.md#some)
* [sort](_plugnet.storagekey.md#sort)
* [subarray](_plugnet.storagekey.md#subarray)
* [toHex](_plugnet.storagekey.md#tohex)
* [toJSON](_plugnet.storagekey.md#tojson)
* [toLocaleString](_plugnet.storagekey.md#tolocalestring)
* [toString](_plugnet.storagekey.md#tostring)
* [toU8a](_plugnet.storagekey.md#tou8a)
* [values](_plugnet.storagekey.md#values)
* [decodeStorageKey](_plugnet.storagekey.md#decodestoragekey)
* [getMeta](_plugnet.storagekey.md#getmeta)
* [getType](_plugnet.storagekey.md#gettype)
...
⊕ **new StorageKey**(value: *[AnyU8a](../modules/_plugnet.md#anyu8a) \| [StorageKey](_plugnet.storagekey.md) \| [StorageFunction](../interfaces/_plugnet.storagefunction.md) \| [[StorageFunction](../interfaces/_plugnet.storagefunction.md), `any`]*): [StorageKey](_plugnet.storagekey.md)

*Overrides [Bytes](_plugnet.bytes.md).[constructor](_plugnet.bytes.md#constructor)*

*Defined in node_modules/@plugnet/types/primitive/StorageKey.d.ts:21*

**Parameters:**

| Name | Type |
| ------ | ------ |
| value | [AnyU8a](../modules/_plugnet.md#anyu8a) \| [StorageKey](_plugnet.storagekey.md) \| [StorageFunction](../interfaces/_plugnet.storagefunction.md) \| [[StorageFunction](../interfaces/_plugnet.storagefunction.md), `any`] |

**Returns:** [StorageKey](_plugnet.storagekey.md)
...
**● meta**: *`MetaV0` \| `MetaV4` \| `null`*

*Defined in node_modules/@plugnet/types/primitive/StorageKey.d.ts:29*
...
*Defined in node_modules/@plugnet/types/primitive/StorageKey.d.ts:33*
...
▸ **decodeStorageKey**(value: *[AnyU8a](../modules/_plugnet.md#anyu8a) \| [StorageKey](_plugnet.storagekey.md) \| [StorageFunction](../interfaces/_plugnet.storagefunction.md) \| [[StorageFunction](../interfaces/_plugnet.storagefunction.md), `any`]*): `Uint8Array`

*Defined in node_modules/@plugnet/types/primitive/StorageKey.d.ts:23*
...
▸ **getMeta**(value: *[StorageKey](_plugnet.storagekey.md) \| [StorageFunction](../interfaces/_plugnet.storagefunction.md) \| [[StorageFunction](../interfaces/_plugnet.storagefunction.md), `any`]*): `MetaV0` \| `MetaV4` \| `null`

*Defined in node_modules/@plugnet/types/primitive/StorageKey.d.ts:24*

**Parameters:**

| Name | Type |
| ------ | ------ |
| value | [StorageKey](_plugnet.storagekey.md) \| [StorageFunction](../interfaces/_plugnet.storagefunction.md) \| [[StorageFunction](../interfaces/_plugnet.storagefunction.md), `any`] |

**Returns:** `MetaV0` \| `MetaV4` \| `null`
...
▸ **getType**(value: *[StorageKey](_plugnet.storagekey.md) \| [StorageFunction](../interfaces/_plugnet.storagefunction.md) \| [[StorageFunction](../interfaces/_plugnet.storagefunction.md), `any`]*): `string` \| `null`

*Defined in node_modules/@plugnet/types/primitive/StorageKey.d.ts:25*
