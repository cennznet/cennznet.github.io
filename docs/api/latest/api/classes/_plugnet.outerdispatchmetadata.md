[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [OuterDispatchMetadata](../classes/_plugnet.outerdispatchmetadata.md)

# Class: OuterDispatchMetadata
...
* [constructor](_plugnet.outerdispatchmetadata.md#constructor)

### Properties

* [Type](_plugnet.outerdispatchmetadata.md#type)
* [__@toStringTag](_plugnet.outerdispatchmetadata.md#___tostringtag)
* [calls](_plugnet.outerdispatchmetadata.md#calls)
* [encodedLength](_plugnet.outerdispatchmetadata.md#encodedlength)
* [isEmpty](_plugnet.outerdispatchmetadata.md#isempty)
* [name](_plugnet.outerdispatchmetadata.md#name)
* [size](_plugnet.outerdispatchmetadata.md#size)

### Methods

* [__@iterator](_plugnet.outerdispatchmetadata.md#___iterator)
* [clear](_plugnet.outerdispatchmetadata.md#clear)
* [delete](_plugnet.outerdispatchmetadata.md#delete)
* [entries](_plugnet.outerdispatchmetadata.md#entries)
* [eq](_plugnet.outerdispatchmetadata.md#eq)
* [forEach](_plugnet.outerdispatchmetadata.md#foreach)
* [get](_plugnet.outerdispatchmetadata.md#get)
* [getAtIndex](_plugnet.outerdispatchmetadata.md#getatindex)
* [has](_plugnet.outerdispatchmetadata.md#has)
* [keys](_plugnet.outerdispatchmetadata.md#keys)
* [set](_plugnet.outerdispatchmetadata.md#set)
* [toArray](_plugnet.outerdispatchmetadata.md#toarray)
* [toHex](_plugnet.outerdispatchmetadata.md#tohex)
* [toJSON](_plugnet.outerdispatchmetadata.md#tojson)
* [toString](_plugnet.outerdispatchmetadata.md#tostring)
* [toU8a](_plugnet.outerdispatchmetadata.md#tou8a)
* [values](_plugnet.outerdispatchmetadata.md#values)
* [with](_plugnet.outerdispatchmetadata.md#with)
...
⊕ **new OuterDispatchMetadata**(value?: *`any`*): [OuterDispatchMetadata](_plugnet.outerdispatchmetadata.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v0/Calls.d.ts:20*
...
**Returns:** [OuterDispatchMetadata](_plugnet.outerdispatchmetadata.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Calls.d.ts:25*
...
*Defined in node_modules/@plugnet/types/Metadata/v0/Calls.d.ts:29*
