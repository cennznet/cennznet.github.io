[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [MapType](../classes/_plugnet.maptype-1.md)
...
* [constructor](_plugnet.maptype-1.md#constructor)

### Properties

* [Type](_plugnet.maptype-1.md#type)
* [__@toStringTag](_plugnet.maptype-1.md#___tostringtag)
* [encodedLength](_plugnet.maptype-1.md#encodedlength)
* [isEmpty](_plugnet.maptype-1.md#isempty)
* [isLinked](_plugnet.maptype-1.md#islinked)
* [key](_plugnet.maptype-1.md#key)
* [size](_plugnet.maptype-1.md#size)
* [value](_plugnet.maptype-1.md#value)

### Methods

* [__@iterator](_plugnet.maptype-1.md#___iterator)
* [clear](_plugnet.maptype-1.md#clear)
* [delete](_plugnet.maptype-1.md#delete)
* [entries](_plugnet.maptype-1.md#entries)
* [eq](_plugnet.maptype-1.md#eq)
* [forEach](_plugnet.maptype-1.md#foreach)
* [get](_plugnet.maptype-1.md#get)
* [getAtIndex](_plugnet.maptype-1.md#getatindex)
* [has](_plugnet.maptype-1.md#has)
* [keys](_plugnet.maptype-1.md#keys)
* [set](_plugnet.maptype-1.md#set)
* [toArray](_plugnet.maptype-1.md#toarray)
* [toHex](_plugnet.maptype-1.md#tohex)
* [toJSON](_plugnet.maptype-1.md#tojson)
* [toString](_plugnet.maptype-1.md#tostring)
* [toU8a](_plugnet.maptype-1.md#tou8a)
* [values](_plugnet.maptype-1.md#values)
* [with](_plugnet.maptype-1.md#with)
...
⊕ **new MapType**(value?: *`any`*): [MapType](_plugnet.maptype-1.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/Metadata/v2/Storage.d.ts:11*
...
**Returns:** [MapType](_plugnet.maptype-1.md)
...
*Defined in node_modules/@plugnet/types/Metadata/v2/Storage.d.ts:24*
...
*Defined in node_modules/@plugnet/types/Metadata/v2/Storage.d.ts:16*

*__description__*: The mapped key as [Type](_plugnet.maptype-1.md#type)
...
*Defined in node_modules/@plugnet/types/Metadata/v2/Storage.d.ts:20*

*__description__*: The mapped value as [Type](_plugnet.maptype-1.md#type)
