[@cennznet/api](../README.md) > [@cennznet/types](../modules/_cennznet_types.md) > [PendingInvite](../classes/_cennznet_types.pendinginvite-1.md)
...
* [constructor](_cennznet_types.pendinginvite-1.md#constructor)

### Properties

* [Type](_cennznet_types.pendinginvite-1.md#type)
* [__@toStringTag](_cennznet_types.pendinginvite-1.md#___tostringtag)
* [encodedLength](_cennznet_types.pendinginvite-1.md#encodedlength)
* [isEmpty](_cennznet_types.pendinginvite-1.md#isempty)
* [size](_cennznet_types.pendinginvite-1.md#size)

### Methods

* [__@iterator](_cennznet_types.pendinginvite-1.md#___iterator)
* [clear](_cennznet_types.pendinginvite-1.md#clear)
* [delete](_cennznet_types.pendinginvite-1.md#delete)
* [entries](_cennznet_types.pendinginvite-1.md#entries)
* [eq](_cennznet_types.pendinginvite-1.md#eq)
* [forEach](_cennznet_types.pendinginvite-1.md#foreach)
* [get](_cennznet_types.pendinginvite-1.md#get)
* [getAtIndex](_cennznet_types.pendinginvite-1.md#getatindex)
* [has](_cennznet_types.pendinginvite-1.md#has)
* [keys](_cennznet_types.pendinginvite-1.md#keys)
* [set](_cennznet_types.pendinginvite-1.md#set)
* [toArray](_cennznet_types.pendinginvite-1.md#toarray)
* [toHex](_cennznet_types.pendinginvite-1.md#tohex)
* [toJSON](_cennznet_types.pendinginvite-1.md#tojson)
* [toString](_cennznet_types.pendinginvite-1.md#tostring)
* [toU8a](_cennznet_types.pendinginvite-1.md#tou8a)
* [values](_cennznet_types.pendinginvite-1.md#values)
* [with](_cennznet_types.pendinginvite-1.md#with)
...
⊕ **new PendingInvite**(value: *`any`*): [PendingInvite](_cennznet_types.pendinginvite-1.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@cennznet/types/src/runtime/sylo.ts:87*
...
**Returns:** [PendingInvite](_cennznet_types.pendinginvite-1.md)
...
*Defined in node_modules/@cennznet/types/src/runtime/sylo.ts:92*
