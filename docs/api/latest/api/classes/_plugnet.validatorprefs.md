[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [ValidatorPrefs](../classes/_plugnet.validatorprefs.md)
...
* [constructor](_plugnet.validatorprefs.md#constructor)

### Properties

* [Type](_plugnet.validatorprefs.md#type)
* [__@toStringTag](_plugnet.validatorprefs.md#___tostringtag)
* [encodedLength](_plugnet.validatorprefs.md#encodedlength)
* [isEmpty](_plugnet.validatorprefs.md#isempty)
* [size](_plugnet.validatorprefs.md#size)
* [unstakeThreshold](_plugnet.validatorprefs.md#unstakethreshold)
* [validatorPayment](_plugnet.validatorprefs.md#validatorpayment)

### Methods

* [__@iterator](_plugnet.validatorprefs.md#___iterator)
* [clear](_plugnet.validatorprefs.md#clear)
* [delete](_plugnet.validatorprefs.md#delete)
* [entries](_plugnet.validatorprefs.md#entries)
* [eq](_plugnet.validatorprefs.md#eq)
* [forEach](_plugnet.validatorprefs.md#foreach)
* [get](_plugnet.validatorprefs.md#get)
* [getAtIndex](_plugnet.validatorprefs.md#getatindex)
* [has](_plugnet.validatorprefs.md#has)
* [keys](_plugnet.validatorprefs.md#keys)
* [set](_plugnet.validatorprefs.md#set)
* [toArray](_plugnet.validatorprefs.md#toarray)
* [toHex](_plugnet.validatorprefs.md#tohex)
* [toJSON](_plugnet.validatorprefs.md#tojson)
* [toString](_plugnet.validatorprefs.md#tostring)
* [toU8a](_plugnet.validatorprefs.md#tou8a)
* [values](_plugnet.validatorprefs.md#values)
* [with](_plugnet.validatorprefs.md#with)
...
⊕ **new ValidatorPrefs**(value?: *[ValidatorPrefsValue](../modules/_plugnet.md#validatorprefsvalue) \| `Uint8Array`*): [ValidatorPrefs](_plugnet.validatorprefs.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/ValidatorPrefs.d.ts:14*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [ValidatorPrefsValue](../modules/_plugnet.md#validatorprefsvalue) \| `Uint8Array` |

**Returns:** [ValidatorPrefs](_plugnet.validatorprefs.md)
...
**● unstakeThreshold**: *[U32](_plugnet.u32.md)*

*Defined in node_modules/@plugnet/types/type/ValidatorPrefs.d.ts:19*

*__description__*: The unstake threshold as [U32](_plugnet.u32.md)
...
**● validatorPayment**: *[Compact](_plugnet.compact.md)*

*Defined in node_modules/@plugnet/types/type/ValidatorPrefs.d.ts:23*

*__description__*: The payment config for the validator as a [Compact](../interfaces/_plugnet.compact-1.md) [Balance](_plugnet.balance.md)
