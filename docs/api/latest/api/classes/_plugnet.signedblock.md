[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [SignedBlock](../classes/_plugnet.signedblock.md)

# Class: SignedBlock

*__name__*: SignedBlock

*__description__*: A [Block](_plugnet.block.md) that has been signed and contains a [Justification](_plugnet.justification.md)
...
* [constructor](_plugnet.signedblock.md#constructor)

### Properties

* [Type](_plugnet.signedblock.md#type)
* [__@toStringTag](_plugnet.signedblock.md#___tostringtag)
* [block](_plugnet.signedblock.md#block)
* [encodedLength](_plugnet.signedblock.md#encodedlength)
* [hash](_plugnet.signedblock.md#hash)
* [isEmpty](_plugnet.signedblock.md#isempty)
* [justification](_plugnet.signedblock.md#justification)
* [size](_plugnet.signedblock.md#size)

### Methods

* [__@iterator](_plugnet.signedblock.md#___iterator)
* [clear](_plugnet.signedblock.md#clear)
* [delete](_plugnet.signedblock.md#delete)
* [entries](_plugnet.signedblock.md#entries)
* [eq](_plugnet.signedblock.md#eq)
* [forEach](_plugnet.signedblock.md#foreach)
* [get](_plugnet.signedblock.md#get)
* [getAtIndex](_plugnet.signedblock.md#getatindex)
* [has](_plugnet.signedblock.md#has)
* [keys](_plugnet.signedblock.md#keys)
* [set](_plugnet.signedblock.md#set)
* [toArray](_plugnet.signedblock.md#toarray)
* [toHex](_plugnet.signedblock.md#tohex)
* [toJSON](_plugnet.signedblock.md#tojson)
* [toString](_plugnet.signedblock.md#tostring)
* [toU8a](_plugnet.signedblock.md#tou8a)
* [values](_plugnet.signedblock.md#values)
* [with](_plugnet.signedblock.md#with)
...
⊕ **new SignedBlock**(value?: *[SignedBlockValue](../modules/_plugnet.md#signedblockvalue) \| `Uint8Array`*): [SignedBlock](_plugnet.signedblock.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/rpc/SignedBlock.d.ts:15*

**Parameters:**

| Name | Type |
| ------ | ------ |
| `Optional` value | [SignedBlockValue](../modules/_plugnet.md#signedblockvalue) \| `Uint8Array` |

**Returns:** [SignedBlock](_plugnet.signedblock.md)
...
**● block**: *[Block](_plugnet.block.md)*

*Defined in node_modules/@plugnet/types/rpc/SignedBlock.d.ts:20*

*__description__*: The wrapped [Block](_plugnet.block.md)
...
*Defined in node_modules/@plugnet/types/rpc/SignedBlock.d.ts:24*

*__description__*: Block/header [Hash](_plugnet.hash.md)
...
**● justification**: *[Justification](_plugnet.justification.md)*

*Defined in node_modules/@plugnet/types/rpc/SignedBlock.d.ts:28*

*__description__*: The wrapped [Justification](_plugnet.justification.md)
