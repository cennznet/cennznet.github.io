[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [Linkage](../classes/_plugnet.linkage.md)
...
* [constructor](_plugnet.linkage.md#constructor)

### Properties

* [Type](_plugnet.linkage.md#type)
* [__@toStringTag](_plugnet.linkage.md#___tostringtag)
* [encodedLength](_plugnet.linkage.md#encodedlength)
* [isEmpty](_plugnet.linkage.md#isempty)
* [next](_plugnet.linkage.md#next)
* [previous](_plugnet.linkage.md#previous)
* [size](_plugnet.linkage.md#size)

### Methods

* [__@iterator](_plugnet.linkage.md#___iterator)
* [clear](_plugnet.linkage.md#clear)
* [delete](_plugnet.linkage.md#delete)
* [entries](_plugnet.linkage.md#entries)
* [eq](_plugnet.linkage.md#eq)
* [forEach](_plugnet.linkage.md#foreach)
* [get](_plugnet.linkage.md#get)
* [getAtIndex](_plugnet.linkage.md#getatindex)
* [has](_plugnet.linkage.md#has)
* [keys](_plugnet.linkage.md#keys)
* [set](_plugnet.linkage.md#set)
* [toArray](_plugnet.linkage.md#toarray)
* [toHex](_plugnet.linkage.md#tohex)
* [toJSON](_plugnet.linkage.md#tojson)
* [toString](_plugnet.linkage.md#tostring)
* [toU8a](_plugnet.linkage.md#tou8a)
* [values](_plugnet.linkage.md#values)
* [with](_plugnet.linkage.md#with)
* [withKey](_plugnet.linkage.md#withkey)
...
⊕ **new Linkage**(Type: *[Constructor](../interfaces/_plugnet.constructor.md)*, value?: *`any`*): [Linkage](_plugnet.linkage.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/codec/Linkage.d.ts:4*
...
**Returns:** [Linkage](_plugnet.linkage.md)
...
**● next**: *[Option](_plugnet.option.md)<`T`>*

*Defined in node_modules/@plugnet/types/codec/Linkage.d.ts:8*
...
**● previous**: *[Option](_plugnet.option.md)<`T`>*

*Defined in node_modules/@plugnet/types/codec/Linkage.d.ts:7*
...
▸ **withKey**<`O`>(Type: *[Constructor](../interfaces/_plugnet.constructor.md)*): [Constructor](../interfaces/_plugnet.constructor.md)<[Linkage](_plugnet.linkage.md)<`O`>>

*Defined in node_modules/@plugnet/types/codec/Linkage.d.ts:6*
...
**Returns:** [Constructor](../interfaces/_plugnet.constructor.md)<[Linkage](_plugnet.linkage.md)<`O`>>
