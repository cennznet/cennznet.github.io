[@cennznet/api](../README.md) > [@plugnet](../modules/_plugnet.md) > [AccountInfo](../classes/_plugnet.accountinfo.md)

# Class: AccountInfo

*__name__*: AccountInfo

*__description__*: An Account information structure for contracts
...
* [constructor](_plugnet.accountinfo.md#constructor)

### Properties

* [Type](_plugnet.accountinfo.md#type)
* [__@toStringTag](_plugnet.accountinfo.md#___tostringtag)
* [currentMemStored](_plugnet.accountinfo.md#currentmemstored)
* [encodedLength](_plugnet.accountinfo.md#encodedlength)
* [isEmpty](_plugnet.accountinfo.md#isempty)
* [size](_plugnet.accountinfo.md#size)
* [trieId](_plugnet.accountinfo.md#trieid)

### Methods

* [__@iterator](_plugnet.accountinfo.md#___iterator)
* [clear](_plugnet.accountinfo.md#clear)
* [delete](_plugnet.accountinfo.md#delete)
* [entries](_plugnet.accountinfo.md#entries)
* [eq](_plugnet.accountinfo.md#eq)
* [forEach](_plugnet.accountinfo.md#foreach)
* [get](_plugnet.accountinfo.md#get)
* [getAtIndex](_plugnet.accountinfo.md#getatindex)
* [has](_plugnet.accountinfo.md#has)
* [keys](_plugnet.accountinfo.md#keys)
* [set](_plugnet.accountinfo.md#set)
* [toArray](_plugnet.accountinfo.md#toarray)
* [toHex](_plugnet.accountinfo.md#tohex)
* [toJSON](_plugnet.accountinfo.md#tojson)
* [toString](_plugnet.accountinfo.md#tostring)
* [toU8a](_plugnet.accountinfo.md#tou8a)
* [values](_plugnet.accountinfo.md#values)
* [with](_plugnet.accountinfo.md#with)
...
⊕ **new AccountInfo**(value: *`any`*): [AccountInfo](_plugnet.accountinfo.md)

*Overrides [Struct](_plugnet.struct.md).[constructor](_plugnet.struct.md#constructor)*

*Defined in node_modules/@plugnet/types/type/AccountInfo.d.ts:9*
...
**Returns:** [AccountInfo](_plugnet.accountinfo.md)
...
___
<a id="currentmemstored"></a>

###  currentMemStored

**● currentMemStored**: *[U64](_plugnet.u64.md)*

*Defined in node_modules/@plugnet/types/type/AccountInfo.d.ts:14*

*__description__*: The size of stored value in octet
...
**● trieId**: *[Bytes](_plugnet.bytes.md)*

*Defined in node_modules/@plugnet/types/type/AccountInfo.d.ts:18*

*__description__*: Unique ID for the subtree encoded as a byte
